...
struct UAimToolingComponent : UBaseInputToolingComponent {
	...
	char pad_864[0x9c]; // 0x864(0x9c)

	bool IsFeatureEnabled(enum class EAimToolingFeature Feature, struct UAimToolingTargetComponentBase* TargetComponent); // Function InputTooling.AimToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x693fd20
	bool IsAimToolingEnabled(); // Function InputTooling.AimToolingComponent.IsAimToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x693fcf0
};
...
struct UAimToolingTargetComponentBase : USceneComponent {
	...
	void EnableAimToolingFeature(enum class EAimToolingFeature AimToolingFeature); // Function InputTooling.AimToolingTargetComponentBase.EnableAimToolingFeature // (Final|Native|Public|BlueprintCallable) // @ game+0x6940fc0
	void DisableAimToolingFeature(enum class EAimToolingFeature AimToolingFeature); // Function InputTooling.AimToolingTargetComponentBase.DisableAimToolingFeature // (Final|Native|Public|BlueprintCallable) // @ game+0x6940f40
};
...
struct UMovementToolingComponent : UBaseInputToolingComponent {
	...
	bool IsMovementToolingEnabled(); // Function InputTooling.MovementToolingComponent.IsMovementToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3ac7300
	bool IsFeatureEnabled(enum class EMovementToolingFeature Feature); // Function InputTooling.MovementToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6948ea0
};
