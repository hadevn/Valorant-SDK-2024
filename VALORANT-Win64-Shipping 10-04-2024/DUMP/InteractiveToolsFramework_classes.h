...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x692e960
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x692e8d0
};
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x692e760
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x692e5c0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x3a8d840
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x692e4d0
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x39c29b0
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x39c2a00
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x692e840
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x692e430
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x3af9d00
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x692e630
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x3a1e4b0
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x692e460
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x692e430
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x692e6c0
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x692e490
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x692e460
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x692e430
};
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x3d8(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x3e0(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x3e8(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x3d8(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x3e0(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x3e8(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x3f0(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x3f8(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x400(0x08)
	struct UPrimitiveComponent* RotateX; // 0x408(0x08)
	struct UPrimitiveComponent* RotateY; // 0x410(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x418(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x420(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x428(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x430(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x438(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x440(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x448(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x450(0x08)
};
