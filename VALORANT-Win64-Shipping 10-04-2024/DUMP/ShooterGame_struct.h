...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadLookStickSensitivityScopedMultiplier = 123,
	GamepadLookStickSensitivityADSMultiplier = 124,
	GamepadLookStickSensitivitySoftADSMultiplier = 125,
	GamepadBaseSpeedMultiplierX = 126,
	GamepadBaseSpeedMultiplierY = 127,
	GamepadMaxSpeedMultiplierX = 128,
	GamepadMaxSpeedMultiplierY = 129,
	GamepadMaxAccelerationThreshold = 130,
	GamepadAimAccelDelaySeconds = 131,
	GamepadAimAccelRampUpSeconds = 132,
	GamepadLookStickInnerDeadzone = 133,
	GamepadLookStickOuterDeadzone = 134,
	GamepadLookStickAngularInnerDeadzoneDeg = 135,
	GamepadLookStickAngularOuterDeadzoneDeg = 136,
	GamepadLookStickAxialHorizontalDeadzone = 137,
	GamepadLookStickAxialVerticalDeadzone = 138,
	GamepadWalkStickInnerDeadzone = 139,
	GamepadWalkStickAngularInnerDeadzoneDeg = 140,
	GamepadWalkStickAngularOuterDeadzoneDeg = 141,
	GamepadWalkStickAxialHorizontalDeadzone = 142,
	GamepadWalkStickAxialVerticalDeadzone = 143,
	GamepadTriggerDeadzone = 144,
	GamepadAnalogWalkThreshold = 145,
	GamepadCrouchingSensitivityScale = 146,
	GamepadCrouchSensScaleEaseInOutTime = 147,
	GamepadShootingSensitivityScale = 148,
	GamepadShootSensScaleEaseInOutTime = 149,
	GamepadInputDampeningMinPercentX = 150,
	GamepadInputDampeningMinPercentY = 151,
	GamepadInputDampeningRampSecondsX = 152,
	GamepadInputDampeningRampSecondsY = 153,
	GamepadInputDampeningLargeMovementThresholdX = 154,
	GamepadInputDampeningLargeMovementThresholdY = 155,
	GamepadInputDampeningRestSeconds = 156,
	GamepadMegamapSizeMultiplier = 157,
	GamepadCloudburstSensitivity = 158,
	GamepadRotationIncreaseAccel = 159,
	GamepadRotationIncreaseAccelSoftADSMultiplier = 160,
	GamepadRotationIncreaseAccelADSMultiplier = 161,
	GamepadRotationIncreaseAccelScopedMultiplier = 162,
	GamepadBaseSpeedMultiplierXZoomed = 163,
	GamepadBaseSpeedMultiplierYZoomed = 164,
	GamepadMaxSpeedMultiplierXZoomed = 165,
	GamepadMaxSpeedMultiplierYZoomed = 166,
	GamepadMaxAccelerationThresholdZoomed = 167,
	GamepadAimAccelDelaySecondsZoomed = 168,
	GamepadAimAccelRampUpSecondsZoomed = 169,
	GamepadBaseSpeedMultiplierXSoftADS = 170,
	GamepadBaseSpeedMultiplierYSoftADS = 171,
	GamepadMaxSpeedMultiplierXSoftADS = 172,
	GamepadMaxSpeedMultiplierYSoftADS = 173,
	GamepadMaxAccelerationThresholdSoftADS = 174,
	GamepadAimAccelDelaySecondsSoftADS = 175,
	GamepadAimAccelRampUpSecondsSoftADS = 176,
	AimToolingAimAccelerationDelayDelayAmount = 177,
	AimToolingAimAccelerationDelayRampUpAmount = 178,
	AimToolingTFPlayerScale = 179,
	AimToolingFORPlayerScale = 180,
	AimToolingSAPlayerScale = 181,
	AimToolingPTCPlayerScale = 182,
	ObserverRunSpeedModifier = 183,
	ObserverWalkSpeedModifier = 184,
	GyroShootingThresholdTap = 185,
	GyroShootingThresholdHold = 186,
	GyroShootingVisualBarMax = 187,
	GyroMovementWalkThresholdHorizontal = 188,
	GyroMovementWalkThresholdVertical = 189,
	GyroMovementRunThresholdHorizontal = 190,
	GyroMovementRunThresholdVertical = 191,
	GyroShotMovementDeadzoneThreshold = 192,
	GyroShotMovementDeadzoneValue = 193,
	EAresFloatSettingName_MAX = 194
};
...
enum class EAresIntSettingName : uint8 {
	...
	GamepadSavedAimCurveZoomed = 71,
	GamepadSavedAimCurveSoftADS = 72,
	GamepadSavedAimCurveAngularDeadzone = 73,
	GamepadAnalogMoveThresholdMode = 74,
	GamepadWeaponSwapMode = 75,
	GamepadJettGlidePressBehavior = 76,
	GamepadAimStickSquaringMode = 77,
	TouchDoubleTapRight = 78,
	TouchHUDPreset = 79,
	TouchDoubleTapLeft = 80,
	TouchAimAccelerationCurveX = 81,
	TouchAimAccelerationCurveY = 82,
	TouchAimADSAccelerationCurveX = 83,
	TouchAimADSAccelerationCurveY = 84,
	TouchAimSniperAccelerationCurveX = 85,
	TouchAimSniperAccelerationCurveY = 86,
	TouchJoystickStyle = 87,
	TouchSniperZoomLevelSetting = 88,
	TouchOperatorZoomCycleStyle = 89,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 90,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 91,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 92,
	TouchAimSensitivityPreset = 93,
	TouchGyroSensitivityPreset = 94,
	TouchTrackballSensitivityPreset = 95,
	TouchDoubleTapTopLeft = 96,
	TouchDoubleTapTopMiddle = 97,
	TouchDoubleTapTopRight = 98,
	TouchDoubleTapMiddleLeft = 99,
	TouchDoubleTapMiddle = 100,
	TouchDoubleTapMiddleRight = 101,
	TouchDoubleTapBottomLeft = 102,
	TouchDoubleTapBottomMiddle = 103,
	TouchDoubleTapBottomRight = 104,
	TouchNumVerticalRegions = 105,
	TouchNumHorizontalRegions = 106,
	MaxFramerateInBuyPhase = 107,
	MaxFramerateInGamePhase = 108,
	MaxFramerateInSpectatorView = 109,
	LastSeenRoamingSettingsVersion = 110,
	EAresIntSettingName_MAX = 111
};
...
enum class EAresBoolSettingName : uint8 {
	...
	GamepadEnableDampeningWhileAccelerated = 135,
	GamepadDampenLargeMovementsOnly = 136,
	GamepadDampeningResetLargeMovements = 137,
	GamepadInputDampeningEnabled = 138,
	StanceIndicatorEnabled = 139,
	GamepadTapToCycleIncompleteInventory = 140,
	GamepadJettAutomaticGlide = 141,
	GamepadRotationIncreaseAccelEnabled = 142,
	GamepadForceDesiredAngle = 143,
	GamepadForceWalkWhileFocusedOrZoomed = 144,
	MultithreadedRenderingEnabled = 145,
	AimToolingDCPlayerEnabled = 146,
	HasEverStartedAMatch = 147,
	HasAcceptedCodeOfConduct = 148,
	HasSeenNewPlayerSettings = 149,
	HasSeenNPEContractTutorial = 150,
	HasSeenUPWTutorial = 151,
	HasSeenSettingsTutorial = 152,
	HasSeenWelcomeScreen = 153,
	HasSeenMenuTutorial = 154,
	HasSeenPhotoSensitivityWarning = 155,
	HasSeenTournamentsScreen = 156,
	HasSeenXGPActivationModal = 157,
	HasSeenTrainingPrompt = 158,
	CollectionShowOwnedOnly = 159,
	IncognitoHideMatchmadePlayerNames = 160,
	IncognitoRejectFriendRequests = 161,
	IncognitoRejectPartyInvitesByDisplayName = 162,
	PlayerBehavior_MuteEnemyTextChat = 163,
	PlayerBehavior_MuteObserverTextChat = 164,
	HideUI = 165,
	HideCrosshair = 166,
	Hide1P = 167,
	HideOutlinesAndFresnel = 168,
	ObserversSeeBlinds = 169,
	TeamColorAffectsHUD = 170,
	ShowKeybindsOnMinimap = 171,
	ShowKeybindsOnMegamap = 172,
	FullscreenMegamap = 173,
	HandednessByTeam = 174,
	HideSpectatedAgentPortrait = 175,
	ObserverToggleScoreboard = 176,
	HasEverAppliedRoamingSettings = 177,
	HasEverAppliedRoamingSettingsGamepad = 178,
	GyroTapShoot = 179,
	GyroShootingAxisSwap = 180,
	GyroShootingAxisInvert = 181,
	GyroShootingDisplayBar = 182,
	GyroMovementAxisInvertVertical = 183,
	GyroMovementAxisInvertHorizontal = 184,
	ShowColoredMuzzleFlashes = 185,
	MaxbotGameplayVO = 186,
	MaxbotFlavorVO = 187,
	RGIInputLatencyEnabled = 188,
	VoiceSelfMuteEnabled = 189,
	MatureContentFilter = 190,
	ShowBloodVisual = 191,
	ShowCorpsesVisual = 192,
	AllowCrossPlay = 193,
	ShowNewPlayerTips = 194,
	ContextAwareModuleComplete = 195,
	EnableToggleableUsables = 196,
...
enum class EGameFeatureToggleName : uint8 {
	...
	AxialTracesCanUseComplexCollisionForEndpoints = 176,
	LimitedTrustedTargetingOnAbilities = 177,
	WraithSmokeInputPrototype = 178,
	CharacterLocationBunchData = 179,
	DoorsSnapToDefaultStateOnPostInitComponents = 180,
	CanCauseDamageWithNullDamageEventComponent = 181,
	LargeActorOverlapFixForWallMeshOverlap = 182,
	EnableDeadlockNeonTimedDoorEvacFix = 183,
	RemoveDeletedFXCsFromPool = 184,
	DisassociateAFKPlayers = 185,
	ReplayDataGameServerCompression = 186,
	OffsetHiddenMontages = 187,
	GamepadAimAccelResetEnabled = 188,
	GamepadAimAccelDelayResetEnabled = 189,
	LimitIncomingConnections = 190,
	VisionConeEarlyRelativeAngleCulling = 191,
	HapticDPTPrototyping = 192,
	ShootingRangeBotPoolingRefactor = 193,
	GamepadMegamapCommInput = 194,
	AccoladesTelemetryEnabled = 195,
	DDoSDetection = 196,
	AIToggleA = 197,
	AIToggleB = 198,
	TimeShiftByMoveBundles = 199,
	LockedMapControlType = 200,
	SwapViewTargetModeToWatchSpawnedOnDeath = 201,
	DisableCharacterTickOnRangeBots = 202,
	UseCachedBaseTeamComponentOnAresPlayerState = 203,
	ContextAwareModuleEnabled = 204,
	DisarmedComponentProgressesToEquipState = 205,
	PreventWeaponSwapSpamWhileDisarmed = 206,
	UnifyBaseAndRegionalDamageCalculation = 207,
	AllShotTelemetryEnabled = 208,
	AllyMapEdgePortraits = 209,
	PrecalcProjectileCollisionUsesTriggers = 210,
	UseAIJobCoordinationBehavior = 211,
	VTSPluginEnabled = 212,
	VTSPluginObserverEnabled = 213,
	ContextAwareModuleVisualsEnabled = 214,
	AIUseDistanceRoomPathfindingCosting = 215,
	EnableDoubleSniperOnAltModes = 216,
	ClientAuthBlinds = 217,
	SeparateCRInterpForRemoteClients = 218,
	EquippableReplicationImprovements = 219,
	SupportsNewPreRoundShop = 220,
	AlwaysTick3PAnimsForLocalPlayer = 221,
	PrimitiveComponentUpdateOverlapsChildren = 222,
	ValidPurchasableForItemClassCheck = 223,
	AnimationOptimizationBTM = 224,
	AnimationOptimizationBTMAllies = 225,
	FocusModeEnabled = 226,
	Count = 227,
	Invalid = 254,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	MaxOvertimeRounds = 11,
	MinimapVisibilityTickInterval = 12,
	ObserverMovementMinQueueSize = 13,
	JohnsLatteRate = 14,
	PainAuxRaisinsRate = 15,
	UsablesPredictionTimeout = 16,
	ForceModulesPredictionTimeout = 17,
	LogsPerSecondThreshold = 18,
	LogsPerSecondCriticalThreshold = 19,
	LogsPerSecondMeasurementWindow = 20,
	AimToolingTrackerHighRecoilThreshold = 21,
	AimToolingTelemetryEventCadenceSeconds = 22,
...
enum class EAresSocialPartyCompatibility : uint8 {
	...
	VersionMismatch = 3,
	Error = 4,
	EAresSocialPartyCompatibility_MAX = 5
};
...
enum class ESocialCategory : uint8 {
	...
	ActivePlatformOtherGame = 10,
	ActivePlatformOffline = 11,
	ESocialCategory_MAX = 12
};
...
enum class EUIConfirmationModalVisualType : uint8 {
	Generic = 0,
	SystemError = 1,
	EUIConfirmationModalVisualType_MAX = 2
};
...
// ScriptStruct ShooterGame.ObjectiveEvent
...
struct FMatchup {
	...
	struct TArray<struct FMatchupGame> Games; // 0x58(0x10)
};
...
struct FMatchupGame {
	...
	struct TArray<struct FMatchupGameScore> Scores; // 0x20(0x10)
...
struct FEquippableAimToolingModifiers {
	...
	struct FString TuningTagFocus; // 0x18(0x10)
	struct FString TuningTagADS; // 0x28(0x10)
};
...
struct FUINavigationGlobalsEntry {
	...
	struct FShellWidgetVisibilityOptions ShellWidgetVisibilityOptions; // 0xf0(0x08)
	bool bIsLandingScreen; // 0xf8(0x01)
...
struct FBTEMilestone {
	...
	struct TSoftClassPtr<UObject> UIData; // 0x40(0x30)
};
...
struct FNodeGrid {
	...
	struct TArray<struct FPatchCellVolume> CellVolumeArray; // 0x30(0x10)
	bool bPatchIsValid; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	int32_t LineSize; // 0x44(0x04)
};

// ScriptStruct ShooterGame.PatchCellVolume
// Size: 0x10 (Inherited: 0x00)
struct FPatchCellVolume {
	struct TArray<struct FPatchCellVolumeInfo> ZLevels; // 0x00(0x10)
};

// ScriptStruct ShooterGame.PatchCellVolumeInfo
// Size: 0x38 (Inherited: 0x00)
struct FPatchCellVolumeInfo {
	struct TArray<struct FVector2D> ConvexHullPoints; // 0x00(0x10)
	enum class ECellStatus Status; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
	float LowestZValue; // 0x14(0x04)
	float HighestZValue; // 0x18(0x04)
	float Distance; // 0x1c(0x04)
	struct FVector_NetQuantize Centroid; // 0x20(0x0c)
	struct FVector_NetQuantizeNormal Normal; // 0x2c(0x0c)
};
...
struct FAresListConfiguration {
	struct UUserWidget* EntryWidgetClass; // 0x00(0x08)
	struct FAresListConstructArgs ListConstructArgs; // 0x08(0x14)
	char pad_1C[0x4]; // 0x1c(0x04)
};
...
struct FAresListConstructArgs {
	...
	bool bClearSelectionOnClick; // 0x03(0x01)
	enum class EConsumeMouseWheel ConsumeMouseWheel; // 0x04(0x01)
	bool bReturnFocusToSelection; // 0x05(0x01)
	enum class EOrientation Orientation; // 0x06(0x01)
	enum class EListItemAlignment TileAlignment; // 0x07(0x01)
	float EntryHeight; // 0x08(0x04)
	float EntryWidth; // 0x0c(0x04)
	bool bWrapDirectionalNavigation; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
};
...
struct FClientLaunchTimes {
	...
	struct FClientLaunchTimeStats ClientLaunchTimeStats; // 0x18(0x28)
};
...
struct FClientReconnectToInGameLaunchTimes {
	struct FString InstanceId; // 0x00(0x10)
	struct FString matchID; // 0x10(0x10)
	struct FClientLaunchTimeStats ClientLaunchTimeStats; // 0x20(0x28)
};
...
struct FParticipantMatchResults {
	...
	struct TMap<struct FString, float> BehaviorFactors; // 0x108(0x50)
};
...
struct FNPEComponentCompletedEvent : FMatchResultBaseEvent {
	struct FObjectiveEvent Data; // 0x10(0x68)
};
...
// ScriptStruct ShooterGame.QRCodeParams
// Size: 0x58 (Inherited: 0x00)
struct FQRCodeParams {
...
struct FPremierRosterV2 {
	...
	struct FPremierRosterV2SeasonData season; // 0xb0(0x98)
	int32_t MinimumRequiredMembersForEnrollment; // 0x148(0x04)
	int32_t MatchesSinceReset; // 0x14c(0x04)
	int32_t TournamentsSinceReset; // 0x150(0x04)
	char pad_154[0x4]; // 0x154(0x04)
	struct FPremierRosterV2Version Version; // 0x158(0x10)
	int64_t UpdatedAt; // 0x168(0x08)
	int64_t CreatedAt; // 0x170(0x08)
};
...
struct FPremierRoster {
	...
	struct FPremierRosterV2SeasonData season; // 0xb8(0x98)
};
...
struct FRemainingBalanceInfo {
	...
	struct FText RemainingFundsMessage; // 0x18(0x18)
};
...
struct FNewPlayerExperienceJourney {
	struct FString Subject; // 0x00(0x10)
	struct FString matchID; // 0x10(0x10)
	struct FString ModuleDescription; // 0x20(0x10)
	struct FString ModuleStatus; // 0x30(0x10)
	struct FString ModuleTimestamp; // 0x40(0x10)
	struct FTelemetryPlatformDetails PlatformDetails; // 0x50(0x20)
};
...
struct FSessionDTO {
	...
	bool ShouldForceInvalidate; // 0xb8(0x01)
	char pad_B9[0x7]; // 0xb9(0x07)
};
...
struct FStateMachineDebugHistoryEntry {
	...
	struct UStateComponent* NewState; // 0x08(0x08)
	struct FString ContextName; // 0x10(0x10)
	enum class EStateMachineDebugEntryMatchState MatchState; // 0x20(0x01)
	bool bWasLastStateBeforeDisagreement; // 0x21(0x01)
