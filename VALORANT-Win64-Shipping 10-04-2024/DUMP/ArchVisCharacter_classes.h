...
struct AArchVisCharacter : ACharacter {
	struct FString LookUpAxisName; // 0x678(0x10)
	struct FString LookUpAtRateAxisName; // 0x688(0x10)
	struct FString TurnAxisName; // 0x698(0x10)
	struct FString TurnAtRateAxisName; // 0x6a8(0x10)
	struct FString MoveForwardAxisName; // 0x6b8(0x10)
	struct FString MoveRightAxisName; // 0x6c8(0x10)
	float MouseSensitivityScale_Pitch; // 0x6d8(0x04)
	float MouseSensitivityScale_Yaw; // 0x6dc(0x04)
};
