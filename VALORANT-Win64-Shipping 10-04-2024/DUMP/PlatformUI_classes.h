...
struct UPlatformUIFRE : UPlatformUI {
	...
	bool SetHotfixAvailability(enum class EPlatformUIHotFixAvailability HotfixAvailability); // Function PlatformUI.PlatformUIFRE.SetHotfixAvailability // (Final|Native|Public|BlueprintCallable) // @ game+0x23ff790
};
