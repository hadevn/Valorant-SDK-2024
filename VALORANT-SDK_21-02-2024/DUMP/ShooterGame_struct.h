...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadBaseSpeedMultiplierXZoomed = 159,
	GamepadBaseSpeedMultiplierYZoomed = 160,
	GamepadMaxSpeedMultiplierXZoomed = 161,
	GamepadMaxSpeedMultiplierYZoomed = 162,
	GamepadMaxAccelerationThresholdZoomed = 163,
	GamepadAimAccelDelaySecondsZoomed = 164,
	GamepadAimAccelRampUpSecondsZoomed = 165,
	GamepadBaseSpeedMultiplierXSoftADS = 166,
	GamepadBaseSpeedMultiplierYSoftADS = 167,
	GamepadMaxSpeedMultiplierXSoftADS = 168,
	GamepadMaxSpeedMultiplierYSoftADS = 169,
	GamepadMaxAccelerationThresholdSoftADS = 170,
	GamepadAimAccelDelaySecondsSoftADS = 171,
	GamepadAimAccelRampUpSecondsSoftADS = 172,
	AimToolingAimAccelerationDelayDelayAmount = 173,
	AimToolingAimAccelerationDelayRampUpAmount = 174,
	AimToolingTFPlayerScale = 175,
	AimToolingFORPlayerScale = 176,
	AimToolingSAPlayerScale = 177,
	AimToolingPTCPlayerScale = 178,
	ObserverRunSpeedModifier = 179,
	ObserverWalkSpeedModifier = 180,
	GyroShootingThresholdTap = 181,
	GyroShootingThresholdHold = 182,
	GyroShootingVisualBarMax = 183,
	GyroMovementWalkThresholdHorizontal = 184,
	GyroMovementWalkThresholdVertical = 185,
	GyroMovementRunThresholdHorizontal = 186,
	GyroMovementRunThresholdVertical = 187,
	GyroShotMovementDeadzoneThreshold = 188,
	GyroShotMovementDeadzoneValue = 189,
	EAresFloatSettingName_MAX = 190
};
...
enum class EAresIntSettingName : uint8 {
	...
	TouchDoubleTapRight = 77,
	TouchHUDPreset = 78,
	TouchDoubleTapLeft = 79,
	TouchAimAccelerationCurveX = 80,
	TouchAimAccelerationCurveY = 81,
	TouchAimADSAccelerationCurveX = 82,
	TouchAimADSAccelerationCurveY = 83,
	TouchAimSniperAccelerationCurveX = 84,
	TouchAimSniperAccelerationCurveY = 85,
	TouchJoystickStyle = 86,
	TouchSniperZoomLevelSetting = 87,
	TouchOperatorZoomCycleStyle = 88,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 89,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 90,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 91,
	TouchAimSensitivityPreset = 92,
	TouchGyroSensitivityPreset = 93,
	TouchTrackballSensitivityPreset = 94,
	TouchDoubleTapTopLeft = 95,
	TouchDoubleTapTopMiddle = 96,
	TouchDoubleTapTopRight = 97,
	TouchDoubleTapMiddleLeft = 98,
	TouchDoubleTapMiddle = 99,
	TouchDoubleTapMiddleRight = 100,
	TouchDoubleTapBottomLeft = 101,
	TouchDoubleTapBottomMiddle = 102,
	TouchDoubleTapBottomRight = 103,
	TouchNumVerticalRegions = 104,
	TouchNumHorizontalRegions = 105,
	MaxFramerateInBuyPhase = 106,
	MaxFramerateInGamePhase = 107,
	MaxFramerateInSpectatorView = 108,
	LastSeenRoamingSettingsVersion = 109,
	EAresIntSettingName_MAX = 110
};
...
enum class EAresBoolSettingName : uint8 {
	...
	MultithreadedRenderingEnabled = 142,
	AimToolingDCPlayerEnabled = 143,
	HasEverStartedAMatch = 144,
	HasAcceptedCodeOfConduct = 145,
	HasSeenNewPlayerSettings = 146,
	HasSeenNPEContractTutorial = 147,
	HasSeenUPWTutorial = 148,
	HasSeenSettingsTutorial = 149,
	HasSeenWelcomeScreen = 150,
	HasSeenMenuTutorial = 151,
	HasSeenPhotoSensitivityWarning = 152,
	HasSeenTournamentsScreen = 153,
	HasSeenXGPActivationModal = 154,
	HasSeenTrainingPrompt = 155,
	CollectionShowOwnedOnly = 156,
	IncognitoHideMatchmadePlayerNames = 157,
	IncognitoRejectFriendRequests = 158,
	IncognitoRejectPartyInvitesByDisplayName = 159,
	PlayerBehavior_MuteEnemyTextChat = 160,
	PlayerBehavior_MuteObserverTextChat = 161,
	HideUI = 162,
	HideCrosshair = 163,
	Hide1P = 164,
	HideOutlinesAndFresnel = 165,
	ObserversSeeBlinds = 166,
	TeamColorAffectsHUD = 167,
	ShowKeybindsOnMinimap = 168,
	ShowKeybindsOnMegamap = 169,
	FullscreenMegamap = 170,
	HandednessByTeam = 171,
	HideSpectatedAgentPortrait = 172,
	ObserverToggleScoreboard = 173,
	HasEverAppliedRoamingSettings = 174,
	HasEverAppliedRoamingSettingsGamepad = 175,
	GyroTapShoot = 176,
	GyroShootingAxisSwap = 177,
	GyroShootingAxisInvert = 178,
	GyroShootingDisplayBar = 179,
	GyroMovementAxisInvertVertical = 180,
	GyroMovementAxisInvertHorizontal = 181,
	ShowColoredMuzzleFlashes = 182,
	MaxbotGameplayVO = 183,
	MaxbotFlavorVO = 184,
	RGIInputLatencyEnabled = 185,
	VoiceSelfMuteEnabled = 186,
	MatureContentFilter = 187,
	ShowBloodVisual = 188,
	ShowCorpsesVisual = 189,
	AllowCrossPlay = 190,
	ShowContextAwareModuleTips = 191,
	EnableToggleableUsables = 192,
	EAresBoolSettingName_MAX = 193
};
...
enum class EGameFeatureToggleName : uint8 {
	...
	PandemicToxicScreenCollisionFixes = 136,
	RateLimitClientInputs = 137,
	ErrorPowerByStabilityType = 138,
	AccoladesEnabled = 139,
	PremierGameEvents = 140,
	EquippableCacheRecycling = 141,
	ViperPitIgnoreCrawlspaceToggle = 142,
	EsportsGameEvents = 143,
	ScaledHeadshotFX = 144,
	ExplicitCharacterLoading = 145,
	MinimapFloors = 146,
	ShortTermNPEUpdates = 147,
	PatchHeightJumpCrouchExploitFix = 148,
	PatchHeightJumpCrouchExploitFixGekko = 149,
	FootstepDecayWhileWalking = 150,
	SystemicAbilityUpdates = 151,
	ConcussLowTickRate = 152,
	BombDestroysAllDestructibles = 153,
	OnlyDropCurrentEquippable = 154,
	FXCPerspectiveUpdatedOnSameFrameFix = 155,
	ObserverMinimapComponentLocation = 156,
	EnableIncreasedNetDriverRateLimiting = 157,
	CellularPatchMultipleNodeOverlapCheck = 158,
	UseExtendedCombatReport = 159,
	AllowSkipRestrictionsForCurrentEquippable = 160,
	DisableFogOfWar = 161,
	RemoveClientPredictionDataForAI = 162,
	EsportsHub = 163,
	EnsureReplicationPauseSend = 164,
	PureTracers = 165,
	RebaseOnEnterFoW = 166,
	AbilityRechargeCooldownMulticastAll = 167,
	UsePlayerloadoutsInWeaponSpawners = 168,
	HideEnemyTracersOutsideGameplay = 169,
	KnifeOnlyFastFOV = 170,
	SkipEnemyMoveSendOutsideGameplay = 171,
	AllowPatchRunAlongGround = 172,
	DisarmedComponentAvoidUnarmedAfterExpiry = 173,
	SetOrbTickRateLow = 174,
	ReplayTimeScrubbing = 175,
	StopPreparedEffects = 176,
	EnableTapHoldActionBindings = 177,
	BotMovementDowntickingEnabled = 178,
	AxialTracesCanUseComplexCollisionForEndpoints = 179,
	LimitedTrustedTargetingOnAbilities = 180,
	WraithSmokeInputPrototype = 181,
	CharacterLocationBunchData = 182,
	DoorsSnapToDefaultStateOnPostInitComponents = 183,
	CanCauseDamageWithNullDamageEventComponent = 184,
	SmallerBoundsCalcsForWallMeshOverlap = 185,
	LargeActorOverlapFixForWallMeshOverlap = 186,
	UsePatchMolotovsParentIsNotAllyDamageCheck = 187,
	SpawnSpotStateCanSweepPrimitiveComponent = 188,
	FindSpawnSpotCanFailIfLocationBlocked = 189,
	UseFindSpawnSpotStateComponentRestructure = 190,
	EnableDeadlockNeonTimedDoorEvacFix = 191,
	RemoveDeletedFXCsFromPool = 192,
	DisassociateAFKPlayers = 193,
	ReplayDataGameServerCompression = 194,
	OffsetHiddenMontages = 195,
	GamepadAimAccelResetEnabled = 196,
	GamepadAimAccelDelayResetEnabled = 197,
	LimitIncomingConnections = 198,
	VisionConeEarlyRelativeAngleCulling = 199,
	HapticDPTPrototyping = 200,
	ShootingRangeBotPoolingRefactor = 201,
	GamepadMegamapCommInput = 202,
	AccoladesTelemetryEnabled = 203,
	DDoSDetection = 204,
	AIToggleA = 205,
	AIToggleB = 206,
	TimeShiftByMoveBundles = 207,
	LockedMapControlType = 208,
	SwapViewTargetModeToWatchSpawnedOnDeath = 209,
	DisableCharacterTickOnRangeBots = 210,
	UseCachedBaseTeamComponentOnAresPlayerState = 211,
	ContextAwareModuleEnabled = 212,
	DisarmedComponentProgressesToEquipState = 213,
	PreventWeaponSwapSpamWhileDisarmed = 214,
	UnifyBaseAndRegionalDamageCalculation = 215,
	AllShotTelemetryEnabled = 216,
	AllyMapEdgePortraits = 217,
	PrecalcProjectileCollisionUsesTriggers = 218,
	UseAIJobCoordinationBehavior = 219,
	VTSPluginEnabled = 220,
	VTSPluginObserverEnabled = 221,
	ContextAwareModuleVisualsEnabled = 222,
	AIUseDistanceRoomPathfindingCosting = 223,
	EnableDoubleSniperOnAltModes = 224,
	ClientAuthBlinds = 225,
	NewRecoilRecovery = 226,
	SeparateCRInterpForRemoteClients = 227,
	EquippableReplicationImprovements = 228,
	SupportsNewPreRoundShop = 229,
	AlwaysTick3PAnimsForLocalPlayer = 230,
	PrimitiveComponentUpdateOverlapsChildren = 231,
	Count = 232,
	Invalid = 254,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	GamepadMaxFramerateAlways = 25,
	EndToEndLatencyJitter = 26,
	ABFootstepTestControlPercent = 27,
	RelativeTriggerThreshold = 28,
	RelativeTriggerDeltaSensitivity = 29,
	GameDataWorldSnapshotIntervalSec = 30,
	GameDataWorldConfigurationIntervalSec = 31,
	GameDataTimeseriesIntervalSec = 32,
	ShortTermNPEUpdatesChance = 33,
	MaxSnapshotCountForShortGames = 34,
	GamepadAimAccelResetAngle = 35,
	DesignerFloatA = 36,
	DesignerFloatB = 37,
	DesignerFloatC = 38,
	DesignerFloatD = 39,
	DesignerFloatE = 40,
	AwakeReplicationFrequency = 41,
	Count = 42,
	Invalid = 254,
...
enum class EAVSErrorType : uint8 {
	...
	SMSServiceError = 13,
	UnknownServerError = 14,
	ConfirmationPinIncorrect = 15,
	Default = 16,
	Count = 17,
	Invalid = 18,
	EAVSErrorType_MAX = 19
};
...
// Enum ShooterGame.EAddFriendErrorType
enum class EAddFriendErrorType : uint8 {
	IncorrectInputFormat = 0,
	AlreadyFriends = 1,
	RequestSentToNonExistentPlayer = 2,
	RequestSentToBlockedPlayer = 3,
	RequestSentToSelf = 4,
	InternalError = 5,
	EAddFriendErrorType_MAX = 6
};
...
enum class EAresSocialPartyCompatibility : uint8 {
	...
	VersionMismatch = 2,
	Error = 3,
	EAresSocialPartyCompatibility_MAX = 4
};
...
enum class EUIConfirmationModalVisualType : uint8 {
	Generic = 0,
	EUIConfirmationModalVisualType_MAX = 1
};
...
// Enum ShooterGame.EContextAwareModuleStepProgressName
enum class EContextAwareModuleStepProgressName : uint8 {
	Economy = 0,
	AttackDefend = 1,
	Range = 2,
	Abilities = 3,
	...
	Crosshair = 6,
	Fights = 7,
	EContextAwareModuleStepProgressName_MAX = 8
};
...
enum class EPlatformInitErrorReason : uint8 {
	...
	Count = 91,
	EPlatformInitErrorReason_MAX = 92
};
...
// Enum ShooterGame.ETipState
enum class ETipState : uint8 {
	Resolved = 0,
	Invalid = 1,
	Valid = 2,
	Shown = 3,
...
// ScriptStruct ShooterGame.ActionChordTapHoldConfig
// Size: 0x0c (Inherited: 0x00)
struct FActionChordTapHoldConfig {
	float IntervalStart; // 0x00(0x04)
	float IntervalLength; // 0x04(0x04)
	float DoubleTapIntervalLength; // 0x08(0x04)
};
...
struct FAimToolingTelemetryEvent {
	struct FString MatchID; // 0x00(0x10)
	struct FString Subject; // 0x10(0x10)
	struct FAimToolingTelemetryData AimToolingData; // 0x20(0x30)
};
...
struct FShotProjectileInfo {
	...
	struct FGameEventCharacterState DealerCharacterState; // 0x88(0x1a0)
	int32_t NumberProjectiles; // 0x228(0x04)
	int32_t ZoomLevel; // 0x22c(0x04)
	struct FStabilityValues StabilityValues; // 0x230(0x18)
	struct FString DamageEquippableInventoryTransactionType; // 0x248(0x10)
};
...
struct FShotProjectileOnHitInfo : FShotProjectileInfo {
	struct FString DamageSource; // 0x258(0x10)
	struct FString DamageSourceId; // 0x268(0x10)
	struct TArray<struct FShotProjectileDamageInfo> DamageEvents; // 0x278(0x10)
};
...
struct FDamageLogEvent {
	...
	struct FString DamageEquippableInventoryTransactionType; // 0x540(0x10)
};
...
struct FSortPartyData {
	...
	struct FAresSocialPresenceState FirstMemberPresenceState; // 0x20(0x04)
	enum class EAresPartyAccessibility PartyAccessibility; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
...
struct FFriendData {
	...
	struct FAresSocialPresenceState PresenceState; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
};
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FGPUStats GPUStats; // 0x62c(0x48)
	struct FClientFrameBuckets FrameBuckets; // 0x674(0x24)
	struct FString MatchID; // 0x698(0x10)
	int32_t RoundNumber; // 0x6a8(0x04)
	char pad_6AC[0x4]; // 0x6ac(0x04)
	int64_t RoundDuration; // 0x6b0(0x08)
	struct FString InstanceId; // 0x6b8(0x10)
	struct FPerfSettings Settings; // 0x6c8(0x58)
	struct FMachinePerfStats MachinePerfStats; // 0x720(0x64)
	char MoveTimestepsPerSecond; // 0x784(0x01)
	char pad_785[0x3]; // 0x785(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x788(0x54)
	char pad_7DC[0x4]; // 0x7dc(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x7e0(0x70)
	struct FInputLatencyStats InputLatencyStats; // 0x850(0x134)
	char pad_984[0x4]; // 0x984(0x04)
	struct FString Puuid; // 0x988(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x998(0x20)
};
...
// ScriptStruct ShooterGame.ContextAwareModuleIntProgress
// Size: 0x28 (Inherited: 0x00)
struct FContextAwareModuleIntProgress {
	struct FName ProgressName; // 0x00(0x0c)
	enum class ESettingStorageType StorageType; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
	struct FString StorageKey; // 0x10(0x10)
	int32_t DefaultValue; // 0x20(0x04)
	int32_t Value; // 0x24(0x04)
};
...
struct FContractMatchResults {
	...
	struct TMap<struct FGuid, struct FRewardGrant> RewardGrants; // 0xe0(0x50)
	struct TMap<struct FGuid, struct FMissionDelta> MissionDeltas; // 0x130(0x50)
	struct TMap<struct FGuid, struct FContractDelta> ContractDeltas; // 0x180(0x50)
	struct FMatchSummary MatchSummary; // 0x1d0(0x08)
	bool CouldProgressMissions; // 0x1d8(0x01)
...
struct FPartyData {
	...
	enum class EAresPlatformType PlatformType; // 0x50(0x01)
	char pad_51[0x7]; // 0x51(0x07)
};
...
// ScriptStruct ShooterGame.CommerceCatalogResponse
// Size: 0x10 (Inherited: 0x00)
struct FCommerceCatalogResponse {
	char pad_0[0x10]; // 0x00(0x10)
};

// ScriptStruct ShooterGame.CommerceCatalogPrice
// Size: 0x28 (Inherited: 0x00)
struct FCommerceCatalogPrice {
	char pad_0[0x28]; // 0x00(0x28)
};
...
struct FPremierSeasonDTO {
	...
	int32_t ChampionshipPointRequirement; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct FString ChampionshipEventID; // 0x70(0x10)
};
