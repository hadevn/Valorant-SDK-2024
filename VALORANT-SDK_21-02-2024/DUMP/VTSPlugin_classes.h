...
struct UVTSAuthorityPlayerTimelineSynchronizer : UVTSPlayerTimelineSynchronizer {
	...
	void Rebase(); // Function VTSPlugin.VTSAuthorityPlayerTimelineSynchronizer.Rebase // (Final|Native|Public|BlueprintCallable) // @ game+0x2a81290
};
...
struct UVTSAutonomousPlayerTimelineSynchronizer : UVTSPlayerTimelineSynchronizer {
	...
	void Rebase(); // Function VTSPlugin.VTSAutonomousPlayerTimelineSynchronizer.Rebase // (Final|Native|Public|BlueprintCallable) // @ game+0x2a812b0
};
...
struct UVTSFixedTimeStepTimelineAPI : UObject {
	...
	void UnregisterTimeSynchronizedObjectBlueprint(struct UObject* TimeSynchronizedObjectBlueprint); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.UnregisterTimeSynchronizedObjectBlueprint // (Final|Native|Public|BlueprintCallable|Const) // @ game+0x2a81470
	bool SetTimeStampDelegateBlueprint(struct FVTSTimeStampIndex& TimeStampIndex, struct FDelegate TimeStampActionDynamicDelegate); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.SetTimeStampDelegateBlueprint // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a81360
	void RegisterTimeSynchronizedObjectBlueprint(struct UObject* TimeSynchronizedObjectBlueprint); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.RegisterTimeSynchronizedObjectBlueprint // (Final|Native|Public|BlueprintCallable|Const) // @ game+0x2a812d0
	float GetRemainingRequiredSimulationTime(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetRemainingRequiredSimulationTime // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a81260
	float GetInterpolationValue(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetInterpolationValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a81230
	float GetFixedTimeStepSize(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetFixedTimeStepSize // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a81200
	struct FVTSTimeStampIndex GetCurrentTimeStampIndex(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetCurrentTimeStampIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2a811c0
};
...
struct UVTSTimeSynchronizedInterfaceBlueprint : UInterface {
	...
	void OnRebaseBlueprint(); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnRebaseBlueprint // (Event|Public|BlueprintEvent) // @ game+0x40ca1b0
	void OnPreFixedTimeStepsBlueprint(float ResidualTimeSeconds); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnPreFixedTimeStepsBlueprint // (Event|Public|BlueprintEvent) // @ game+0x40ca1b0
	void OnPostFixedTimeStepsBlueprint(float ResidualTimeSeconds); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnPostFixedTimeStepsBlueprint // (Event|Public|BlueprintEvent) // @ game+0x40ca1b0
	void OnFixedTimeStepBlueprint(struct FVTSTimeStampIndex& TimeStampIndex); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnFixedTimeStepBlueprint // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x40ca1b0
	int32_t GetFixedTimeStepPriorityBlueprint(); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.GetFixedTimeStepPriorityBlueprint // (Event|Public|BlueprintEvent|Const) // @ game+0x40ca1b0
};
