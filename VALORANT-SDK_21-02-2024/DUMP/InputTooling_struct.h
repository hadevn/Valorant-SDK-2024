...
struct FAimToolingTelemetryData {
	...
	float LookInputVectorSize; // 0x28(0x04)
	int32_t ActiveAimToolingFeatures; // 0x2c(0x04)
};

// ScriptStruct InputTooling.AimToolingPrecisionBendingWeaponTuningSet
// Size: 0x18 (Inherited: 0x00)
struct FAimToolingPrecisionBendingWeaponTuningSet {
	bool bPrecisionBendingForWeapon; // 0x00(0x01)
...
struct FAimToolingStrafeAssistSharedTuningSet {
	...
	float AimToolingStrafeAssistNewTargetDelaySeconds; // 0x0c(0x04)
	float AimToolingStrafeAssistNewTargetRampUpSeconds; // 0x10(0x04)
};
...
struct FAimToolingTargetFrictionSharedTuningSet {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct UCurveFloat* TargetFrictionPrecisionAimingScalarCurve; // 0x10(0x08)
};
...
struct FAimToolingTargetManagementSharedTuningSet {
	...
	bool ENGINEERING_ONLY_CHECK_TO_MODIFY_VALUES_BELOW; // 0x90(0x01)
	char pad_91[0x3]; // 0x91(0x03)
	float PotentialTargetMaxAngle; // 0x94(0x04)
	float DefaultRawInputVectorSize; // 0x98(0x04)
...
struct FMovementToolingFastStrafingSharedTuningSet {
	...
	float InitialFastStrafingStickDeltaThreshold; // 0x1c(0x04)
	float InitialFastStrafingPlayerSpeedCutoff; // 0x20(0x04)
};
