...
struct FRemoteControlActor : FRemoteControlEntity {
	struct FSoftObjectPath Path; // 0xa0(0x20)
};
...
struct FRemoteControlField : FRemoteControlEntity {
	...
	struct FSoftClassPath OwnerClass; // 0x118(0x20)
	bool bIsEditorOnly; // 0x138(0x01)
...
struct FRemoteControlFunction : FRemoteControlField {
	...
	bool bIsCallableInPackaged; // 0x150(0x01)
	char pad_151[0x7]; // 0x151(0x07)
	struct FSoftObjectPath FunctionPath; // 0x158(0x20)
...
struct FRemoteControlProperty : FRemoteControlField {
	bool bIsEditableInPackaged; // 0x140(0x01)
