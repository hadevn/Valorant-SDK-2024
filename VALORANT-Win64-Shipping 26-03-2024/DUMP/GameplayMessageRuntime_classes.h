...
struct UGameplayMessageSubsystem : UGameInstanceSubsystem {
	...
	void K2_BroadcastMessage(struct FGameplayTag Channel, int32_t& Message); // Function GameplayMessageRuntime.GameplayMessageSubsystem.K2_BroadcastMessage // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x2c56d00
};
