...
struct UJumpingPathFollowingComponent : UPathFollowingComponent {
	...
	void OnPostProcessMove(struct UPathFollowingComponent* PathFollower, struct FVector& InOutVelocity); // Function AINavigation.JumpingPathFollowingComponent.OnPostProcessMove // (Final|Native|Protected|HasOutParms|HasDefaults) // @ game+0x27a0da0
};
...
struct ANavLinkDropOffGenerator : AActor {
	...
	void OnNavigationGenerated(struct ANavigationData* NavData); // Function AINavigation.NavLinkDropOffGenerator.OnNavigationGenerated // (Final|Native|Private) // @ game+0x27a0d10
	bool HasValidData(); // Function AINavigation.NavLinkDropOffGenerator.HasValidData // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x27a0ce0
	bool DoesMapHaveHealthyJumpLinks(); // Function AINavigation.NavLinkDropOffGenerator.DoesMapHaveHealthyJumpLinks // (Final|Native|Public|BlueprintCallable) // @ game+0x27a0cb0
};
