...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadRotationIncreaseAccel = 175,
	GamepadRotationIncreaseAccelSoftADSMultiplier = 176,
	GamepadRotationIncreaseAccelADSMultiplier = 177,
	GamepadRotationIncreaseAccelScopedMultiplier = 178,
	GamepadBaseSpeedMultiplierXADS = 179,
	GamepadBaseSpeedMultiplierYADS = 180,
	GamepadMaxSpeedMultiplierXADS = 181,
	GamepadMaxSpeedMultiplierYADS = 182,
	GamepadMaxAccelerationThresholdADS = 183,
	GamepadAimAccelDelaySecondsADS = 184,
	GamepadAimAccelRampUpSecondsADS = 185,
	GamepadBaseSpeedMultiplierXScoped = 186,
	GamepadBaseSpeedMultiplierYScoped = 187,
	GamepadMaxSpeedMultiplierXScoped = 188,
	GamepadMaxSpeedMultiplierYScoped = 189,
	GamepadMaxAccelerationThresholdScoped = 190,
	GamepadAimAccelDelaySecondsScoped = 191,
	GamepadAimAccelRampUpSecondsScoped = 192,
	GamepadBaseSpeedMultiplierXSoftADS = 193,
	GamepadBaseSpeedMultiplierYSoftADS = 194,
	GamepadMaxSpeedMultiplierXSoftADS = 195,
	GamepadMaxSpeedMultiplierYSoftADS = 196,
	GamepadMaxAccelerationThresholdSoftADS = 197,
	GamepadAimAccelDelaySecondsSoftADS = 198,
	GamepadAimAccelRampUpSecondsSoftADS = 199,
	AimToolingAimAccelerationDelayDelayAmount = 200,
	AimToolingAimAccelerationDelayRampUpAmount = 201,
	AimToolingTFPlayerScale = 202,
	AimToolingFORPlayerScale = 203,
	AimToolingSAPlayerScale = 204,
	AimToolingPTCPlayerScale = 205,
	ObserverRunSpeedModifier = 206,
	ObserverWalkSpeedModifier = 207,
	GyroShootingThresholdTap = 208,
	GyroShootingThresholdHold = 209,
	GyroShootingVisualBarMax = 210,
	GyroMovementWalkThresholdHorizontal = 211,
	GyroMovementWalkThresholdVertical = 212,
	GyroMovementRunThresholdHorizontal = 213,
	GyroMovementRunThresholdVertical = 214,
	GyroShotMovementDeadzoneThreshold = 215,
	GyroShotMovementDeadzoneValue = 216,
	GamepadAggroBotMoshPitSensitivity = 217,
	GamepadAggroBotThrashSensitivity = 218,
	GamepadBountyHunterPrecisionModeSensitivity = 219,
	GamepadBountyHunterProwlerSensitivity = 220,
	GamepadBountyHunterSeizeSensitivity = 221,
	GamepadBreachAftershockSensitivity = 222,
	GamepadBreachFaultLineSensitivity = 223,
	GamepadBreachFlashpointSensitivity = 224,
	GamepadCableAnnihilationSensitivity = 225,
	GamepadCableGravNetSensitivity = 226,
	GamepadClayPaintShellSensitivity = 227,
	GamepadClayShowstopperSensitivity = 228,
	GamepadCloudburstSensitivity = 229,
	GamepadGrenadierFlashDriveSensitivity = 230,
	GamepadGrenadierFragmentSensitivity = 231,
	GamepadGrenadierZeroPointSensitivity = 232,
	GamepadGuideGuidingLightSensitivity = 233,
	GamepadGuideTrailblazerSensitivity = 234,
	GamepadGumshoePrecisionModeSensitivity = 235,
	GamepadGumshoeSpycamSensitivity = 236,
	GamepadHunterHuntersFurySensitivity = 237,
	GamepadHunterReconBoltSensitivity = 238,
	GamepadHunterShockBoltSensitivity = 239,
	GamepadMageHighTideSensitivity = 240,
	GamepadPandemicPoisonCloudSensitivity = 241,
	GamepadPandemicSnakeBiteSensitivity = 242,
	GamepadPhoenixBlazeSensitivity = 243,
	GamepadSargeAbilityTabletSensitivity = 244,
	GamepadSargePrecisionModeSensitivity = 245,
	GamepadSequoiaUndercutSensitivity = 246,
	GamepadSmonkButterflyKnifeSensitivity = 247,
	GamepadStealthBlindsideSensitivity = 248,
	GamepadWraithDarkCoverSensitivity = 249,
	GamepadWraithFromTheShadowsSensitivity = 250,
	GamepadWraithShroudedStepSensitivity = 251,
	EAresFloatSettingName_MAX = 252
};
...
enum class EAresIntSettingName : uint8 {
	...
	GamepadForceDesiredAngleMode = 76,
...
enum class EAresBoolSettingName : uint8 {
	...
	SpectatorCountWidgetVisible = 61,
	ToggleReturnToStrongestWeapon = 62,
	AutoEquipPrioritizeStrongest = 63,
	AutoEquipSkipsMelee = 64,
	ToggleLiveDiagnostics = 65,
	AESWheelHoldEnabled = 66,
	CrosshairHasOutline = 67,
	CrosshairDisplayCenterDot = 68,
	CrosshairUseCustomColor = 69,
	CrosshairFixMinErrorAcrossWeapons = 70,
	CrosshairUseAdvancedOptions = 71,
	CrosshairScaleToResolution = 72,
	CrosshairInnerLinesShowMovementError = 73,
	CrosshairInnerLinesShowShootingError = 74,
	CrosshairInnerLinesShowMinError = 75,
	CrosshairInnerLinesShowLines = 76,
	CrosshairInnerLinesAllowVertScaling = 77,
	CrosshairOuterLinesShowMovementError = 78,
	CrosshairOuterLinesShowShootingError = 79,
	CrosshairOuterLinesShowMinError = 80,
	CrosshairOuterLinesShowLines = 81,
	CrosshairOuterLinesAllowVertScaling = 82,
	CrosshairUseCustomCrosshairOnAllPrimary = 83,
	CrosshairUsePrimaryCrosshairForADS = 84,
	CrosshairADSHasOutline = 85,
	CrosshairADSDisplayCenterDot = 86,
	CrosshairADSUseCustomColor = 87,
	CrosshairADSFixMinErrorAcrossWeapons = 88,
	CrosshairADSInnerLinesShowMovementError = 89,
	CrosshairADSInnerLinesShowShootingError = 90,
	CrosshairADSInnerLinesShowMinError = 91,
	CrosshairADSInnerLinesShowLines = 92,
	CrosshairADSInnerLinesAllowVertScaling = 93,
	CrosshairADSOuterLinesShowMovementError = 94,
	CrosshairADSOuterLinesShowShootingError = 95,
	CrosshairADSOuterLinesShowMinError = 96,
	CrosshairADSOuterLinesShowLines = 97,
	CrosshairADSOuterLinesAllowVertScaling = 98,
	CrosshairUsePrimaryCrosshairForFocusMode = 99,
	CrosshairFocusModeHasOutline = 100,
	CrosshairFocusModeDisplayCenterDot = 101,
	CrosshairFocusModeUseCustomColor = 102,
	CrosshairFocusModeFixMinErrorAcrossWeapons = 103,
	CrosshairFocusModeInnerLinesShowMovementError = 104,
	CrosshairFocusModeInnerLinesShowShootingError = 105,
	CrosshairFocusModeInnerLinesShowMinError = 106,
	CrosshairFocusModeInnerLinesShowLines = 107,
	CrosshairFocusModeInnerLinesAllowVertScaling = 108,
	CrosshairFocusModeOuterLinesShowMovementError = 109,
	CrosshairFocusModeOuterLinesShowShootingError = 110,
	CrosshairFocusModeOuterLinesShowMinError = 111,
	CrosshairFocusModeOuterLinesShowLines = 112,
	CrosshairFocusModeOuterLinesAllowVertScaling = 113,
	CrosshairSniperDisplayCenterDot = 114,
	CrosshairSniperUseCustomColor = 115,
	AlwaysShowInventoryWidgets = 116,
	LeftHanded = 117,
	TeamColorCrosshair = 118,
	AllyLoadoutInfoAlwaysVisibile = 119,
	TacticalCalloutsInChat = 120,
	TouchAimInvertX = 121,
	TouchAimInvertY = 122,
	TouchAimOneEuroFilteringEnabled = 123,
	TouchAimMultiTouchFilteringEnabled = 124,
	TouchAimContinueFilteringAfterRelease = 125,
	TouchAimTrackballEnabled = 126,
	TouchGyroAimOneEuroFilteringEnabled = 127,
	TouchGyroAimEnabled = 128,
	TouchGyroAimInvertX = 129,
	TouchGyroAimInvertY = 130,
	TouchGyroDroneAimEnabled = 131,
	TouchCustomAbilityUI = 132,
	TouchAbilityRestoreLastEquippable = 133,
	TouchUseSprintToggle = 134,
	TouchUseHalfScreenMovementArea = 135,
	TouchMovementUncrouchOnRun = 136,
	TouchAbilityMapRotation = 137,
	TouchEnableAutoRun = 138,
	TouchAutoRunEquipsKnife = 139,
	TouchCrosshairHighlightEnabled = 140,
	TouchSprintInputFromBottomOnly = 141,
	ToughMagnetismEnabled = 142,
	TouchRunBuffer = 143,
	TouchAimSnappingEnabled = 144,
	TouchMarshalCycleZoomOnHold = 145,
	TouchTrackballEnableLinearDrag = 146,
	TouchQuickCastingEnabled = 147,
	TouchJoystickFollowHorizontalOnly = 148,
	GamepadInvertLookStickY = 149,
	GamepadInvertLookStickX = 150,
	GamepadToggleDropSpikeHold = 151,
	StanceIndicatorEnabled = 152,
	GamepadTapToCycleIncompleteInventory = 153,
	GamepadJettAutomaticGlide = 154,
	GamepadRotationIncreaseAccelEnabled = 155,
	GamepadApplyPartialSquaring = 156,
	GamepadForceWalkWhileFocusedOrZoomed = 157,
	GamepadUseBaseSpeedMultipliers = 158,
	GamepadUseShootingSensMultipliers = 159,
	MultithreadedRenderingEnabled = 160,
	AimToolingDCPlayerEnabled = 161,
	HasEverStartedAMatch = 162,
	HasAcceptedCodeOfConduct = 163,
	HasSeenNewPlayerSettings = 164,
	HasSeenNPEContractTutorial = 165,
	HasSeenUPWTutorial = 166,
	HasSeenSettingsTutorial = 167,
	HasSeenWelcomeScreen = 168,
	HasSeenMenuTutorial = 169,
	HasSeenPhotoSensitivityWarning = 170,
	HasSeenTournamentsScreen = 171,
	HasSeenXGPActivationModal = 172,
	HasSeenTrainingPrompt = 173,
	HasSeenBTEModal = 174,
	CollectionShowOwnedOnly = 175,
	IncognitoHideMatchmadePlayerNames = 176,
	IncognitoRejectFriendRequests = 177,
	IncognitoRejectPartyInvitesByDisplayName = 178,
	PlayerBehavior_MuteEnemyTextChat = 179,
	PlayerBehavior_MuteObserverTextChat = 180,
	HideUI = 181,
	HideCrosshair = 182,
	Hide1P = 183,
	HideOutlinesAndFresnel = 184,
	ObserversSeeBlinds = 185,
	TeamColorAffectsHUD = 186,
	ShowKeybindsOnMinimap = 187,
	ShowKeybindsOnMegamap = 188,
	FullscreenMegamap = 189,
	HandednessByTeam = 190,
	HideSpectatedAgentPortrait = 191,
	ObserverToggleScoreboard = 192,
	HasEverAppliedRoamingSettings = 193,
	HasEverAppliedRoamingSettingsGamepad = 194,
	GyroTapShoot = 195,
	GyroShootingAxisSwap = 196,
	GyroShootingAxisInvert = 197,
	GyroShootingDisplayBar = 198,
	GyroMovementAxisInvertVertical = 199,
	GyroMovementAxisInvertHorizontal = 200,
	ShowColoredMuzzleFlashes = 201,
	MaxbotGameplayVO = 202,
	MaxbotFlavorVO = 203,
	RGIInputLatencyEnabled = 204,
	VoiceSelfMuteEnabled = 205,
	MatureContentFilter = 206,
	ShowBloodVisual = 207,
	ShowCorpsesVisual = 208,
	AllowCrossPlay = 209,
	ShowCrossPlayWarning = 210,
	ShowNewPlayerTips = 211,
	ContextAwareModuleComplete = 212,
	EnableToggleableUsables = 213,
	GamepadRiftCosmicDivideOffset = 214,
	GamepadClayAutomatedBackthrow = 215,
	EAresBoolSettingName_MAX = 216
};
...
enum class EGameFeatureToggleName : uint8 {
	...
	PODetection = 116,
	MobileAllySendRateLimiting = 117,
	PremiumContentToggle0 = 118,
	PremiumContentToggle1 = 119,
	PremiumContentToggle2 = 120,
	PremiumContentToggle3 = 121,
	PremiumContentToggle4 = 122,
	PremiumContentToggle5 = 123,
	PremiumContentToggle6 = 124,
	PremiumContentToggle7 = 125,
	PremiumContentToggle8 = 126,
	PremiumContentToggle9 = 127,
	GradualMovementCorrections = 128,
	DebugMenuEnabledDefault = 129,
	UseMeshMaterialManager = 130,
	OmenCustomEQS = 131,
	OmenWallToggle = 132,
	VisionConeIntersectionFix = 133,
	CorpsesBlockWorldDynamic = 134,
	RateLimitClientInputs = 135,
	ErrorPowerByStabilityType = 136,
	AccoladesEnabled = 137,
	PremierGameEvents = 138,
	EquippableCacheRecycling = 139,
	ViperPitIgnoreCrawlspaceToggle = 140,
	EsportsGameEvents = 141,
	ScaledHeadshotFX = 142,
	ExplicitCharacterLoading = 143,
	MinimapFloors = 144,
	ShortTermNPEUpdates = 145,
	FootstepDecayWhileWalking = 146,
	SystemicAbilityUpdates = 147,
	ConcussLowTickRate = 148,
	BombDestroysAllDestructibles = 149,
	OnlyDropCurrentEquippable = 150,
	ObserverMinimapComponentLocation = 151,
	EnableIncreasedNetDriverRateLimiting = 152,
	CellularPatchMultipleNodeOverlapCheck = 153,
	UseExtendedCombatReport = 154,
	AllowSkipRestrictionsForCurrentEquippable = 155,
	DisableFogOfWar = 156,
	RemoveClientPredictionDataForAI = 157,
	EsportsHub = 158,
	EnsureReplicationPauseSend = 159,
	PureTracers = 160,
	RebaseOnEnterFoW = 161,
	AbilityRechargeCooldownMulticastAll = 162,
	UsePlayerloadoutsInWeaponSpawners = 163,
	HideEnemyTracersOutsideGameplay = 164,
	KnifeOnlyFastFOV = 165,
	SkipEnemyMoveSendOutsideGameplay = 166,
	AllowPatchRunAlongGround = 167,
	SetOrbTickRateLow = 168,
	ReplayTimeScrubbing = 169,
	StopPreparedEffects = 170,
	EnableTapHoldActionBindings = 171,
	BotMovementDowntickingEnabled = 172,
	BotInterleaveMovementDowntickingEnabled = 173,
	AxialTracesCanUseComplexCollisionForEndpoints = 174,
	LimitedTrustedTargetingOnAbilities = 175,
	WraithSmokeInputPrototype = 176,
	CharacterLocationBunchData = 177,
	DoorsSnapToDefaultStateOnPostInitComponents = 178,
	CanCauseDamageWithNullDamageEventComponent = 179,
	LargeActorOverlapFixForWallMeshOverlap = 180,
	EnableDeadlockNeonTimedDoorEvacFix = 181,
	RemoveDeletedFXCsFromPool = 182,
	DisassociateAFKPlayers = 183,
	ReplayDataGameServerCompression = 184,
	OffsetHiddenMontages = 185,
	GamepadAimAccelResetEnabled = 186,
	GamepadAimAccelDelayResetEnabled = 187,
	LimitIncomingConnections = 188,
	VisionConeEarlyRelativeAngleCulling = 189,
	HapticDPTPrototyping = 190,
	ShootingRangeBotPoolingRefactor = 191,
	GamepadMegamapCommInput = 192,
	AccoladesTelemetryEnabled = 193,
	DDoSDetection = 194,
	AIToggleA = 195,
	AIToggleB = 196,
	TimeShiftByMoveBundles = 197,
	LockedMapControlType = 198,
	SwapViewTargetModeToWatchSpawnedOnDeath = 199,
	DisableCharacterTickOnRangeBots = 200,
	UseCachedBaseTeamComponentOnAresPlayerState = 201,
	ContextAwareModuleEnabled = 202,
	DisarmedComponentProgressesToEquipState = 203,
	PreventWeaponSwapSpamWhileDisarmed = 204,
	UnifyBaseAndRegionalDamageCalculation = 205,
	AllShotTelemetryEnabled = 206,
	AllyMapEdgePortraits = 207,
	PrecalcProjectileCollisionUsesTriggers = 208,
	UseAIJobCoordinationBehavior = 209,
	VTSPluginEnabled = 210,
	VTSPluginObserverEnabled = 211,
	ContextAwareModuleVisualsEnabled = 212,
	AIUseDistanceRoomPathfindingCosting = 213,
	EnableDoubleSniperOnAltModes = 214,
	ClientAuthBlinds = 215,
	SeparateCRInterpForRemoteClients = 216,
	EquippableReplicationImprovements = 217,
	SupportsNewPreRoundShop = 218,
	AlwaysTick3PAnimsForLocalPlayer = 219,
	PrimitiveComponentUpdateOverlapsChildren = 220,
	ValidPurchasableForItemClassCheck = 221,
	AnimationOptimizationBTM = 222,
	AnimationOptimizationBTMAllies = 223,
	FocusModeEnabled = 224,
	ArmorHUDFlooring = 225,
	UseNewInformationScreen = 226,
	AimToolingCloseRangeTuningEnabled = 227,
	DisableNonGamepadKeyBinds = 228,
	EnableGamepadVotingUI = 229,
	MinimapVisionConesWaitForTasks = 230,
	WallCollisionV2 = 231,
	MuzzleFlashCulling = 232,
	RunningSupersedesSpeedThresholdForSageSlowfieldSFX = 233,
	NonVerbalCommsPCBinding = 234,
	EnableCalculateWallPenetrationEnergyWhenDamaged = 235,
	NonVerbalCommsTelemetryEnabled = 236,
	Count = 237,
	Invalid = 254,
...
enum class EUIConfirmationModalResponse : uint8 {
	...
	Confirm = 1,
	Cancel = 2,
	EUIConfirmationModalResponse_MAX = 3
};
...
enum class EGamepadForceDesiredAngleMode : uint8 {
	Off = 0,
	OneToOne = 1,
	CustomCurve = 2,
	EGamepadForceDesiredAngleMode_MAX = 3
};
...
struct FMMRPlayer {
	...
	struct FString OnboardingStatus; // 0xa8(0x10)
};
...
struct FCrosshairSettings {
	...
	struct FLineCrosshairSettings FocusMode; // 0x100(0x80)
	struct FSniperCrosshairSettings Sniper; // 0x180(0x18)
	bool bUsePrimaryCrosshairForADS; // 0x198(0x01)
	bool bUsePrimaryCrosshairForFocusMode; // 0x199(0x01)
	bool bUseCustomCrosshairOnAllPrimary; // 0x19a(0x01)
	bool bUseAdvancedOptions; // 0x19b(0x01)
	bool bScaleToResolution; // 0x19c(0x01)
	char pad_19D[0x3]; // 0x19d(0x03)
	struct FString ProfileName; // 0x1a0(0x10)
};
...
// Size: 0x468 (Inherited: 0x00)
struct FAresInputStream {
	char pad_0[0x468]; // 0x00(0x468)
};
...
struct FGameClientInstanceInfo : FGameBaseInstanceInfo {
	...
	bool IsRunningOnUnknownDriveType; // 0x149(0x01)
...
struct FUINavigationGlobalsEntry {
	...
	bool bUseDisplayNameAsBreadcrumb; // 0x60(0x01)
	bool bHideParentBreadcrumb; // 0x61(0x01)
	char pad_62[0x6]; // 0x62(0x06)
	struct TSoftObjectPtr<UTexture2D> ScreenIcon; // 0x68(0x30)
	struct TSoftObjectPtr<UTexture2D> BackgroundArtOverride; // 0x98(0x30)
	struct FMenuStackMediaSourceParams BackgroundVideoOverride; // 0xc8(0x30)
	struct FShellWidgetVisibilityOptions ShellWidgetVisibilityOptions; // 0xf8(0x09)
	bool bIsLandingScreen; // 0x101(0x01)
	char pad_102[0x6]; // 0x102(0x06)
	struct TSoftClassPtr<UObject> NavigationButtonClass; // 0x108(0x30)
	struct TArray<struct FName> ValidChildScreens; // 0x138(0x10)
	int32_t NavigationBarIndex; // 0x148(0x04)
	char pad_14C[0x4]; // 0x14c(0x04)
	struct TArray<struct FModalContextInfo> ModalContext; // 0x150(0x10)
};
...
struct FAresPaginatedListConfiguration {
	...
	bool bShouldPaginationFocusFirstElement; // 0x08(0x01)
	bool bShouldPaginationFocusFallbackToFirstElement; // 0x09(0x01)
	char pad_A[0x2]; // 0x0a(0x02)
};
...
struct FNonPingEventTelemetryData {
	...
	struct FVector CommLocation; // 0x38(0x0c)
	char pad_44[0x4]; // 0x44(0x04)
	struct FString RoundPhase; // 0x48(0x10)
};
...
struct FPingEventTelemetryData {
	...
	struct FVector PingDestination; // 0x10(0x0c)
	struct FVector PingLocation; // 0x1c(0x0c)
	struct FString PingItem; // 0x28(0x10)
	int64_t PingSent; // 0x38(0x08)
	struct FString RoundPhase; // 0x40(0x10)
};
...
struct FPartyData {
	...
	enum class EAresTempType PrecisePlatformTypes; // 0x50(0x01)
