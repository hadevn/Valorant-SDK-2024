...
struct FConstraintNodeData {
	...
	struct FName LinkedNode; // 0x90(0x0c)
	char pad_9C[0x4]; // 0x9c(0x04)
	struct TArray<struct FTransformConstraint> Constraints; // 0xa0(0x10)
};
...
struct FAnimNode_ControlRig : FAnimNode_ControlRigBase {
	...
	struct FName AlphaCurveName; // 0x1d8(0x0c)
	struct FInputScaleBiasClamp AlphaScaleBiasClamp; // 0x1e4(0x30)
	...
	char pad_2B8[0xb0]; // 0x2b8(0xb0)
	int32_t LODThreshold; // 0x368(0x04)
...
struct FControlRigComponentMappedElement {
	...
	int32_t TransformIndex; // 0x30(0x04)
	struct FName TransformName; // 0x34(0x0c)
	enum class ERigElementType ElementType; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	struct FName ElementName; // 0x44(0x0c)
	enum class EControlRigComponentMapDirection Direction; // 0x50(0x01)
	char pad_51[0xf]; // 0x51(0x0f)
	struct FTransform Offset; // 0x60(0x30)
	float Weight; // 0x90(0x04)
	enum class EControlRigComponentSpace Space; // 0x94(0x01)
	char pad_95[0x3]; // 0x95(0x03)
	struct USceneComponent* SceneComponent; // 0x98(0x08)
	int32_t ElementIndex; // 0xa0(0x04)
	int32_t SubIndex; // 0xa4(0x04)
...
struct FControlRigDrawInstruction {
	...
	enum class EControlRigDrawSettings PrimitiveType; // 0x0c(0x01)
...
struct FControlRigGizmoDefinition {
	struct FName GizmoName; // 0x00(0x0c)
...
struct FIntegerParameterNameAndCurve {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct FMovieSceneIntegerChannel ParameterCurve; // 0x10(0x90)
};
...
struct FEnumParameterNameAndCurve {
	struct FName ParameterName; // 0x00(0x0c)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FMovieSceneByteChannel ParameterCurve; // 0x10(0x98)
};
...
struct FRigControl : FRigElement {
	...
	struct FTransform OffsetTransform; // 0x50(0x30)
	struct FRigControlValue InitialValue; // 0x80(0x80)
	struct FRigControlValue Value; // 0x100(0x80)
	enum class ERigControlAxis PrimaryAxis; // 0x180(0x01)
	bool bIsCurve; // 0x181(0x01)
	bool bAnimatable; // 0x182(0x01)
	bool bLimitTranslation; // 0x183(0x01)
	bool bLimitRotation; // 0x184(0x01)
	bool bLimitScale; // 0x185(0x01)
	bool bDrawLimits; // 0x186(0x01)
	char pad_187[0x9]; // 0x187(0x09)
	struct FRigControlValue MinimumValue; // 0x190(0x80)
	struct FRigControlValue MaximumValue; // 0x210(0x80)
	bool bGizmoEnabled; // 0x290(0x01)
	bool bGizmoVisible; // 0x291(0x01)
	char pad_292[0x2]; // 0x292(0x02)
	struct FName GizmoName; // 0x294(0x0c)
	struct FTransform GizmoTransform; // 0x2a0(0x30)
	struct FLinearColor GizmoColor; // 0x2d0(0x10)
	struct TArray<int32_t> Dependents; // 0x2e0(0x10)
	bool bIsTransientControl; // 0x2f0(0x01)
	char pad_2F1[0x7]; // 0x2f1(0x07)
	struct UEnum* ControlEnum; // 0x2f8(0x08)
};
...
struct FRigUnitMutable : FRigUnit {
	struct FControlRigExecuteContext ExecuteContext; // 0x08(0x68)
};
...
struct FRigUnit_AddBoneTransform : FRigUnitMutable {
	...
	bool bPostMultiply; // 0xb4(0x01)
	bool bPropagateToChildren; // 0xb5(0x01)
	char pad_B6[0x2]; // 0xb6(0x02)
	struct FCachedRigElement CachedBone; // 0xb8(0x18)
};
...
struct FRigUnit_AimItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKey Item; // 0x70(0x10)
	struct FRigUnit_AimItem_Target Primary; // 0x80(0x30)
	struct FRigUnit_AimItem_Target Secondary; // 0xb0(0x30)
	float Weight; // 0xe0(0x04)
	char pad_E4[0xc]; // 0xe4(0x0c)
	struct FRigUnit_AimBone_DebugSettings DebugSettings; // 0xf0(0x40)
	struct FCachedRigElement CachedItem; // 0x130(0x18)
	struct FCachedRigElement PrimaryCachedSpace; // 0x148(0x18)
	struct FCachedRigElement SecondaryCachedSpace; // 0x160(0x18)
...
struct FRigUnit_AimItem_Target {
	...
	struct FRigElementKey Space; // 0x20(0x10)
};
...
struct FRigUnit_AimBone : FRigUnit_HighlevelBaseMutable {
	struct FName Bone; // 0x70(0x0c)
	struct FRigUnit_AimBone_Target Primary; // 0x7c(0x2c)
	struct FRigUnit_AimBone_Target Secondary; // 0xa8(0x2c)
	float Weight; // 0xd4(0x04)
	bool bPropagateToChildren; // 0xd8(0x01)
	char pad_D9[0x7]; // 0xd9(0x07)
	struct FRigUnit_AimBone_DebugSettings DebugSettings; // 0xe0(0x40)
	struct FCachedRigElement CachedBoneIndex; // 0x120(0x18)
	struct FCachedRigElement PrimaryCachedSpace; // 0x138(0x18)
	struct FCachedRigElement SecondaryCachedSpace; // 0x150(0x18)
...
struct FRigUnit_AimBoneMath : FRigUnit_HighlevelBase {
	...
	struct FRigUnit_AimItem_Target Primary; // 0x40(0x30)
	struct FRigUnit_AimItem_Target Secondary; // 0x70(0x30)
	float Weight; // 0xa0(0x04)
	char pad_A4[0xc]; // 0xa4(0x0c)
	struct FTransform Result; // 0xb0(0x30)
	struct FRigUnit_AimBone_DebugSettings DebugSettings; // 0xe0(0x40)
	struct FCachedRigElement PrimaryCachedSpace; // 0x120(0x18)
	struct FCachedRigElement SecondaryCachedSpace; // 0x138(0x18)
};

// ScriptStruct ControlRig.RigUnit_AimConstraint
// Size: 0xc8 (Inherited: 0x70)
struct FRigUnit_AimConstraint : FRigUnitMutable {
	struct FName Joint; // 0x70(0x0c)
	enum class EAimMode AimMode; // 0x7c(0x01)
	enum class EAimMode UpMode; // 0x7d(0x01)
	char pad_7E[0x2]; // 0x7e(0x02)
	struct FVector AimVector; // 0x80(0x0c)
	struct FVector UpVector; // 0x8c(0x0c)
	struct TArray<struct FAimTarget> AimTargets; // 0x98(0x10)
	struct TArray<struct FAimTarget> UpTargets; // 0xa8(0x10)
	struct FRigUnit_AimConstraint_WorkData WorkData; // 0xb8(0x10)
};
...
struct FRigUnit_ApplyFK : FRigUnitMutable {
	...
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FTransform Transform; // 0x80(0x30)
	struct FTransformFilter Filter; // 0xb0(0x09)
	enum class EApplyTransformMode ApplyTransformMode; // 0xb9(0x01)
	enum class ETransformSpaceMode ApplyTransformSpace; // 0xba(0x01)
	char pad_BB[0x5]; // 0xbb(0x05)
	struct FTransform BaseTransform; // 0xc0(0x30)
	struct FName BaseJoint; // 0xf0(0x0c)
...
struct FRigUnit_ItemHarmonics : FRigUnit_HighlevelBaseMutable {
	struct TArray<struct FRigUnit_Harmonics_TargetItem> Targets; // 0x70(0x10)
	struct FVector WaveSpeed; // 0x80(0x0c)
	struct FVector WaveFrequency; // 0x8c(0x0c)
	struct FVector WaveAmplitude; // 0x98(0x0c)
	struct FVector WaveOffset; // 0xa4(0x0c)
	struct FVector WaveNoise; // 0xb0(0x0c)
	enum class EControlRigAnimEasingType WaveEase; // 0xbc(0x01)
	char pad_BD[0x3]; // 0xbd(0x03)
	float WaveMinimum; // 0xc0(0x04)
	float WaveMaximum; // 0xc4(0x04)
	enum class EControlRigRotationOrder RotationOrder; // 0xc8(0x01)
	char pad_C9[0x7]; // 0xc9(0x07)
	struct FRigUnit_BoneHarmonics_WorkData WorkData; // 0xd0(0x20)
};
...
struct FRigUnit_BoneHarmonics : FRigUnit_HighlevelBaseMutable {
	struct TArray<struct FRigUnit_BoneHarmonics_BoneTarget> Bones; // 0x70(0x10)
	struct FVector WaveSpeed; // 0x80(0x0c)
	struct FVector WaveFrequency; // 0x8c(0x0c)
	struct FVector WaveAmplitude; // 0x98(0x0c)
	struct FVector WaveOffset; // 0xa4(0x0c)
...
struct FRigUnit_CCDIKPerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKeyCollection Items; // 0x70(0x10)
...
struct FRigUnit_CCDIK : FRigUnit_HighlevelBaseMutable {
	struct FName StartBone; // 0x70(0x0c)
	struct FName EffectorBone; // 0x7c(0x0c)
	char pad_88[0x8]; // 0x88(0x08)
	struct FTransform EffectorTransform; // 0x90(0x30)
	float Precision; // 0xc0(0x04)
	float Weight; // 0xc4(0x04)
	int32_t MaxIterations; // 0xc8(0x04)
	bool bStartFromTail; // 0xcc(0x01)
	char pad_CD[0x3]; // 0xcd(0x03)
	float BaseRotationLimit; // 0xd0(0x04)
	char pad_D4[0x4]; // 0xd4(0x04)
	struct TArray<struct FRigUnit_CCDIK_RotationLimit> RotationLimits; // 0xd8(0x10)
	bool bPropagateToChildren; // 0xe8(0x01)
	char pad_E9[0x7]; // 0xe9(0x07)
	struct FRigUnit_CCDIK_WorkData WorkData; // 0xf0(0x58)
...
struct FRigUnit_ChainHarmonicsPerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKey ChainRoot; // 0x70(0x10)
	struct FVector Speed; // 0x80(0x0c)
	struct FRigUnit_ChainHarmonics_Reach Reach; // 0x8c(0x28)
	struct FRigUnit_ChainHarmonics_Wave Wave; // 0xb4(0x40)
	char pad_F4[0x4]; // 0xf4(0x04)
	struct FRuntimeFloatCurve WaveCurve; // 0xf8(0x88)
	struct FRigUnit_ChainHarmonics_Pendulum Pendulum; // 0x180(0x3c)
	bool bDrawDebug; // 0x1bc(0x01)
	char pad_1BD[0x3]; // 0x1bd(0x03)
	struct FTransform DrawWorldOffset; // 0x1c0(0x30)
	struct FRigUnit_ChainHarmonics_WorkData WorkData; // 0x1f0(0x90)
};
...
struct FRigUnit_ChainHarmonics : FRigUnit_HighlevelBaseMutable {
	struct FName ChainRoot; // 0x70(0x0c)
	struct FVector Speed; // 0x7c(0x0c)
	struct FRigUnit_ChainHarmonics_Reach Reach; // 0x88(0x28)
	struct FRigUnit_ChainHarmonics_Wave Wave; // 0xb0(0x40)
	struct FRuntimeFloatCurve WaveCurve; // 0xf0(0x88)
	struct FRigUnit_ChainHarmonics_Pendulum Pendulum; // 0x178(0x3c)
	bool bDrawDebug; // 0x1b4(0x01)
...
struct FRigUnit_CollectionLoop : FRigUnit_CollectionBaseMutable {
	struct FRigElementKeyCollection Collection; // 0x70(0x10)
	struct FRigElementKey Item; // 0x80(0x10)
	int32_t Index; // 0x90(0x04)
	int32_t Count; // 0x94(0x04)
	float Ratio; // 0x98(0x04)
	bool Continue; // 0x9c(0x01)
	char pad_9D[0x3]; // 0x9d(0x03)
	struct FControlRigExecuteContext Completed; // 0xa0(0x68)
};
...
struct FRigUnit_CollectionReplaceItems : FRigUnit_CollectionBase {
	...
	struct FRigElementKeyCollection CachedCollection; // 0x48(0x10)
	int32_t CachedHierarchyHash; // 0x58(0x04)
...
struct FRigUnit_CollectionChildren : FRigUnit_CollectionBase {
	...
	struct FRigElementKeyCollection CachedCollection; // 0x30(0x10)
	int32_t CachedHierarchyHash; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
};
...
struct FRigUnit_DebugBezierItemSpace : FRigUnit_DebugBaseMutable {
	struct FCRFourPointBezier Bezier; // 0x70(0x30)
	float MinimumU; // 0xa0(0x04)
	float MaximumU; // 0xa4(0x04)
	struct FLinearColor Color; // 0xa8(0x10)
	float Thickness; // 0xb8(0x04)
	int32_t Detail; // 0xbc(0x04)
	struct FRigElementKey Space; // 0xc0(0x10)
...
struct FRigUnit_DebugHierarchy : FRigUnit_DebugBaseMutable {
	...
	char pad_88[0x8]; // 0x88(0x08)
	struct FTransform WorldOffset; // 0x90(0x30)
...
struct FRigUnit_DebugLineItemSpace : FRigUnit_DebugBaseMutable {
	struct FVector A; // 0x70(0x0c)
	struct FVector B; // 0x7c(0x0c)
	struct FLinearColor Color; // 0x88(0x10)
	float Thickness; // 0x98(0x04)
	struct FRigElementKey Space; // 0x9c(0x10)
	char pad_AC[0x4]; // 0xac(0x04)
	struct FTransform WorldOffset; // 0xb0(0x30)
...
struct FRigUnit_DebugLineStripItemSpace : FRigUnit_DebugBaseMutable {
	struct TArray<struct FVector> Points; // 0x70(0x10)
	struct FLinearColor Color; // 0x80(0x10)
	float Thickness; // 0x90(0x04)
	struct FRigElementKey Space; // 0x94(0x10)
	char pad_A4[0xc]; // 0xa4(0x0c)
	struct FTransform WorldOffset; // 0xb0(0x30)
	bool bEnabled; // 0xe0(0x01)
	char pad_E1[0xf]; // 0xe1(0x0f)
...
struct FRigUnit_DebugPointMutable : FRigUnit_DebugBaseMutable {
	struct FVector Vector; // 0x70(0x0c)
	enum class ERigUnitDebugPointMode Mode; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	struct FLinearColor Color; // 0x80(0x10)
	float Scale; // 0x90(0x04)
	float Thickness; // 0x94(0x04)
	struct FName Space; // 0x98(0x0c)
	char pad_A4[0xc]; // 0xa4(0x0c)
	struct FTransform WorldOffset; // 0xb0(0x30)
	bool bEnabled; // 0xe0(0x01)
	char pad_E1[0xf]; // 0xe1(0x0f)
...
struct FRigUnit_DebugArcItemSpace : FRigUnit_DebugBaseMutable {
	...
	struct FRigElementKey Space; // 0xc4(0x10)
	char pad_D4[0xc]; // 0xd4(0x0c)
	struct FTransform WorldOffset; // 0xe0(0x30)
	bool bEnabled; // 0x110(0x01)
...
struct FRigUnit_DebugRectangleItemSpace : FRigUnit_DebugBaseMutable {
	...
	struct FRigElementKey Space; // 0xb8(0x10)
...
struct FRigUnit_DebugTransformArrayMutable : FRigUnit_DebugBaseMutable {
	struct TArray<struct FTransform> Transforms; // 0x70(0x10)
	enum class ERigUnitDebugTransformMode Mode; // 0x80(0x01)
	char pad_81[0x3]; // 0x81(0x03)
	struct FLinearColor Color; // 0x84(0x10)
	float Thickness; // 0x94(0x04)
	float Scale; // 0x98(0x04)
	struct FName Space; // 0x9c(0x0c)
	char pad_A8[0x8]; // 0xa8(0x08)
	struct FTransform WorldOffset; // 0xb0(0x30)
	bool bEnabled; // 0xe0(0x01)
...
struct FRigUnit_DebugTransformMutableItemSpace : FRigUnit_DebugBaseMutable {
	...
	struct FRigElementKey Space; // 0xbc(0x10)
	char pad_CC[0x4]; // 0xcc(0x04)
	struct FTransform WorldOffset; // 0xd0(0x30)
	bool bEnabled; // 0x100(0x01)
	char pad_101[0xf]; // 0x101(0x0f)
...
struct FRigUnit_DistributeRotationForCollection : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKeyCollection Items; // 0x70(0x10)
	struct TArray<struct FRigUnit_DistributeRotation_Rotation> Rotations; // 0x80(0x10)
	enum class EControlRigAnimEasingType RotationEaseType; // 0x90(0x01)
...
struct FRigUnit_DistributeRotation : FRigUnit_HighlevelBaseMutable {
	struct FName StartBone; // 0x70(0x0c)
	struct FName EndBone; // 0x7c(0x0c)
	struct TArray<struct FRigUnit_DistributeRotation_Rotation> Rotations; // 0x88(0x10)
	enum class EControlRigAnimEasingType RotationEaseType; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	float Weight; // 0x9c(0x04)
	bool bPropagateToChildren; // 0xa0(0x01)
	char pad_A1[0x7]; // 0xa1(0x07)
	struct FRigUnit_DistributeRotation_WorkData WorkData; // 0xa8(0x50)
};

// ScriptStruct ControlRig.RigUnit_DrawContainerSetTransform
// Size: 0xb0 (Inherited: 0x70)
struct FRigUnit_DrawContainerSetTransform : FRigUnitMutable {
	struct FName InstructionName; // 0x70(0x0c)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FTransform Transform; // 0x80(0x30)
};
...
struct FRigUnit_FABRIK : FRigUnit_HighlevelBaseMutable {
	...
	struct FRigUnit_FABRIK_WorkData WorkData; // 0xd0(0x38)
...
struct FRigUnit_FitChainToCurvePerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKeyCollection Items; // 0x70(0x10)
	struct FCRFourPointBezier Bezier; // 0x80(0x30)
	enum class EControlRigCurveAlignment Alignment; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	float Minimum; // 0xb4(0x04)
	float Maximum; // 0xb8(0x04)
	int32_t SamplingPrecision; // 0xbc(0x04)
	struct FVector PrimaryAxis; // 0xc0(0x0c)
	struct FVector SecondaryAxis; // 0xcc(0x0c)
	struct FVector PoleVectorPosition; // 0xd8(0x0c)
	char pad_E4[0x4]; // 0xe4(0x04)
	struct TArray<struct FRigUnit_FitChainToCurve_Rotation> Rotations; // 0xe8(0x10)
	enum class EControlRigAnimEasingType RotationEaseType; // 0xf8(0x01)
	char pad_F9[0x3]; // 0xf9(0x03)
	float Weight; // 0xfc(0x04)
	bool bPropagateToChildren; // 0x100(0x01)
	char pad_101[0xf]; // 0x101(0x0f)
	struct FRigUnit_FitChainToCurve_DebugSettings DebugSettings; // 0x110(0x60)
...
struct FRigUnit_FitChainToCurve : FRigUnit_HighlevelBaseMutable {
	struct FName StartBone; // 0x70(0x0c)
	struct FName EndBone; // 0x7c(0x0c)
	struct FCRFourPointBezier Bezier; // 0x88(0x30)
	enum class EControlRigCurveAlignment Alignment; // 0xb8(0x01)
	char pad_B9[0x3]; // 0xb9(0x03)
	float Minimum; // 0xbc(0x04)
	float Maximum; // 0xc0(0x04)
	int32_t SamplingPrecision; // 0xc4(0x04)
	struct FVector PrimaryAxis; // 0xc8(0x0c)
	struct FVector SecondaryAxis; // 0xd4(0x0c)
	struct FVector PoleVectorPosition; // 0xe0(0x0c)
	char pad_EC[0x4]; // 0xec(0x04)
	struct TArray<struct FRigUnit_FitChainToCurve_Rotation> Rotations; // 0xf0(0x10)
	enum class EControlRigAnimEasingType RotationEaseType; // 0x100(0x01)
...
struct FRigUnit_ForLoopCount : FRigUnitMutable {
	...
	int32_t Index; // 0x74(0x04)
	float Ratio; // 0x78(0x04)
	bool Continue; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	struct FControlRigExecuteContext Completed; // 0x80(0x68)
};
...
struct FRigUnit_GetBoneTransform : FRigUnit {
	...
	struct FCachedRigElement CachedBone; // 0x50(0x18)
	char pad_68[0x8]; // 0x68(0x08)
};
...
struct FRigUnit_GetControlTransform : FRigUnit {
	...
	struct FCachedRigElement CachedControlIndex; // 0xb0(0x18)
	char pad_C8[0x8]; // 0xc8(0x08)
};
...
struct FRigUnit_GetControlRotator : FRigUnit {
	...
	enum class EBoneGetterSetterMode Space; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FRotator Rotator; // 0x18(0x0c)
	struct FRotator Minimum; // 0x24(0x0c)
	struct FRotator Maximum; // 0x30(0x0c)
	struct FCachedRigElement CachedControlIndex; // 0x3c(0x18)
	char pad_54[0x4]; // 0x54(0x04)
};
...
struct FRigUnit_GetControlVector : FRigUnit {
	...
	struct FVector Minimum; // 0x24(0x0c)
	struct FVector Maximum; // 0x30(0x0c)
	struct FCachedRigElement CachedControlIndex; // 0x3c(0x18)
	char pad_54[0x4]; // 0x54(0x04)
};
...
struct FRigUnit_GetControlVector2D : FRigUnit {
	struct FName Control; // 0x08(0x0c)
	struct FVector2D Vector; // 0x14(0x08)
	struct FVector2D Minimum; // 0x1c(0x08)
	struct FVector2D Maximum; // 0x24(0x08)
	struct FCachedRigElement CachedControlIndex; // 0x2c(0x18)
	char pad_44[0x4]; // 0x44(0x04)
};
...
struct FRigUnit_GetJointTransform : FRigUnitMutable {
	struct FName Joint; // 0x70(0x0c)
	enum class ETransformGetterType Type; // 0x7c(0x01)
	enum class ETransformSpaceMode TransformSpace; // 0x7d(0x01)
	char pad_7E[0x2]; // 0x7e(0x02)
	struct FTransform BaseTransform; // 0x80(0x30)
	struct FName BaseJoint; // 0xb0(0x0c)
...
struct FRigUnit_GetRelativeBoneTransform : FRigUnit {
	...
	struct FTransform Transform; // 0x20(0x30)
	struct FCachedRigElement CachedBone; // 0x50(0x18)
	struct FCachedRigElement CachedSpace; // 0x68(0x18)
};
...
struct FRigUnit_GetRelativeTransformForItem : FRigUnit {
	...
	struct FCachedRigElement CachedChild; // 0x60(0x18)
	struct FCachedRigElement CachedParent; // 0x78(0x18)
};
...
struct FRigUnit_GetSpaceTransform : FRigUnit {
	struct FName Space; // 0x08(0x0c)
	enum class EBoneGetterSetterMode SpaceType; // 0x14(0x01)
	char pad_15[0xb]; // 0x15(0x0b)
	struct FTransform Transform; // 0x20(0x30)
	struct FCachedRigElement CachedSpaceIndex; // 0x50(0x18)
	char pad_68[0x8]; // 0x68(0x08)
};
...
struct FRigUnit_HierarchyGetSiblings : FRigUnit_HierarchyBase {
	...
	struct FCachedRigElement CachedItem; // 0x30(0x18)
...
struct FRigUnit_HierarchyGetParents : FRigUnit_HierarchyBase {
	...
	struct FCachedRigElement CachedChild; // 0x30(0x18)
...
struct FRigUnit_HierarchyGetParent : FRigUnit_HierarchyBase {
	...
	struct FCachedRigElement CachedParent; // 0x40(0x18)
};
...
struct FRigUnit_ItemExists : FRigUnit_ItemBase {
	...
	char pad_19[0x3]; // 0x19(0x03)
	struct FCachedRigElement CachedIndex; // 0x1c(0x18)
...
struct FRigUnit_ModifyBoneTransforms : FRigUnit_HighlevelBaseMutable {
	struct TArray<struct FRigUnit_ModifyBoneTransforms_PerBone> BoneToModify; // 0x70(0x10)
	float Weight; // 0x80(0x04)
	float WeightMinimum; // 0x84(0x04)
	float WeightMaximum; // 0x88(0x04)
	enum class EControlRigModifyBoneMode Mode; // 0x8c(0x01)
	char pad_8D[0x3]; // 0x8d(0x03)
	struct FRigUnit_ModifyBoneTransforms_WorkData WorkData; // 0x90(0x10)
};
...
struct FRigUnit_ModifyTransforms : FRigUnit_HighlevelBaseMutable {
	struct TArray<struct FRigUnit_ModifyTransforms_PerItem> ItemToModify; // 0x70(0x10)
	float Weight; // 0x80(0x04)
	float WeightMinimum; // 0x84(0x04)
	float WeightMaximum; // 0x88(0x04)
	enum class EControlRigModifyBoneMode Mode; // 0x8c(0x01)
	char pad_8D[0x3]; // 0x8d(0x03)
	struct FRigUnit_ModifyTransforms_WorkData WorkData; // 0x90(0x10)
};
...
struct FRigUnit_MultiFABRIK : FRigUnit_HighlevelBaseMutable {
	struct FName RootBone; // 0x70(0x0c)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct TArray<struct FRigUnit_MultiFABRIK_EndEffector> Effectors; // 0x80(0x10)
	float Precision; // 0x90(0x04)
	bool bPropagateToChildren; // 0x94(0x01)
	char pad_95[0x3]; // 0x95(0x03)
	int32_t MaxIterations; // 0x98(0x04)
	char pad_9C[0x4]; // 0x9c(0x04)
	struct FRigUnit_MultiFABRIK_WorkData WorkData; // 0xa0(0x60)
};
...
struct FRigUnit_ParentSwitchConstraint : FRigUnitMutable {
	struct FRigElementKey Subject; // 0x70(0x10)
	int32_t ParentIndex; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
	struct FRigElementKeyCollection Parents; // 0x88(0x10)
	char pad_98[0x8]; // 0x98(0x08)
	struct FTransform InitialGlobalTransform; // 0xa0(0x30)
	float Weight; // 0xd0(0x04)
	char pad_D4[0xc]; // 0xd4(0x0c)
	struct FTransform Transform; // 0xe0(0x30)
	bool Switched; // 0x110(0x01)
	char pad_111[0x3]; // 0x111(0x03)
	struct FCachedRigElement CachedSubject; // 0x114(0x18)
	struct FCachedRigElement CachedParent; // 0x12c(0x18)
	char pad_144[0xc]; // 0x144(0x0c)
	struct FTransform RelativeOffset; // 0x150(0x30)
};
...
struct FRigUnit_PointSimulation : FRigUnit_SimBaseMutable {
	struct TArray<struct FCRSimPoint> Points; // 0x70(0x10)
	struct TArray<struct FCRSimLinearSpring> Links; // 0x80(0x10)
	struct TArray<struct FCRSimPointForce> Forces; // 0x90(0x10)
	struct TArray<struct FCRSimSoftCollision> CollisionVolumes; // 0xa0(0x10)
	float SimulatedStepsPerSecond; // 0xb0(0x04)
	enum class ECRSimPointIntegrateType IntegratorType; // 0xb4(0x01)
	char pad_B5[0x3]; // 0xb5(0x03)
	float VerletBlend; // 0xb8(0x04)
	char pad_BC[0x4]; // 0xbc(0x04)
	struct TArray<struct FRigUnit_PointSimulation_BoneTarget> BoneTargets; // 0xc0(0x10)
	bool bLimitLocalPosition; // 0xd0(0x01)
	bool bPropagateToChildren; // 0xd1(0x01)
	char pad_D2[0x2]; // 0xd2(0x02)
	struct FVector PrimaryAimAxis; // 0xd4(0x0c)
	struct FVector SecondaryAimAxis; // 0xe0(0x0c)
	char pad_EC[0x4]; // 0xec(0x04)
...
struct FRigUnit_EndProfilingTimer : FRigUnit_DebugBaseMutable {
	int32_t NumberOfMeasurements; // 0x70(0x04)
	char pad_74[0x4]; // 0x74(0x04)
	struct FString Prefix; // 0x78(0x10)
	float AccumulatedTime; // 0x88(0x04)
	int32_t MeasurementsLeft; // 0x8c(0x04)
};
...
struct FRigUnit_ProjectTransformToNewParent : FRigUnit {
	...
	struct FCachedRigElement CachedOldParent; // 0x98(0x18)
	struct FCachedRigElement CachedNewParent; // 0xb0(0x18)
	char pad_C8[0x8]; // 0xc8(0x08)
};
...
struct FRigUnit_PropagateTransform : FRigUnitMutable {
	struct FRigElementKey Item; // 0x70(0x10)
	bool bRecomputeGlobal; // 0x80(0x01)
	bool bApplyToChildren; // 0x81(0x01)
	bool bRecursive; // 0x82(0x01)
	char pad_83[0x1]; // 0x83(0x01)
	struct FCachedRigElement CachedIndex; // 0x84(0x18)
	char pad_9C[0x4]; // 0x9c(0x04)
};
...
struct FRigUnit_SendEvent : FRigUnitMutable {
	enum class ERigEvent Event; // 0x70(0x01)
	char pad_71[0x3]; // 0x71(0x03)
	struct FRigElementKey Item; // 0x74(0x10)
	float OffsetInSeconds; // 0x84(0x04)
	bool bEnable; // 0x88(0x01)
	bool bOnlyDuringInteraction; // 0x89(0x01)
...
struct FRigUnit_SequenceExecution : FRigUnit {
	struct FControlRigExecuteContext ExecuteContext; // 0x08(0x68)
	struct FControlRigExecuteContext A; // 0x70(0x68)
	struct FControlRigExecuteContext B; // 0xd8(0x68)
	struct FControlRigExecuteContext C; // 0x140(0x68)
	struct FControlRigExecuteContext D; // 0x1a8(0x68)
};
...
struct FRigUnit_SetBoneInitialTransform : FRigUnitMutable {
	...
	bool bPropagateToChildren; // 0xe1(0x01)
	char pad_E2[0x2]; // 0xe2(0x02)
	struct FCachedRigElement CachedBone; // 0xe4(0x18)
	char pad_FC[0x4]; // 0xfc(0x04)
};
...
struct FRigUnit_SetBoneRotation : FRigUnitMutable {
	...
	enum class EBoneGetterSetterMode Space; // 0x90(0x01)
	char pad_91[0x3]; // 0x91(0x03)
	float Weight; // 0x94(0x04)
	bool bPropagateToChildren; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	struct FCachedRigElement CachedBone; // 0x9c(0x18)
...
struct FRigUnit_SetBoneTransform : FRigUnitMutable {
	...
	float Weight; // 0xe4(0x04)
	bool bPropagateToChildren; // 0xe8(0x01)
	char pad_E9[0x3]; // 0xe9(0x03)
	struct FCachedRigElement CachedBone; // 0xec(0x18)
...
struct FRigUnit_SetBoneTranslation : FRigUnitMutable {
	struct FName Bone; // 0x70(0x0c)
	struct FVector Translation; // 0x7c(0x0c)
	enum class EBoneGetterSetterMode Space; // 0x88(0x01)
	char pad_89[0x3]; // 0x89(0x03)
	float Weight; // 0x8c(0x04)
	bool bPropagateToChildren; // 0x90(0x01)
	char pad_91[0x3]; // 0x91(0x03)
	struct FCachedRigElement CachedBone; // 0x94(0x18)
	char pad_AC[0x4]; // 0xac(0x04)
};
...
struct FRigUnit_SetControlColor : FRigUnitMutable {
	struct FName Control; // 0x70(0x0c)
	struct FLinearColor Color; // 0x7c(0x10)
	struct FCachedRigElement CachedControlIndex; // 0x8c(0x18)
...
struct FRigUnit_SetControlOffset : FRigUnitMutable {
	struct FName Control; // 0x70(0x0c)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FTransform Offset; // 0x80(0x30)
	enum class EBoneGetterSetterMode Space; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	struct FCachedRigElement CachedControlIndex; // 0xb4(0x18)
	char pad_CC[0x4]; // 0xcc(0x04)
};
...
struct FRigUnit_SetMultiControlRotator : FRigUnitMutable {
	struct TArray<struct FRigUnit_SetMultiControlRotator_Entry> Entries; // 0x70(0x10)
	float Weight; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
	struct TArray<struct FCachedRigElement> CachedControlIndices; // 0x88(0x10)
};
...
struct FRigUnit_SetControlRotator : FRigUnitMutable {
	struct FName Control; // 0x70(0x0c)
	float Weight; // 0x7c(0x04)
	struct FRotator Rotator; // 0x80(0x0c)
	enum class EBoneGetterSetterMode Space; // 0x8c(0x01)
	char pad_8D[0x3]; // 0x8d(0x03)
	struct FCachedRigElement CachedControlIndex; // 0x90(0x18)
};
...
struct FRigUnit_SetControlVector : FRigUnitMutable {
	struct FName Control; // 0x70(0x0c)
	float Weight; // 0x7c(0x04)
	struct FVector Vector; // 0x80(0x0c)
	enum class EBoneGetterSetterMode Space; // 0x8c(0x01)
	char pad_8D[0x3]; // 0x8d(0x03)
	struct FCachedRigElement CachedControlIndex; // 0x90(0x18)
};
...
struct FRigUnit_SetMultiControlVector2D : FRigUnitMutable {
	struct TArray<struct FRigUnit_SetMultiControlVector2D_Entry> Entries; // 0x70(0x10)
	float Weight; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
	struct TArray<struct FCachedRigElement> CachedControlIndices; // 0x88(0x10)
};
...
struct FRigUnit_SetMultiControlVector2D_Entry {
	struct FName Control; // 0x00(0x0c)
	struct FVector2D Vector; // 0x0c(0x08)
};
...
struct FRigUnit_SetControlVector2D : FRigUnitMutable {
	struct FName Control; // 0x70(0x0c)
	float Weight; // 0x7c(0x04)
	struct FVector2D Vector; // 0x80(0x08)
	struct FCachedRigElement CachedControlIndex; // 0x88(0x18)
};

// ScriptStruct ControlRig.RigUnit_SetMultiControlInteger
// Size: 0x98 (Inherited: 0x70)
struct FRigUnit_SetMultiControlInteger : FRigUnitMutable {
	struct TArray<struct FRigUnit_SetMultiControlInteger_Entry> Entries; // 0x70(0x10)
	float Weight; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
	struct TArray<struct FCachedRigElement> CachedControlIndices; // 0x88(0x10)
};
...
struct FRigUnit_SetControlInteger : FRigUnitMutable {
	...
	int32_t IntegerValue; // 0x80(0x04)
	struct FCachedRigElement CachedControlIndex; // 0x84(0x18)
	char pad_9C[0x4]; // 0x9c(0x04)
};
...
struct FRigUnit_SetMultiControlFloat : FRigUnitMutable {
	struct TArray<struct FRigUnit_SetMultiControlFloat_Entry> Entries; // 0x70(0x10)
	float Weight; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
	struct TArray<struct FCachedRigElement> CachedControlIndices; // 0x88(0x10)
};
...
struct FRigUnit_SetMultiControlBool : FRigUnitMutable {
	struct TArray<struct FRigUnit_SetMultiControlBool_Entry> Entries; // 0x70(0x10)
...
struct FRigUnit_SetControlBool : FRigUnitMutable {
	struct FName Control; // 0x70(0x0c)
	bool BoolValue; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	struct FCachedRigElement CachedControlIndex; // 0x80(0x18)
};
...
struct FRigUnit_SetControlVisibility : FRigUnitMutable {
	struct FRigElementKey Item; // 0x70(0x10)
	struct FString Pattern; // 0x80(0x10)
	bool bVisible; // 0x90(0x01)
	char pad_91[0x7]; // 0x91(0x07)
	struct TArray<struct FCachedRigElement> CachedControlIndices; // 0x98(0x10)
};

// ScriptStruct ControlRig.RigUnit_SetCurveValue
// Size: 0x98 (Inherited: 0x70)
struct FRigUnit_SetCurveValue : FRigUnitMutable {
	struct FName Curve; // 0x70(0x0c)
	float Value; // 0x7c(0x04)
	struct FCachedRigElement CachedCurveIndex; // 0x80(0x18)
};
...
struct FRigUnit_SetRelativeBoneTransform : FRigUnitMutable {
	struct FName Bone; // 0x70(0x0c)
	struct FName Space; // 0x7c(0x0c)
	char pad_88[0x8]; // 0x88(0x08)
	struct FTransform Transform; // 0x90(0x30)
	float Weight; // 0xc0(0x04)
	bool bPropagateToChildren; // 0xc4(0x01)
	char pad_C5[0x3]; // 0xc5(0x03)
	struct FCachedRigElement CachedBone; // 0xc8(0x18)
	struct FCachedRigElement CachedSpaceIndex; // 0xe0(0x18)
	char pad_F8[0x8]; // 0xf8(0x08)
};
...
struct FRigUnit_SetRelativeTransformForItem : FRigUnitMutable {
	struct FRigElementKey Child; // 0x70(0x10)
	struct FRigElementKey Parent; // 0x80(0x10)
	bool bParentInitial; // 0x90(0x01)
	char pad_91[0xf]; // 0x91(0x0f)
	struct FTransform RelativeTransform; // 0xa0(0x30)
	float Weight; // 0xd0(0x04)
	bool bPropagateToChildren; // 0xd4(0x01)
	char pad_D5[0x3]; // 0xd5(0x03)
	struct FCachedRigElement CachedChild; // 0xd8(0x18)
	struct FCachedRigElement CachedParent; // 0xf0(0x18)
	char pad_108[0x8]; // 0x108(0x08)
};
...
struct FRigUnit_SetSpaceInitialTransform : FRigUnitMutable {
	struct FName SpaceName; // 0x70(0x0c)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FTransform Transform; // 0x80(0x30)
	struct FTransform Result; // 0xb0(0x30)
	enum class EBoneGetterSetterMode Space; // 0xe0(0x01)
	char pad_E1[0x3]; // 0xe1(0x03)
	struct FCachedRigElement CachedSpaceIndex; // 0xe4(0x18)
	char pad_FC[0x4]; // 0xfc(0x04)
};
...
struct FRigUnit_SetSpaceTransform : FRigUnitMutable {
	struct FName Space; // 0x70(0x0c)
	float Weight; // 0x7c(0x04)
	struct FTransform Transform; // 0x80(0x30)
	enum class EBoneGetterSetterMode SpaceType; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	struct FCachedRigElement CachedSpaceIndex; // 0xb4(0x18)
	char pad_CC[0x4]; // 0xcc(0x04)
};
...
struct FRigUnit_SetScale : FRigUnitMutable {
	...
	char pad_81[0x3]; // 0x81(0x03)
	struct FVector Scale; // 0x84(0x0c)
	float Weight; // 0x90(0x04)
	bool bPropagateToChildren; // 0x94(0x01)
	char pad_95[0x3]; // 0x95(0x03)
	struct FCachedRigElement CachedIndex; // 0x98(0x18)
};
...
struct FRigUnit_SetRotation : FRigUnitMutable {
	...
	struct FQuat Rotation; // 0x90(0x10)
	float Weight; // 0xa0(0x04)
...
struct FRigUnit_SetTranslation : FRigUnitMutable {
	...
	enum class EBoneGetterSetterMode Space; // 0x80(0x01)
	char pad_81[0x3]; // 0x81(0x03)
	struct FVector Translation; // 0x84(0x0c)
	float Weight; // 0x90(0x04)
	bool bPropagateToChildren; // 0x94(0x01)
	char pad_95[0x3]; // 0x95(0x03)
	struct FCachedRigElement CachedIndex; // 0x98(0x18)
...
struct FRigUnit_SetTransform : FRigUnitMutable {
	struct FRigElementKey Item; // 0x70(0x10)
	enum class EBoneGetterSetterMode Space; // 0x80(0x01)
	bool bInitial; // 0x81(0x01)
	char pad_82[0xe]; // 0x82(0x0e)
	struct FTransform Transform; // 0x90(0x30)
	float Weight; // 0xc0(0x04)
	bool bPropagateToChildren; // 0xc4(0x01)
	char pad_C5[0x3]; // 0xc5(0x03)
	struct FCachedRigElement CachedIndex; // 0xc8(0x18)
};
...
struct FRigUnit_SlideChainPerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKeyCollection Items; // 0x70(0x10)
	float SlideAmount; // 0x80(0x04)
	bool bPropagateToChildren; // 0x84(0x01)
	char pad_85[0x3]; // 0x85(0x03)
	struct FRigUnit_SlideChain_WorkData WorkData; // 0x88(0x48)
};
...
struct FRigUnit_SlideChain : FRigUnit_HighlevelBaseMutable {
	struct FName StartBone; // 0x70(0x0c)
	struct FName EndBone; // 0x7c(0x0c)
	float SlideAmount; // 0x88(0x04)
	bool bPropagateToChildren; // 0x8c(0x01)
	char pad_8D[0x3]; // 0x8d(0x03)
	struct FRigUnit_SlideChain_WorkData WorkData; // 0x90(0x48)
};
...
struct FRigUnit_SpringIK : FRigUnit_HighlevelBaseMutable {
	struct FName StartBone; // 0x70(0x0c)
	struct FName EndBone; // 0x7c(0x0c)
	float HierarchyStrength; // 0x88(0x04)
	float EffectorStrength; // 0x8c(0x04)
	float EffectorRatio; // 0x90(0x04)
	float RootStrength; // 0x94(0x04)
	float RootRatio; // 0x98(0x04)
	float Damping; // 0x9c(0x04)
	struct FVector PoleVector; // 0xa0(0x0c)
	bool bFlipPolePlane; // 0xac(0x01)
	enum class EControlRigVectorKind PoleVectorKind; // 0xad(0x01)
	char pad_AE[0x2]; // 0xae(0x02)
	struct FName PoleVectorSpace; // 0xb0(0x0c)
	struct FVector PrimaryAxis; // 0xbc(0x0c)
	struct FVector SecondaryAxis; // 0xc8(0x0c)
	bool bLiveSimulation; // 0xd4(0x01)
	char pad_D5[0x3]; // 0xd5(0x03)
	int32_t Iterations; // 0xd8(0x04)
	bool bLimitLocalPosition; // 0xdc(0x01)
	bool bPropagateToChildren; // 0xdd(0x01)
	char pad_DE[0x2]; // 0xde(0x02)
	struct FRigUnit_SpringIK_DebugSettings DebugSettings; // 0xe0(0x50)
	struct FRigUnit_SpringIK_WorkData WorkData; // 0x130(0xb0)
};
...
struct FRigUnit_TransformConstraintPerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKey Item; // 0x70(0x10)
	enum class ETransformSpaceMode BaseTransformSpace; // 0x80(0x01)
	char pad_81[0xf]; // 0x81(0x0f)
	struct FTransform BaseTransform; // 0x90(0x30)
	struct FRigElementKey BaseItem; // 0xc0(0x10)
	struct TArray<struct FConstraintTarget> Targets; // 0xd0(0x10)
	bool bUseInitialTransforms; // 0xe0(0x01)
	char pad_E1[0x7]; // 0xe1(0x07)
	struct FRigUnit_TransformConstraint_WorkData WorkData; // 0xe8(0x60)
	char pad_148[0x8]; // 0x148(0x08)
};
...
struct FRigUnit_TransformConstraint : FRigUnit_HighlevelBaseMutable {
	struct FName Bone; // 0x70(0x0c)
	enum class ETransformSpaceMode BaseTransformSpace; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	struct FTransform BaseTransform; // 0x80(0x30)
	struct FName BaseBone; // 0xb0(0x0c)
	char pad_BC[0x4]; // 0xbc(0x04)
...
struct FRigUnit_TwistBonesPerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKeyCollection Items; // 0x70(0x10)
	struct FVector TwistAxis; // 0x80(0x0c)
	struct FVector PoleAxis; // 0x8c(0x0c)
	enum class EControlRigAnimEasingType TwistEaseType; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	float Weight; // 0x9c(0x04)
	bool bPropagateToChildren; // 0xa0(0x01)
	char pad_A1[0x7]; // 0xa1(0x07)
	struct FRigUnit_TwistBones_WorkData WorkData; // 0xa8(0x30)
};
...
struct FRigUnit_TwistBones : FRigUnit_HighlevelBaseMutable {
	struct FName StartBone; // 0x70(0x0c)
	struct FName EndBone; // 0x7c(0x0c)
	struct FVector TwistAxis; // 0x88(0x0c)
	struct FVector PoleAxis; // 0x94(0x0c)
	enum class EControlRigAnimEasingType TwistEaseType; // 0xa0(0x01)
	char pad_A1[0x3]; // 0xa1(0x03)
	float Weight; // 0xa4(0x04)
	bool bPropagateToChildren; // 0xa8(0x01)
	char pad_A9[0x7]; // 0xa9(0x07)
	struct FRigUnit_TwistBones_WorkData WorkData; // 0xb0(0x30)
};

// ScriptStruct ControlRig.RigUnit_TwoBoneIKFK
// Size: 0x230 (Inherited: 0x70)
struct FRigUnit_TwoBoneIKFK : FRigUnitMutable {
	struct FName StartJoint; // 0x70(0x0c)
	struct FName EndJoint; // 0x7c(0x0c)
	struct FVector PoleTarget; // 0x88(0x0c)
	float Spin; // 0x94(0x04)
	char pad_98[0x8]; // 0x98(0x08)
	struct FTransform EndEffector; // 0xa0(0x30)
	float IKBlend; // 0xd0(0x04)
	char pad_D4[0xc]; // 0xd4(0x0c)
	struct FTransform StartJointFKTransform; // 0xe0(0x30)
	struct FTransform MidJointFKTransform; // 0x110(0x30)
	struct FTransform EndJointFKTransform; // 0x140(0x30)
	float PreviousFKIKBlend; // 0x170(0x04)
	char pad_174[0xc]; // 0x174(0x0c)
	struct FTransform StartJointIKTransform; // 0x180(0x30)
	struct FTransform MidJointIKTransform; // 0x1b0(0x30)
	struct FTransform EndJointIKTransform; // 0x1e0(0x30)
	int32_t StartJointIndex; // 0x210(0x04)
	int32_t MidJointIndex; // 0x214(0x04)
	int32_t EndJointIndex; // 0x218(0x04)
	float UpperLimbLength; // 0x21c(0x04)
	float LowerLimbLength; // 0x220(0x04)
...
struct FRigUnit_TwoBoneIKSimplePerItem : FRigUnit_HighlevelBaseMutable {
	struct FRigElementKey ItemA; // 0x70(0x10)
	struct FRigElementKey ItemB; // 0x80(0x10)
	struct FRigElementKey EffectorItem; // 0x90(0x10)
	struct FTransform Effector; // 0xa0(0x30)
	struct FVector PrimaryAxis; // 0xd0(0x0c)
	struct FVector SecondaryAxis; // 0xdc(0x0c)
	float SecondaryAxisWeight; // 0xe8(0x04)
	struct FVector PoleVector; // 0xec(0x0c)
	enum class EControlRigVectorKind PoleVectorKind; // 0xf8(0x01)
	char pad_F9[0x3]; // 0xf9(0x03)
	struct FRigElementKey PoleVectorSpace; // 0xfc(0x10)
	...
	struct FRigUnit_TwoBoneIKSimple_DebugSettings DebugSettings; // 0x130(0x40)
	struct FCachedRigElement CachedItemAIndex; // 0x170(0x18)
	struct FCachedRigElement CachedItemBIndex; // 0x188(0x18)
	struct FCachedRigElement CachedEffectorItemIndex; // 0x1a0(0x18)
	struct FCachedRigElement CachedPoleVectorSpaceIndex; // 0x1b8(0x18)
};
...
struct FRigUnit_TwoBoneIKSimple : FRigUnit_HighlevelBaseMutable {
	struct FName BoneA; // 0x70(0x0c)
	struct FName BoneB; // 0x7c(0x0c)
	struct FName EffectorBone; // 0x88(0x0c)
	char pad_94[0xc]; // 0x94(0x0c)
	struct FTransform Effector; // 0xa0(0x30)
	struct FVector PrimaryAxis; // 0xd0(0x0c)
	struct FVector SecondaryAxis; // 0xdc(0x0c)
	...
	enum class EControlRigVectorKind PoleVectorKind; // 0xf8(0x01)
	char pad_F9[0x3]; // 0xf9(0x03)
	struct FName PoleVectorSpace; // 0xfc(0x0c)
	...
	struct FRigUnit_TwoBoneIKSimple_DebugSettings DebugSettings; // 0x130(0x40)
	struct FCachedRigElement CachedBoneAIndex; // 0x170(0x18)
	struct FCachedRigElement CachedBoneBIndex; // 0x188(0x18)
	struct FCachedRigElement CachedEffectorBoneIndex; // 0x1a0(0x18)
	struct FCachedRigElement CachedPoleVectorSpaceIndex; // 0x1b8(0x18)
};
...
struct FRigUnit_VisualDebugTransformItemSpace : FRigUnit_DebugBase {
	...
	struct FRigElementKey Space; // 0x4c(0x10)
	char pad_5C[0x4]; // 0x5c(0x04)
};
...
struct FRigUnit_VisualDebugTransform : FRigUnit_DebugBase {
	...
	float Thickness; // 0x44(0x04)
	float Scale; // 0x48(0x04)
	struct FName BoneSpace; // 0x4c(0x0c)
	char pad_58[0x8]; // 0x58(0x08)
};
...
struct FRigUnit_VisualDebugQuatItemSpace : FRigUnit_DebugBase {
	...
	float Scale; // 0x28(0x04)
	struct FRigElementKey Space; // 0x2c(0x10)
	char pad_3C[0x4]; // 0x3c(0x04)
};
...
struct FRigUnit_VisualDebugQuat : FRigUnit_DebugBase {
	...
	float Thickness; // 0x24(0x04)
	float Scale; // 0x28(0x04)
	struct FName BoneSpace; // 0x2c(0x0c)
	char pad_38[0x8]; // 0x38(0x08)
};
...
struct FRigUnit_VisualDebugVectorItemSpace : FRigUnit_DebugBase {
	...
	struct FRigElementKey Space; // 0x30(0x10)
};
...
struct FRigUnit_VisualDebugVector : FRigUnit_DebugBase {
	...
	float Thickness; // 0x28(0x04)
	float Scale; // 0x2c(0x04)
	struct FName BoneSpace; // 0x30(0x0c)
	char pad_3C[0x4]; // 0x3c(0x04)
};
