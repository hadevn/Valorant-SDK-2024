...
struct AAudioHandlerActor_C : AAresSoundHandler {
	...
	void TriggerHUDError(struct AShooterCharacter* ShooterCharacter, struct UAkAudioEvent* Event, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerHUDError // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void DidPlayBulletWhiz(); // Function AudioHandlerActor.AudioHandlerActor_C.DidPlayBulletWhiz // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void ShouldPlayBulletWhiz(float WhizByChance, bool BypassWhizCooldown, bool& ShouldPlayBulletWhiz); // Function AudioHandlerActor.AudioHandlerActor_C.ShouldPlayBulletWhiz // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x40572e0
	void TriggerBulletWhizSound(struct UBulletWhizByComponent* WhizByComponent, struct FAresWhizBySoundTuning& WhizByTuning, struct FVector& ShotStart, struct FVector& ShotEnd, struct FVector& ClosestPoint, float ClosestPointDistance, struct FVector& ListenerPoint, struct AShooterCharacter* InstigatorShooterCharacter, struct AShooterCharacter* LocalShooterCharacter, bool bIsFriendlyFire, enum class EAresImpactOrder ImpactOrder); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerBulletWhizSound // (Event|Protected|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerHUDPing(struct AShooterCharacter* ShooterCharacter, struct UAkAudioEvent* Event, struct FVector& Location, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerHUDPing // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerHUDKillConfirmSound(struct AShooterCharacter* ShooterCharacter, struct UAkAudioEvent* Event, int32_t MultikillLevel, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerHUDKillConfirmSound // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerExplosionEffectSound(struct AShooterExplosionEffect* ExplosionEffect, struct UAkAudioEvent* Event, struct FVector& Location, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerExplosionEffectSound // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerEjectableBounceSound(struct AAresEjectable* Ejectable, struct UAkAudioEvent* Event, struct FVector& Location, enum class EAresSurfaceType SurfaceType, int32_t NumBounces, float BounceSpeed, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerEjectableBounceSound // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerCharacterEquippableSound(struct AShooterCharacter* ShooterCharacter, struct UAkAudioEvent* Event, struct USceneComponent* AttachComponent, struct FName AttachPoint, struct FString Perspective, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerCharacterEquippableSound // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerCharacterHitConfirmSound(struct AShooterCharacter* ShooterCharacter, struct UAkAudioEvent* Event, struct USkeletalMeshComponent* AttachComponent, enum class EAresHitConfirmLocality HitLocality, enum class EAresRegionalDamage RegionalDamage, float FalloffMultiplier, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerCharacterHitConfirmSound // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	...
	void TriggerWorldEquippableSound(struct AShooterCharacter* ShooterCharacter, struct UAkAudioEvent* Event, struct USceneComponent* AttachComponent, struct FName AttachPoint, struct FString Perspective, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerWorldEquippableSound // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerWorldImpactEffectSound(struct AActor* InstigatorActor, struct UWorld* World, struct UAkAudioEvent* Event, struct FVector& ImpactPoint, struct FString Perspective, enum class EAresSurfaceType SurfaceType, bool bEnableOcclusion, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerWorldImpactEffectSound // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void TriggerCharacterGroundSound(struct AShooterCharacter* ShooterCharacter, struct TArray<struct UAkAudioEvent*>& Events, struct FVector& SoundLocation, struct FRotator& SoundRotation, struct FString Perspective, enum class EAresSurfaceType SurfaceType, float VolumeMultiplier, bool& Result, struct UAresAudioComponent*& AudioComponent); // Function AudioHandlerActor.AudioHandlerActor_C.TriggerCharacterGroundSound // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void ReceiveTick(float DeltaSeconds); // Function AudioHandlerActor.AudioHandlerActor_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x40572e0
	void PostGroundEvent(struct UAresAudioComponent* AudioComponent, struct AShooterCharacter* Character, struct TArray<struct UAkAudioEvent*>& Events); // Function AudioHandlerActor.AudioHandlerActor_C.PostGroundEvent // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
	void ExecuteUbergraph_AudioHandlerActor(int32_t EntryPoint); // Function AudioHandlerActor.AudioHandlerActor_C.ExecuteUbergraph_AudioHandlerActor // (Final|UbergraphFunction|HasDefaults) // @ game+0x40572e0
};
