...
struct URemoteControlFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool ExposeProperty(struct URemoteControlPreset* Preset, struct UObject* SourceObject, struct FString Property, struct FRemoteControlOptionalExposeArgs Args); // Function RemoteControl.RemoteControlFunctionLibrary.ExposeProperty // (Final|Native|Static|Private|BlueprintCallable) // @ game+0x2237420
	bool ExposeFunction(struct URemoteControlPreset* Preset, struct UObject* SourceObject, struct FString Function, struct FRemoteControlOptionalExposeArgs Args); // Function RemoteControl.RemoteControlFunctionLibrary.ExposeFunction // (Final|Native|Static|Private|BlueprintCallable) // @ game+0x2237200
	bool ExposeActor(struct URemoteControlPreset* Preset, struct AActor* Actor, struct FRemoteControlOptionalExposeArgs Args); // Function RemoteControl.RemoteControlFunctionLibrary.ExposeActor // (Final|Native|Static|Private|BlueprintCallable) // @ game+0x2237040
};
...
struct URemoteControlInterceptionTestObject : UObject {
	...
	struct FRemoteControlInterceptionFunctionParamStruct TestFunction(struct FRemoteControlInterceptionFunctionParamStruct& InStruct, int32_t InTestFactor); // Function RemoteControl.RemoteControlInterceptionTestObject.TestFunction // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x2237640
};
