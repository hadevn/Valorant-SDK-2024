...
struct UGlobals_C : UShooterGameGlobals {
	...
	void NewEventDispatcher_0__DelegateSignature(); // Function Globals.Globals_C.NewEventDispatcher_0__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x40572e0
};
