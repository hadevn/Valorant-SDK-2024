...
struct FSimulationStageMetaData {
	struct FName SimulationStageName; // 0x00(0x0c)
	struct FName IterationSource; // 0x0c(0x0c)
	char bSpawnOnly : 1; // 0x18(0x01)
	char bWritesParticles : 1; // 0x18(0x01)
	char bPartialParticleUpdate : 1; // 0x18(0x01)
	char pad_18_3 : 5; // 0x18(0x01)
	char pad_19[0x7]; // 0x19(0x07)
	struct TArray<struct FName> OutputDestinations; // 0x20(0x10)
	int32_t MinStage; // 0x30(0x04)
	int32_t MaxStage; // 0x34(0x04)
};
