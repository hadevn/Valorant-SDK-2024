...
enum class EPrimaryAssetCookCategory : uint8 {
	...
	JamMap = 23,
	JuliettMap = 24,
	EPrimaryAssetCookCategory_MAX = 25
};
...
// Size: 0x28 (Inherited: 0x1c)
struct FMaterialAttributesInput : FExpressionInput {
	char pad_1C[0x4]; // 0x1c(0x04)
	int64_t PropertyConnectedBitmask; // 0x20(0x08)
};
...
struct FAnimSingleNodeInstanceProxy : FAnimInstanceProxy {
	char pad_7A0[0x150]; // 0x7a0(0x150)
};
...
struct FCameraShakeScrubParams {
	...
	struct FMinimalViewInfo POV; // 0x10(0x6a0)
};
...
struct FMinimalViewInfo {
	...
	char pad_3C[0x4]; // 0x3c(0x04)
	struct FPostProcessSettings PostProcessSettings; // 0x40(0x610)
	struct FVector2D OffCenterProjectionOffset; // 0x650(0x08)
...
struct FPostProcessSettings {
	...
	enum class ETemperatureMethod TemperatureType; // 0x32(0x01)
	char pad_33[0x1]; // 0x33(0x01)
	...
	float PathTracingFilterWidth; // 0x550(0x04)
	char PathTracingEnableEmissive : 1; // 0x554(0x01)
	char pad_554_1 : 7; // 0x554(0x01)
	char pad_555[0x3]; // 0x555(0x03)
	float PathTracingMaxPathExposure; // 0x558(0x04)
	char PathTracingEnableDenoiser : 1; // 0x55c(0x01)
	char pad_55C_1 : 7; // 0x55c(0x01)
	char pad_55D[0x3]; // 0x55d(0x03)
	float LPVFadeRange; // 0x560(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x564(0x04)
	float ScreenPercentage; // 0x568(0x04)
	char pad_56C[0x4]; // 0x56c(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x570(0x10)
	struct FLinearColor AmbientOcclusionTintColor; // 0x580(0x10)
	float AresAdaptiveSharpenCurveSlope; // 0x590(0x04)
	float AresAdaptiveSharpenDarkCompressionHigh; // 0x594(0x04)
	float AresAdaptiveSharpenDarkCompressionLow; // 0x598(0x04)
	float AresAdaptiveSharpenDarkOvershoot; // 0x59c(0x04)
	float AresAdaptiveSharpenLightCompressionHigh; // 0x5a0(0x04)
	float AresAdaptiveSharpenLightCompressionLow; // 0x5a4(0x04)
	float AresAdaptiveSharpenLightOvershoot; // 0x5a8(0x04)
	float AresAdaptiveSharpenPowerMeanPValue; // 0x5ac(0x04)
	float AresAdaptiveSharpenScaleCompressionSlope; // 0x5b0(0x04)
	float AresAdaptiveSharpenScaleLim; // 0x5b4(0x04)
	float AresAdaptiveSharpenStrength; // 0x5b8(0x04)
	float AresCharacterOutlinesBlurDistance; // 0x5bc(0x04)
	struct FLinearColor AresCharacterOutlinesColor; // 0x5c0(0x10)
	struct FLinearColor AresCharacterOutlinesOverlayColor; // 0x5d0(0x10)
	int32_t AresCharacterOutlinesPixelOffset; // 0x5e0(0x04)
	int32_t AresClarityBlendIfDark; // 0x5e4(0x04)
	int32_t AresClarityBlendIfLight; // 0x5e8(0x04)
	enum class EAresClarityBlendMode AresClarityBlendMode; // 0x5ec(0x01)
	char pad_5ED[0x3]; // 0x5ed(0x03)
	float AresClarityDarkIntensity; // 0x5f0(0x04)
	float AresClarityLightIntensity; // 0x5f4(0x04)
	float AresClarityOffset; // 0x5f8(0x04)
	int32_t AresClarityRadius; // 0x5fc(0x04)
	float AresClarityStrength; // 0x600(0x04)
	char pad_604[0x4]; // 0x604(0x04)
	struct UCurveFloat* IndirectLightingScaleCurve; // 0x608(0x08)
};
...
// Size: 0x50 (Inherited: 0x04)
struct FBlueprintInputKeyDelegateBinding : FBlueprintInputDelegateBinding {
	char pad_4[0x4]; // 0x04(0x04)
	struct FInputChord InputChord; // 0x08(0x38)
	enum class EInputEvent InputKeyEvent; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	struct FName FunctionNameToBind; // 0x44(0x0c)
};
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	bool bOverride_UseAresProjectionMatrixIndex; // 0x13(0x01)
	...
	bool bUseAresProjectionMatrixIndex; // 0x2e(0x01)
	char TwoSided : 1; // 0x2f(0x01)
	char DitheredLODTransition : 1; // 0x2f(0x01)
	char bCastDynamicShadowAsMasked : 1; // 0x2f(0x01)
	char pad_2F_3 : 5; // 0x2f(0x01)
	enum class EBlendMode BlendMode; // 0x30(0x01)
	enum class EMaterialShadingModel ShadingModel; // 0x31(0x01)
...
struct FTViewTarget {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x6a0)
	struct APlayerState* PlayerState; // 0x6b0(0x08)
...
// ScriptStruct Engine.InputActionKeyMappingHoldConsumption
// Size: 0x02 (Inherited: 0x00)
struct FInputActionKeyMappingHoldConsumption {
	char pad_0[0x2]; // 0x00(0x02)
};
...
struct FInputActionKeyMapping {
	...
	char pad_D[0x3]; // 0x0d(0x03)
	float HoldIntervalStart; // 0x10(0x04)
	float HoldIntervalLength; // 0x14(0x04)
	float DoubleTapListeningThreshold; // 0x18(0x04)
	char pad_1C[0x4]; // 0x1c(0x04)
...
struct FTextureLODGroup {
	...
	char pad_6D[0x3]; // 0x6d(0x03)
	uint32_t MaxTextureDimension; // 0x70(0x04)
	uint32_t AdditionalAnisotropy; // 0x74(0x04)
	bool IsUI; // 0x78(0x01)
