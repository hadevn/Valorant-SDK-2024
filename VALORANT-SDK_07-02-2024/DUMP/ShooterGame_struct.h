...
enum class EAresEquippableInput : uint8 {
	...
	EquippableInput_Primary_Trigger_Gamepad = 13,
	EquippableInput_Secondary_Trigger_Gamepad = 14,
	EquippableInput_ToggleZoom_SkipFirstLevel = 15,
...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadSensitivityModifierX = 150,
	GamepadSensitivityModifierY = 151,
	GamepadSensModifierEaseInTime = 152,
	GamepadSensModifierEaseOutTime = 153,
	GamepadInputDampeningMinPercentX = 154,
	GamepadInputDampeningMinPercentY = 155,
	GamepadInputDampeningRampSecondsX = 156,
	GamepadInputDampeningRampSecondsY = 157,
	GamepadInputDampeningLargeMovementThresholdX = 158,
	GamepadInputDampeningLargeMovementThresholdY = 159,
	GamepadMegamapSizeMultiplier = 160,
	GamepadBaseSpeedMultiplierXZoomed = 161,
	GamepadBaseSpeedMultiplierYZoomed = 162,
	GamepadMaxSpeedMultiplierXZoomed = 163,
	GamepadMaxSpeedMultiplierYZoomed = 164,
	GamepadMaxAccelerationThresholdZoomed = 165,
	GamepadAimAccelDelaySecondsZoomed = 166,
	GamepadAimAccelRampUpSecondsZoomed = 167,
	GamepadBaseSpeedMultiplierXSoftADS = 168,
	GamepadBaseSpeedMultiplierYSoftADS = 169,
	GamepadMaxSpeedMultiplierXSoftADS = 170,
	GamepadMaxSpeedMultiplierYSoftADS = 171,
	GamepadMaxAccelerationThresholdSoftADS = 172,
	GamepadAimAccelDelaySecondsSoftADS = 173,
	GamepadAimAccelRampUpSecondsSoftADS = 174,
	AimToolingAimAccelerationDelayDelayAmount = 175,
	AimToolingAimAccelerationDelayRampUpAmount = 176,
	AimToolingTFPlayerScale = 177,
	AimToolingFORPlayerScale = 178,
	AimToolingSAPlayerScale = 179,
	AimToolingPTCPlayerScale = 180,
	ObserverRunSpeedModifier = 181,
	ObserverWalkSpeedModifier = 182,
	GyroShootingThresholdTap = 183,
	GyroShootingThresholdHold = 184,
	GyroShootingVisualBarMax = 185,
	GyroMovementWalkThresholdHorizontal = 186,
	GyroMovementWalkThresholdVertical = 187,
	GyroMovementRunThresholdHorizontal = 188,
	GyroMovementRunThresholdVertical = 189,
	GyroShotMovementDeadzoneThreshold = 190,
	GyroShotMovementDeadzoneValue = 191,
	EAresFloatSettingName_MAX = 192
};
...
enum class EAresIntSettingName : uint8 {
	...
	TouchDoubleTapRight = 76,
	TouchHUDPreset = 77,
	TouchDoubleTapLeft = 78,
	TouchAimAccelerationCurveX = 79,
	TouchAimAccelerationCurveY = 80,
	TouchAimADSAccelerationCurveX = 81,
	TouchAimADSAccelerationCurveY = 82,
	TouchAimSniperAccelerationCurveX = 83,
	TouchAimSniperAccelerationCurveY = 84,
	TouchJoystickStyle = 85,
	TouchSniperZoomLevelSetting = 86,
	TouchOperatorZoomCycleStyle = 87,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 88,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 89,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 90,
	TouchAimSensitivityPreset = 91,
	TouchGyroSensitivityPreset = 92,
	TouchTrackballSensitivityPreset = 93,
	TouchDoubleTapTopLeft = 94,
	TouchDoubleTapTopMiddle = 95,
	TouchDoubleTapTopRight = 96,
	TouchDoubleTapMiddleLeft = 97,
	TouchDoubleTapMiddle = 98,
	TouchDoubleTapMiddleRight = 99,
	TouchDoubleTapBottomLeft = 100,
	TouchDoubleTapBottomMiddle = 101,
	TouchDoubleTapBottomRight = 102,
	TouchNumVerticalRegions = 103,
	TouchNumHorizontalRegions = 104,
	MaxFramerateInBuyPhase = 105,
	MaxFramerateInGamePhase = 106,
	MaxFramerateInSpectatorView = 107,
	LastSeenRoamingSettingsVersion = 108,
	EAresIntSettingName_MAX = 109
};
...
enum class EAresBoolSettingName : uint8 {
	...
	GamepadInputDampeningEnabled = 137,
	StanceIndicatorEnabled = 138,
	GamepadTapToCycleIncompleteInventory = 139,
	MultithreadedRenderingEnabled = 140,
	AimToolingDCPlayerEnabled = 141,
	HasEverStartedAMatch = 142,
	HasAcceptedCodeOfConduct = 143,
	HasSeenNewPlayerSettings = 144,
	HasSeenNPEContractTutorial = 145,
	HasSeenUPWTutorial = 146,
	HasSeenSettingsTutorial = 147,
	HasSeenWelcomeScreen = 148,
	HasSeenMenuTutorial = 149,
	HasSeenPhotoSensitivityWarning = 150,
	HasSeenTournamentsScreen = 151,
	HasSeenXGPActivationModal = 152,
	HasSeenTrainingPrompt = 153,
	CollectionShowOwnedOnly = 154,
	IncognitoHideMatchmadePlayerNames = 155,
	IncognitoRejectFriendRequests = 156,
	IncognitoRejectPartyInvitesByDisplayName = 157,
	PlayerBehavior_MuteEnemyTextChat = 158,
	PlayerBehavior_MuteObserverTextChat = 159,
	HideUI = 160,
	HideCrosshair = 161,
	Hide1P = 162,
	HideOutlinesAndFresnel = 163,
	ObserversSeeBlinds = 164,
	TeamColorAffectsHUD = 165,
	ShowKeybindsOnMinimap = 166,
	ShowKeybindsOnMegamap = 167,
	FullscreenMegamap = 168,
	HandednessByTeam = 169,
	HideSpectatedAgentPortrait = 170,
	ObserverToggleScoreboard = 171,
	TriggerSwapAll = 172,
	HasEverAppliedRoamingSettings = 173,
	HasEverAppliedRoamingSettingsGamepad = 174,
	GyroTapShoot = 175,
	GyroShootingAxisSwap = 176,
	GyroShootingAxisInvert = 177,
	GyroShootingDisplayBar = 178,
	GyroMovementAxisInvertVertical = 179,
	GyroMovementAxisInvertHorizontal = 180,
	ShowColoredMuzzleFlashes = 181,
	MaxbotGameplayVO = 182,
	MaxbotFlavorVO = 183,
	RGIInputLatencyEnabled = 184,
	VoiceSelfMuteEnabled = 185,
	MatureContentFilter = 186,
	ShowBloodVisual = 187,
	ShowCorpsesVisual = 188,
	AllowCrossPlay = 189,
	EAresBoolSettingName_MAX = 190
};
...
enum class EGameFeatureToggleName : uint8 {
	...
	ContextAwareModuleVisualsEnabled = 221,
	AIUseDistanceRoomPathfindingCosting = 222,
	EnableDoubleSniperOnAltModes = 223,
	ClientAuthBlinds = 224,
	NewRecoilRecovery = 225,
	SeparateCRInterpForRemoteClients = 226,
	Count = 227,
	Invalid = 254,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	AimToolingTuningMode = 24,
	MovementToolingTuningMode = 25,
	GamepadRecoilRecoveryMultiplier = 26,
	...
	GameDataWorldSnapshotIntervalSec = 32,
	GameDataWorldConfigurationIntervalSec = 33,
	GameDataTimeseriesIntervalSec = 34,
	ShortTermNPEUpdatesChance = 35,
	MaxSnapshotCountForShortGames = 36,
	GamepadAimAccelResetAngle = 37,
	DesignerFloatA = 38,
	DesignerFloatB = 39,
	DesignerFloatC = 40,
	DesignerFloatD = 41,
...
struct FTeamDTO {
	...
	struct FString AlternativeImageURL; // 0x40(0x10)
	struct FString BackgroundImageURL; // 0x50(0x10)
	struct FString PrimaryColor; // 0x60(0x10)
	struct FString SecondaryColor; // 0x70(0x10)
	struct FMatchOutcomeDTO MatchOutcome; // 0x80(0x38)
	struct FOriginDTO Origin; // 0xb8(0x28)
	struct TArray<struct FPlayerDTO> Players; // 0xe0(0x10)
	struct FTeamRecordDTO Record; // 0xf0(0x0c)
	char pad_FC[0x4]; // 0xfc(0x04)
	struct FHomeLeagueDTO HomeLeague; // 0x100(0x40)
};
...
struct FPremierLeaderboardEntry {
	...
	struct FString RosterName; // 0x18(0x10)
	struct FString Tag; // 0x28(0x10)
	struct FPremierRosterCustomization Customization; // 0x38(0x40)
	int32_t Wins; // 0x78(0x04)
	int32_t Losses; // 0x7c(0x04)
	int32_t RoundWins; // 0x80(0x04)
	int32_t RoundLosses; // 0x84(0x04)
};
...
struct FAllInitSystems {
	...
	struct UContractDefinitionsManager* ContractDefinitionsManager; // 0x1d8(0x08)
	struct UContractsViewController* ContractsViewController; // 0x1e0(0x08)
	struct UCrosshairManager* CrosshairManager; // 0x1e8(0x08)
	struct URewardGrantModelFactory* RewardGrantModelFactory; // 0x1f0(0x08)
	struct UVanguardManager* VanguardManager; // 0x1f8(0x08)
	struct UDropInLoadingManager* DropInLoadingManager; // 0x200(0x08)
	struct UChatSessionManager* ChatSessionManager; // 0x208(0x08)
	struct UPurchaseManager* PurchaseManager; // 0x210(0x08)
	struct UPlatformOffersManager* PlatformOffersManager; // 0x218(0x08)
	struct UStoreManager* StoreManager; // 0x220(0x08)
	struct UStoreUITelemetryManager* StoreUITelemetryManager; // 0x228(0x08)
	struct UStoreViewControllerV2* StoreViewController; // 0x230(0x08)
	struct UPlayerFeedbackToolViewController* PlayerFeedbackToolViewController; // 0x238(0x08)
	struct UAresClientEvents* AresClientEvents; // 0x240(0x08)
	struct UCompetitiveTierUpdater* CompetitiveTierUpdater; // 0x248(0x08)
	struct UPlayerIdentityUpdater* PlayerIdentityUpdater; // 0x250(0x08)
	struct UProvisioningErrorNotificationManager* ProvisioningErrorNotificationManager; // 0x258(0x08)
	struct ULegalInfoManager* LegalInfoManager; // 0x260(0x08)
	struct UMapLoadModel* MapLoadModel; // 0x268(0x08)
	struct UMenuStackManager* MenuStackManager; // 0x270(0x08)
	struct UUINavigationManager* UINavigationManager; // 0x278(0x08)
	struct UModalManager* ModalManager; // 0x280(0x08)
	struct UFlyoutManager* FlyoutManager; // 0x288(0x08)
	struct UPlayerAliasManager* PlayerAliasManager; // 0x290(0x08)
	struct UPaymentsManager* PaymentsManager; // 0x298(0x08)
	struct UPingManager* PingManager; // 0x2a0(0x08)
	struct UOnlineIdentityManager* OnlineIdentityManager; // 0x2a8(0x08)
	struct UPlayerSettingsTelemetry* PlayerSettingsTelemetry; // 0x2b0(0x08)
	struct UUITelemetryManager* UITelemetryManager; // 0x2b8(0x08)
	struct UActionTraitsManager* ActionTraitsManager; // 0x2c0(0x08)
	struct UActionBindingsManager* ActionBindingsManager; // 0x2c8(0x08)
	struct UPlayerFacingPerfManager* PlayerFacingPerfManager; // 0x2d0(0x08)
	struct UApplicationRepairManager* ApplicationRepairManager; // 0x2d8(0x08)
	struct UArsenalViewController* ArsenalViewController; // 0x2e0(0x08)
	struct UPlayerAffinityManager* PlayerAffinityManager; // 0x2e8(0x08)
	struct UPatchAvailabilityManager* PatchAvailabilityManager; // 0x2f0(0x08)
	struct UPatchManager* PatchManager; // 0x2f8(0x08)
	struct URiotClientConfigManager* RiotClientConfigManager; // 0x300(0x08)
	struct UNPELoader* NPELoader; // 0x308(0x08)
	struct UTransitionModelManager* TransitionModelManager; // 0x310(0x08)
	struct UTutorialManager* TutorialManager; // 0x318(0x08)
	struct ULoginQueueManager* LoginQueueManager; // 0x320(0x08)
	struct URiotClientHeartbeatManager* RiotClientHeartbeatManager; // 0x328(0x08)
	struct ULocalePreferenceManager* LocalePreferenceManager; // 0x330(0x08)
	struct UVNGManager* VNGManager; // 0x338(0x08)
	struct UMassRewardsManager* MassRewardsManager; // 0x340(0x08)
	struct UPlayerLoginLocationHistoryManager* PlayerLoginLocationHistoryManager; // 0x348(0x08)
	struct URestrictionsManager* RestrictionsManager; // 0x350(0x08)
	struct UAccountXPManager* AccountXPManager; // 0x358(0x08)
	struct UReporterFeedbackManager* ReporterFeedbackManager; // 0x360(0x08)
	struct URiotWarningManager* RiotWarningManager; // 0x368(0x08)
	struct URosterManager* RosterManager; // 0x370(0x08)
	struct UTournamentsManager* TournamentsManager; // 0x378(0x08)
	struct UPremierManager* PremierManager; // 0x380(0x08)
	struct UPremierRosterManager* PremierRosterManager; // 0x388(0x08)
	struct UPremierRosterViewController* PremierRosterViewController; // 0x390(0x08)
	struct ULeaderboardManager* LeaderboardManager; // 0x398(0x08)
	struct ULeaderboardViewController* LeaderboardViewController; // 0x3a0(0x08)
	struct UMainMenuTelemetryManager* MainMenuTelemetryManager; // 0x3a8(0x08)
	struct UHovercardCacheManager* HovercardCacheManager; // 0x3b0(0x08)
	struct UEULAManager* EULAManager; // 0x3b8(0x08)
	struct UAVSManager* AVSManager; // 0x3c0(0x08)
	struct UDailyRewardsManager* DailyRewardsManager; // 0x3c8(0x08)
	struct UJuiceScreenViewController* JuiceScreenViewController; // 0x3d0(0x08)
	struct UFavoritesManager* FavoritesManager; // 0x3d8(0x08)
	struct UContentFilterViewController* ContentFilterViewController; // 0x3e0(0x08)
	struct UContentFilterUITelemetryManager* ContentFilterUITelemetryManager; // 0x3e8(0x08)
	struct UUserInfoNotificationManager* UserInfoNotificationManager; // 0x3f0(0x08)
	struct UClientTelemetryPersistence* TelemetryPersistence; // 0x3f8(0x08)
	struct ULatencyService* LatencyService; // 0x400(0x08)
	struct UPlatformEnvironmentManager* PlatformEnvironmentManager; // 0x408(0x08)
	struct UConfigManager* ConfigManager; // 0x410(0x08)
	struct URSOManager* RSOManager; // 0x418(0x08)
	struct UPlatformSessionManager* SessionManager; // 0x420(0x08)
	struct URMSManager* RMSManager; // 0x428(0x08)
	struct UPersonalizationManagerV2* PersonalizationManagerV2; // 0x430(0x08)
	struct UPartyManager* PartyManager; // 0x438(0x08)
	struct UPlayerReportManager* PlayerReportManager; // 0x440(0x08)
	struct UGlobalAudioManager* GlobalAudioManager; // 0x448(0x08)
	struct UEsportsManager* EsportsManager; // 0x450(0x08)
	struct UEsportsTelemetryManager* EsportsTelemetryManager; // 0x458(0x08)
	struct UReplayCatalogManager* ReplayManager; // 0x460(0x08)
	struct UAresRGIFriendsClient* RGIFriendsClient; // 0x468(0x08)
	struct UMainMenuParentWidget* MainMenuParent; // 0x470(0x08)
};
...
struct FShotsFiredOverRoundEvent {
	...
	struct FString PlatformType; // 0x88(0x10)
};
...
struct FAresGameplayMessage {
	struct FGameplayTag Verb; // 0x00(0x0c)
	char pad_C[0x4]; // 0x0c(0x04)
...
struct FInputLatencyStats {
	...
	struct FInputLatencyFpsBuckets TotalEngineLatencyFpsBuckets; // 0x50(0x34)
	struct FInputLatencyFpsBuckets TotalWorkFpsBuckets; // 0x84(0x34)
	struct FInputLatencyFpsBuckets TotalWorkAndSlackFpsBuckets; // 0xb8(0x34)
};
...
struct FCAPProgressionConfig {
	...
	struct FCAPProgressionConfigContent Content; // 0x10(0x40)
};

// ScriptStruct ShooterGame.CAPProgressionConfigContent
// Size: 0x40 (Inherited: 0x00)
struct FCAPProgressionConfigContent {
	struct FGuid ID; // 0x00(0x10)
	struct FString Name; // 0x10(0x10)
...
struct FCAPProgressionConfigMilestone {
	struct FGuid ID; // 0x00(0x10)
	struct FString Name; // 0x10(0x10)
	struct TArray<struct FCAPProgressionConfigCounterMilestoneTrigger> Triggers; // 0x20(0x10)
	struct FCAPProgressionConfigEntitlementRewards Rewards; // 0x30(0x10)
};

// ScriptStruct ShooterGame.CAPProgressionConfigEntitlementRewards
// Size: 0x10 (Inherited: 0x00)
struct FCAPProgressionConfigEntitlementRewards {
	struct TArray<struct FCAPProgressionConfigReward> Items; // 0x00(0x10)
};
...
struct FCAPProgressionConfigReward {
	...
	struct FGuid CurrencyID; // 0x48(0x10)
	int64_t Amount; // 0x58(0x08)
	struct FGuid CounterID; // 0x60(0x10)
};

// ScriptStruct ShooterGame.CAPProgressionConfigCounterMilestoneTrigger
// Size: 0x28 (Inherited: 0x00)
struct FCAPProgressionConfigCounterMilestoneTrigger {
	struct FString Type; // 0x00(0x10)
	struct FGuid CounterID; // 0x10(0x10)
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FClientFrameBuckets FrameBuckets; // 0x62c(0x24)
	struct FString MatchID; // 0x650(0x10)
	int32_t RoundNumber; // 0x660(0x04)
	char pad_664[0x4]; // 0x664(0x04)
	int64_t RoundDuration; // 0x668(0x08)
	struct FString InstanceId; // 0x670(0x10)
	struct FPerfSettings Settings; // 0x680(0x58)
	struct FMachinePerfStats MachinePerfStats; // 0x6d8(0x64)
	char MoveTimestepsPerSecond; // 0x73c(0x01)
	char pad_73D[0x3]; // 0x73d(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x740(0x54)
	char pad_794[0x4]; // 0x794(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x798(0x70)
	struct FInputLatencyStats InputLatencyStats; // 0x808(0xec)
	char pad_8F4[0x4]; // 0x8f4(0x04)
	struct FString Puuid; // 0x8f8(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x908(0x20)
};
...
// ScriptStruct ShooterGame.TipProgressEntry
// Size: 0x30 (Inherited: 0x00)
struct FTipProgressEntry {
	struct FString Name; // 0x00(0x10)
	struct FString Wording; // 0x10(0x10)
	int32_t ResolveCount; // 0x20(0x04)
	int32_t ResolveLimit; // 0x24(0x04)
	int32_t Priority; // 0x28(0x04)
	enum class ETipState TipState; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
};

// ScriptStruct ShooterGame.TipInfo
// Size: 0x88 (Inherited: 0x08)
struct FTipInfo : FTableRowBase {
	struct FName Name; // 0x08(0x0c)
	char pad_14[0x4]; // 0x14(0x04)
	struct TSoftClassPtr<UObject> DataAsset; // 0x18(0x30)
	enum class EEducationArea Area; // 0x48(0x01)
	char pad_49[0x3]; // 0x49(0x03)
	int32_t Stage; // 0x4c(0x04)
	struct FText TipWording; // 0x50(0x18)
	int32_t Priority; // 0x68(0x04)
	int32_t ResolvedLimit; // 0x6c(0x04)
	bool ShowOnce; // 0x70(0x01)
	char pad_71[0x7]; // 0x71(0x07)
	struct TArray<enum class ETipPossibleDisplayTimes> PossibleDisplayTimes; // 0x78(0x10)
};
...
struct FLeaderboardRankingDTO {
	...
	char pad_19[0x7]; // 0x19(0x07)
	struct FAdditionalData additionalInfo; // 0x20(0x70)
};
...
struct FAdditionalData {
	...
	struct FPremierRosterCustomization Customization; // 0x30(0x40)
};
...
// ScriptStruct ShooterGame.PremierRosterEnrollBody
// Size: 0x10 (Inherited: 0x00)
struct FPremierRosterEnrollBody {
...
struct FPluginStoreOffer {
	struct FPluginStorePurchaseInformation PurchaseInformation; // 0x00(0xf8)
	struct TArray<struct FPluginStoreSubOffer> SubOffers; // 0xf8(0x10)
};
