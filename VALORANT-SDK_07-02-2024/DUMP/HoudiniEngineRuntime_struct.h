...
struct FHoudiniAssetBlueprintOutput {
	...
	struct FHoudiniOutputObject OutputObject; // 0x08(0xf8)
};
...
struct FHoudiniGeoPartObject {
	...
	bool bHasEditLayers; // 0xb8(0x01)
	char pad_B9[0x7]; // 0xb9(0x07)
	struct FString VolumeLayerName; // 0xc0(0x10)
	int32_t VolumeTileIndex; // 0xd0(0x04)
	bool bIsVisible; // 0xd4(0x01)
	bool bIsEditable; // 0xd5(0x01)
	bool bIsTemplated; // 0xd6(0x01)
	bool bIsInstanced; // 0xd7(0x01)
	bool bHasGeoChanged; // 0xd8(0x01)
	bool bHasPartChanged; // 0xd9(0x01)
	bool bHasTransformChanged; // 0xda(0x01)
	bool bHasMaterialsChanged; // 0xdb(0x01)
	char pad_DC[0x144]; // 0xdc(0x144)
