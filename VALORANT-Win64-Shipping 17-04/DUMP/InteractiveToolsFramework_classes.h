...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	float HoverSizeMultiplier; // 0x560(0x04)
	float PixelHitDistanceThreshold; // 0x564(0x04)
	char pad_568[0x8]; // 0x568(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x6a16ef0
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x6a16e60
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x590 (Inherited: 0x570)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x570(0x0c)
	float Gap; // 0x57c(0x04)
	float Length; // 0x580(0x04)
	float Thickness; // 0x584(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x570(0x0c)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x570(0x0c)
	float Radius; // 0x57c(0x04)
	float Thickness; // 0x580(0x04)
	int32_t NumSides; // 0x584(0x04)
	bool bViewAligned; // 0x588(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x589(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x6a16cf0
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x6a16b50
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x3b5ee80
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x6a16a60
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x3a8ed90
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x3a8ede0
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x6a16dd0
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x6a169c0
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x3bcf530
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x6a16bc0
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x3aec4c0
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x6a169f0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x6a169c0
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x6a16c50
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x6a16a20
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x6a169f0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x6a169c0
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x570(0x0c)
	float HandleSize; // 0x57c(0x04)
	float Thickness; // 0x580(0x04)
	struct FVector Direction; // 0x584(0x0c)
	float Length; // 0x590(0x04)
	bool bImageScale; // 0x594(0x01)
...
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x570(0x0c)
	struct FVector DirectionY; // 0x57c(0x0c)
	float OffsetX; // 0x588(0x04)
	float OffsetY; // 0x58c(0x04)
	float LengthX; // 0x590(0x04)
	float LengthY; // 0x594(0x04)
	float Thickness; // 0x598(0x04)
	char SegmentFlags; // 0x59c(0x01)
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x3b8(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x3c0(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x3c8(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x3b8(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x3c0(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x3c8(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x3d0(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x3d8(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x3e0(0x08)
	struct UPrimitiveComponent* RotateX; // 0x3e8(0x08)
	struct UPrimitiveComponent* RotateY; // 0x3f0(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x3f8(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x400(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x408(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x410(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x418(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x420(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x428(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x430(0x08)
};
