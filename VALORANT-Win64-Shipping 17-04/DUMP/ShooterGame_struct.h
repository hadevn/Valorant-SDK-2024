...
enum class EAresFloatSettingName : uint8 {
	...
	CrosshairSniperCenterDotSize = 55,
	CrosshairSniperCenterDotOpacity = 56,
	TouchAimSensitivityX = 57,
	TouchAimSensitivityY = 58,
	TouchAimSensitivityADSX = 59,
	TouchAimSensitivityADSY = 60,
	TouchAimSensitivitySniperX = 61,
	TouchAimSensitivitySniperY = 62,
	TouchAimAccelerationSensitivity = 63,
	TouchAimAccelerationSensitivityX = 64,
	TouchAimAccelerationSensitivityY = 65,
	TouchAimAccelerationADSSensitivityX = 66,
	TouchAimAccelerationADSSensitivityY = 67,
	TouchAimAccelerationSniperSensitivityX = 68,
	TouchAimAccelerationSniperSensitivityY = 69,
	TouchAimAccelerationTargetRampUp = 70,
	TouchAimOneEuroMinCutoff = 71,
	TouchAimOneEuroCutoffSlope = 72,
	TouchAimOneEuroDeltaCutoff = 73,
	TouchAimTrackballActivationVelocityX = 74,
	TouchAimTrackballActivationVelocityY = 75,
	TouchAimTrackballMinXVelocity = 76,
	TouchAimTrackballMinYVelocity = 77,
	TouchAimTrackballMaxXVelocity = 78,
	TouchAimTrackballMaxYVelocity = 79,
	TouchAimTrackballActivationVelocityWeightX = 80,
	TouchAimTrackballActivationVelocityWeightY = 81,
	TouchAimTrackballMaxDecelerationX = 82,
	TouchAimTrackballMaxDecelerationY = 83,
	TouchGyroAimSensitivityX = 84,
	TouchGyroAimSensitivityY = 85,
	TouchGyroADSSensitivityX = 86,
	TouchGyroADSSensitivityY = 87,
	TouchGyroSniperSensitivityX = 88,
	TouchGyroSniperSensitivityY = 89,
	TouchGyroAimOneEuroMinCutoff = 90,
	TouchGyroAimOneEuroCutoffSlope = 91,
	TouchGyroAimOneEuroDeltaCutoff = 92,
	TouchSensitivityZoomed = 93,
	TouchSensitivitySniper = 94,
	TouchTapMaxTime = 95,
	TouchExperimentalAnchoredButtonOffset = 96,
	TouchExperimentalMaxWalkSpeed = 97,
	TouchAccelMinDeltaX = 98,
	TouchAccelMinDeltaY = 99,
	TouchAccelMaxDeltaX = 100,
	TouchAccelMaxDeltaY = 101,
	TouchDoubleTapTime = 102,
	TouchDoubleTapDistance = 103,
	TouchTrackballLinearDragCoefficient = 104,
	TouchTrackballLinearDragMinimum = 105,
	TouchTabletLayoutWidthThreshold = 106,
	TouchJoystickInnerDeadzone = 107,
	TouchJoystickAngularInnerDeadzoneDeg = 108,
	TouchJoystickAngularOuterDeadzoneDeg = 109,
	TouchJoystickAxialHorizontalDeadzone = 110,
	TouchJoystickAxialVerticalDeadzone = 111,
	TouchJoystickWalkThreshold = 112,
	TouchJoystickRunLockThreshold = 113,
	TouchJoystickRunLockActivationAngleDeg = 114,
	TouchJoystickRunLockDisplayThreshold = 115,
	TouchJoystickFollowDistance = 116,
	TouchJoystickOneEuroMinCutoff = 117,
	TouchJoystickOneEuroCutoffSlope = 118,
	TouchJoystickOneEuroDeltaCutoff = 119,
	TouchSniperHoldCyclingSpeed = 120,
	GamepadBaseRotationSpeedX = 121,
	GamepadBaseRotationSpeedY = 122,
	GamepadFocusRotationSpeedX = 123,
	GamepadFocusRotationSpeedY = 124,
	GamepadADSRotationSpeedX = 125,
	GamepadADSRotationSpeedY = 126,
	GamepadScopedRotationSpeedX = 127,
	GamepadScopedRotationSpeedY = 128,
	GamepadBaseSpeedMultiplierX = 129,
	GamepadBaseSpeedMultiplierY = 130,
	GamepadMaxSpeedMultiplierX = 131,
	GamepadMaxSpeedMultiplierY = 132,
	GamepadMaxAccelerationThreshold = 133,
	GamepadAimAccelDelaySeconds = 134,
	GamepadAimAccelRampUpSeconds = 135,
	GamepadLookStickInnerDeadzone = 136,
	GamepadLookStickOuterDeadzone = 137,
	GamepadLookStickAngularInnerDeadzoneDeg = 138,
	GamepadLookStickAngularOuterDeadzoneDeg = 139,
	GamepadLookStickAxialHorizontalDeadzone = 140,
	GamepadLookStickAxialVerticalDeadzone = 141,
	GamepadWalkStickInnerDeadzone = 142,
	GamepadWalkStickAngularInnerDeadzoneDeg = 143,
	GamepadWalkStickAngularOuterDeadzoneDeg = 144,
	GamepadWalkStickAxialHorizontalDeadzone = 145,
	GamepadWalkStickAxialVerticalDeadzone = 146,
	GamepadTriggerDeadzone = 147,
	GamepadAnalogWalkThreshold = 148,
	GamepadShootingSensitivityScaleX = 149,
	GamepadShootingSensitivityScaleY = 150,
	GamepadShootSensScaleEaseInOutTime = 151,
	GamepadShootSensRotationSpeedX = 152,
	GamepadShootSensRotationSpeedY = 153,
	GamepadMegamapSizeMultiplier = 154,
	GamepadRotationIncreaseAccel = 155,
	GamepadRotationIncreaseAccelSoftADSMultiplier = 156,
	GamepadRotationIncreaseAccelADSMultiplier = 157,
	GamepadRotationIncreaseAccelScopedMultiplier = 158,
	GamepadBaseSpeedMultiplierXADS = 159,
	GamepadBaseSpeedMultiplierYADS = 160,
	GamepadMaxSpeedMultiplierXADS = 161,
	GamepadMaxSpeedMultiplierYADS = 162,
	GamepadMaxAccelerationThresholdADS = 163,
	GamepadAimAccelDelaySecondsADS = 164,
	GamepadAimAccelRampUpSecondsADS = 165,
	GamepadBaseSpeedMultiplierXScoped = 166,
	GamepadBaseSpeedMultiplierYScoped = 167,
	GamepadMaxSpeedMultiplierXScoped = 168,
	GamepadMaxSpeedMultiplierYScoped = 169,
	GamepadMaxAccelerationThresholdScoped = 170,
	GamepadAimAccelDelaySecondsScoped = 171,
	GamepadAimAccelRampUpSecondsScoped = 172,
	GamepadBaseSpeedMultiplierXSoftADS = 173,
	GamepadBaseSpeedMultiplierYSoftADS = 174,
	GamepadMaxSpeedMultiplierXSoftADS = 175,
	GamepadMaxSpeedMultiplierYSoftADS = 176,
	GamepadMaxAccelerationThresholdSoftADS = 177,
	GamepadAimAccelDelaySecondsSoftADS = 178,
	GamepadAimAccelRampUpSecondsSoftADS = 179,
	AimToolingAimAccelerationDelayDelayAmount = 180,
	AimToolingAimAccelerationDelayRampUpAmount = 181,
	AimToolingTFPlayerScale = 182,
	AimToolingFORPlayerScale = 183,
	AimToolingSAPlayerScale = 184,
	AimToolingPTCPlayerScale = 185,
	ObserverRunSpeedModifier = 186,
	ObserverWalkSpeedModifier = 187,
	GyroShootingThresholdTap = 188,
	GyroShootingThresholdHold = 189,
	GyroShootingVisualBarMax = 190,
	GyroMovementWalkThresholdHorizontal = 191,
	GyroMovementWalkThresholdVertical = 192,
	GyroMovementRunThresholdHorizontal = 193,
	GyroMovementRunThresholdVertical = 194,
	GyroShotMovementDeadzoneThreshold = 195,
	GyroShotMovementDeadzoneValue = 196,
	GamepadAggroBotMoshPitSensitivity = 197,
	GamepadAggroBotThrashSensitivity = 198,
	GamepadBountyHunterPrecisionModeSensitivity = 199,
	GamepadBountyHunterProwlerSensitivity = 200,
	GamepadBountyHunterSeizeSensitivity = 201,
	GamepadBreachAftershockSensitivity = 202,
	GamepadBreachFaultLineSensitivity = 203,
	GamepadBreachFlashpointSensitivity = 204,
	GamepadCableAnnihilationSensitivity = 205,
	GamepadCableGravNetSensitivity = 206,
	GamepadClayPaintShellSensitivity = 207,
	GamepadClayShowstopperSensitivity = 208,
	GamepadCloudburstSensitivity = 209,
	GamepadGrenadierFlashDriveSensitivity = 210,
	GamepadGrenadierFragmentSensitivity = 211,
	GamepadGrenadierZeroPointSensitivity = 212,
	GamepadGuideGuidingLightSensitivity = 213,
	GamepadGuideTrailblazerSensitivity = 214,
	GamepadGumshoePrecisionModeSensitivity = 215,
	GamepadGumshoeSpycamSensitivity = 216,
	GamepadHunterHuntersFurySensitivity = 217,
	GamepadHunterReconBoltSensitivity = 218,
	GamepadHunterShockBoltSensitivity = 219,
	GamepadMageHighTideSensitivity = 220,
	GamepadPandemicPoisonCloudSensitivity = 221,
	GamepadPandemicSnakeBiteSensitivity = 222,
	GamepadPhoenixBlazeSensitivity = 223,
	GamepadSargeAbilityTabletSensitivity = 224,
	GamepadSargePrecisionModeSensitivity = 225,
	GamepadSequoiaUndercutSensitivity = 226,
	GamepadSmonkButterflyKnifeSensitivity = 227,
	GamepadStealthBlindsideSensitivity = 228,
	GamepadWraithDarkCoverSensitivity = 229,
	GamepadWraithFromTheShadowsSensitivity = 230,
	GamepadWraithShroudedStepSensitivity = 231,
	EAresFloatSettingName_MAX = 232
};
...
enum class EAresIntSettingName : uint8 {
	...
	PlayerPerf_LastSetting = 64,
	NetworkSmoothing = 65,
	ShootingRangeSkillTestSetting = 66,
	ShootingRangePlantModuleDifficultySetting = 67,
	ShootingRangeDefuseModuleDifficultySetting = 68,
	GamepadSavedPreset = 69,
	GamepadSavedAimCurve = 70,
	GamepadSavedAimCurveADS = 71,
	GamepadSavedAimCurveScoped = 72,
	GamepadSavedAimCurveSoftADS = 73,
	GamepadSavedAimCurveAngularDeadzone = 74,
	GamepadAnalogMoveThresholdMode = 75,
	GamepadWeaponSwapMode = 76,
	GamepadWeaponSwapInputType = 77,
	GamepadJettGlidePressBehavior = 78,
	GamepadAimStickSquaringMode = 79,
	TouchDoubleTapRight = 80,
	TouchHUDPreset = 81,
	TouchDoubleTapLeft = 82,
	TouchAimAccelerationCurveX = 83,
	TouchAimAccelerationCurveY = 84,
	TouchAimADSAccelerationCurveX = 85,
	TouchAimADSAccelerationCurveY = 86,
	TouchAimSniperAccelerationCurveX = 87,
	TouchAimSniperAccelerationCurveY = 88,
	TouchJoystickStyle = 89,
	TouchSniperZoomLevelSetting = 90,
	TouchOperatorZoomCycleStyle = 91,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 92,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 93,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 94,
	TouchAimSensitivityPreset = 95,
	TouchGyroSensitivityPreset = 96,
	TouchTrackballSensitivityPreset = 97,
	TouchDoubleTapTopLeft = 98,
	TouchDoubleTapTopMiddle = 99,
	TouchDoubleTapTopRight = 100,
	TouchDoubleTapMiddleLeft = 101,
	TouchDoubleTapMiddle = 102,
	TouchDoubleTapMiddleRight = 103,
	TouchDoubleTapBottomLeft = 104,
	TouchDoubleTapBottomMiddle = 105,
	TouchDoubleTapBottomRight = 106,
	TouchNumVerticalRegions = 107,
	TouchNumHorizontalRegions = 108,
	MaxFramerateInBuyPhase = 109,
	MaxFramerateInGamePhase = 110,
	MaxFramerateInSpectatorView = 111,
	ShootingRangeBotMode = 112,
	ShootingRangeBotAmount = 113,
	LastSeenRoamingSettingsVersion = 114,
	EAresIntSettingName_MAX = 115
};
...
enum class EAresBoolSettingName : uint8 {
	...
	AESWheelHoldEnabled = 65,
	CrosshairHasOutline = 66,
	CrosshairDisplayCenterDot = 67,
	CrosshairUseCustomColor = 68,
	CrosshairFixMinErrorAcrossWeapons = 69,
	CrosshairUseAdvancedOptions = 70,
	CrosshairInnerLinesShowMovementError = 71,
	CrosshairInnerLinesShowShootingError = 72,
	CrosshairInnerLinesShowMinError = 73,
	CrosshairInnerLinesShowLines = 74,
	CrosshairInnerLinesAllowVertScaling = 75,
	CrosshairOuterLinesShowMovementError = 76,
	CrosshairOuterLinesShowShootingError = 77,
	CrosshairOuterLinesShowMinError = 78,
	CrosshairOuterLinesShowLines = 79,
	CrosshairOuterLinesAllowVertScaling = 80,
	CrosshairUseCustomCrosshairOnAllPrimary = 81,
	CrosshairUsePrimaryCrosshairForADS = 82,
	CrosshairADSHasOutline = 83,
	CrosshairADSDisplayCenterDot = 84,
	CrosshairADSUseCustomColor = 85,
	CrosshairADSFixMinErrorAcrossWeapons = 86,
	CrosshairADSInnerLinesShowMovementError = 87,
	CrosshairADSInnerLinesShowShootingError = 88,
	CrosshairADSInnerLinesShowMinError = 89,
	CrosshairADSInnerLinesShowLines = 90,
	CrosshairADSInnerLinesAllowVertScaling = 91,
	CrosshairADSOuterLinesShowMovementError = 92,
	CrosshairADSOuterLinesShowShootingError = 93,
	CrosshairADSOuterLinesShowMinError = 94,
	CrosshairADSOuterLinesShowLines = 95,
	CrosshairADSOuterLinesAllowVertScaling = 96,
	CrosshairSniperDisplayCenterDot = 97,
	CrosshairSniperUseCustomColor = 98,
	AlwaysShowInventoryWidgets = 99,
	LeftHanded = 100,
	TeamColorCrosshair = 101,
	AllyLoadoutInfoAlwaysVisibile = 102,
	TacticalCalloutsInChat = 103,
	TouchAimInvertX = 104,
	TouchAimInvertY = 105,
	TouchAimOneEuroFilteringEnabled = 106,
	TouchAimMultiTouchFilteringEnabled = 107,
	TouchAimContinueFilteringAfterRelease = 108,
	TouchAimTrackballEnabled = 109,
	TouchGyroAimOneEuroFilteringEnabled = 110,
	TouchGyroAimEnabled = 111,
	TouchGyroAimInvertX = 112,
	TouchGyroAimInvertY = 113,
	TouchGyroDroneAimEnabled = 114,
	TouchCustomAbilityUI = 115,
	TouchAbilityRestoreLastEquippable = 116,
	TouchUseSprintToggle = 117,
	TouchUseHalfScreenMovementArea = 118,
	...
	TouchMarshalCycleZoomOnHold = 128,
	TouchTrackballEnableLinearDrag = 129,
	TouchQuickCastingEnabled = 130,
	TouchJoystickFollowHorizontalOnly = 131,
	GamepadInvertLookStickY = 132,
	GamepadInvertLookStickX = 133,
	GamepadToggleDropSpikeHold = 134,
	StanceIndicatorEnabled = 135,
	GamepadTapToCycleIncompleteInventory = 136,
	GamepadJettAutomaticGlide = 137,
	GamepadRotationIncreaseAccelEnabled = 138,
	GamepadForceDesiredAngle = 139,
	GamepadForceWalkWhileFocusedOrZoomed = 140,
	GamepadUseBaseSpeedMultipliers = 141,
	GamepadUseShootingSensMultipliers = 142,
	MultithreadedRenderingEnabled = 143,
	AimToolingDCPlayerEnabled = 144,
	HasEverStartedAMatch = 145,
	HasAcceptedCodeOfConduct = 146,
	HasSeenNewPlayerSettings = 147,
	HasSeenNPEContractTutorial = 148,
	HasSeenUPWTutorial = 149,
	HasSeenSettingsTutorial = 150,
	HasSeenWelcomeScreen = 151,
	HasSeenMenuTutorial = 152,
	HasSeenPhotoSensitivityWarning = 153,
	HasSeenTournamentsScreen = 154,
	HasSeenXGPActivationModal = 155,
	HasSeenTrainingPrompt = 156,
	CollectionShowOwnedOnly = 157,
	IncognitoHideMatchmadePlayerNames = 158,
	IncognitoRejectFriendRequests = 159,
	IncognitoRejectPartyInvitesByDisplayName = 160,
	PlayerBehavior_MuteEnemyTextChat = 161,
	PlayerBehavior_MuteObserverTextChat = 162,
	HideUI = 163,
	HideCrosshair = 164,
	Hide1P = 165,
	HideOutlinesAndFresnel = 166,
	ObserversSeeBlinds = 167,
	TeamColorAffectsHUD = 168,
	ShowKeybindsOnMinimap = 169,
	ShowKeybindsOnMegamap = 170,
	FullscreenMegamap = 171,
	HandednessByTeam = 172,
	HideSpectatedAgentPortrait = 173,
	ObserverToggleScoreboard = 174,
	HasEverAppliedRoamingSettings = 175,
	HasEverAppliedRoamingSettingsGamepad = 176,
	GyroTapShoot = 177,
	GyroShootingAxisSwap = 178,
	GyroShootingAxisInvert = 179,
	GyroShootingDisplayBar = 180,
	GyroMovementAxisInvertVertical = 181,
	GyroMovementAxisInvertHorizontal = 182,
	ShowColoredMuzzleFlashes = 183,
	MaxbotGameplayVO = 184,
	MaxbotFlavorVO = 185,
	RGIInputLatencyEnabled = 186,
	VoiceSelfMuteEnabled = 187,
	MatureContentFilter = 188,
	ShowBloodVisual = 189,
	ShowCorpsesVisual = 190,
	AllowCrossPlay = 191,
	ShowNewPlayerTips = 192,
	ContextAwareModuleComplete = 193,
	EnableToggleableUsables = 194,
	GamepadRiftCosmicDivideOffset = 195,
	GamepadClayAutomatedBackthrow = 196,
	EAresBoolSettingName_MAX = 197
};
...
enum class EAresStringSettingName : uint8 {
	...
	MutedWords = 20,
	CheatEOGMatchID = 21,
	PlayerPerfPresetType = 22,
	NativePlatformSelectedLanguage = 23,
	PremierPromotionNotice = 24,
	EAresStringSettingName_MAX = 25
};
...
enum class EGameFeatureToggleName : uint8 {
	...
	ServerRewindedMovement = 13,
	ToggleGore = 14,
	CalloutRegionsDebug = 15,
	DesignerToggleA = 16,
	DesignerToggleB = 17,
	DesignerToggleC = 18,
	DowntickPreround = 19,
	ReuseActorOnRespawn = 20,
	LookDirectionKeys = 21,
	DevInstabilityHUD = 22,
	GameplayQualityLogging = 23,
	LogMarkers = 24,
	EnableSlashCommands = 25,
	NiagaraTest = 26,
	ShowDrawVoteInCustom = 27,
	ShowLeftHandedSetting = 28,
	AllowShoppingWhileDead = 29,
	DeathmatchRepeatingUAV = 30,
	DeathmatchEncourageFarSpawning = 31,
	DatadogEventing = 32,
	GameDataExport = 33,
	ReuseCharacterHUDWidgets = 34,
	RegisterEquippableVisibility = 35,
	FixedColorTeams = 36,
	RoundStateLog = 37,
	DisableEquippableAnimationInFXCs = 38,
	YoruAltTeleportTargeting = 39,
	RequestViewTargetModeUpdate = 40,
	Ep2TacVO = 41,
	EnableHRTFSetting = 42,
	Coaches = 43,
	TaggingAccuracyOverride = 44,
	ForceUpdateProblematicMinimapComponents = 45,
	GameplayNotificationsV2 = 46,
	EnableBehaviorScoreTrackers = 47,
	TencentSecuritySDK = 48,
	PlayerThroughWallClipping = 49,
	PlayerThroughWallBackClipping = 50,
	PlayerMultipleClipping = 51,
	PlayerCorpseClipping = 52,
	GameDataEventPipelineRefactor = 53,
	RoundRestore = 54,
	MatchRecovery = 55,
	Hovercards = 56,
	ModesToggleA = 57,
	ModesToggleB = 58,
	ModesToggleC = 59,
	MobileLimitedSkinLoading = 60,
	RoamingSettingsLocalCache = 61,
	EnableCharacterScaling = 62,
	Totems = 63,
	FXCPoolWarming = 64,
	TopHUDV2 = 65,
	MultipleProjectileTuning = 66,
	ProjectileJumpThrowNormalization = 67,
	ReplaySystem = 68,
	ReflexLatencyAnalyzer = 69,
	EnableDynamicSpawnAlternateRotations = 70,
	SpawnAlternateRotationsPathfindToNearestEnemy = 71,
	FoWDebugCheats = 72,
	AgentMastery = 73,
	EnableSpawnPointLookAheadBox = 74,
	DeathDistanceScoring = 75,
	ScoreLowVisibilityPointsMoreOften = 76,
	MoveProcessingDelayDebug = 77,
	SpawnPointLookAheadDynamicAdjustment = 78,
	UseMegamapTextureOverrides = 79,
	NVCUpdates = 80,
	RationalMoveQueueTarget = 81,
	SprayV2 = 82,
	WheelShowupDelay = 83,
	SeparateQuickSpray = 84,
	CleanPlayerStateOnDisassociate = 85,
	FXCPerspectiveUpdateFix = 86,
	EnableCypherGameObject = 87,
	FireButtonCustomization = 88,
	DevOnlyShop = 89,
	EnableJumpCrouch = 90,
	ChamberTPDeathBehaviorFix = 91,
	AllowGameplayTagFastReplication = 92,
	MoveDistributionTargeting = 93,
	LineupCompass = 94,
	LineupOverlay = 95,
	RPCValidationWithDisconnect = 96,
	SendPerRoundNetworkTelemetryEvents = 97,
	DeathMatchPlayerSpawnedTelemetryEnabled = 98,
	LiveDiagnostics = 99,
	ExpandedGestures = 100,
	DeathPuckSizeAdjustment = 101,
	GyroShooting = 102,
	EnableCombatReportEventDeferral = 103,
	UseAbilityTrackingComponent = 104,
	GyroMovement = 105,
	RelativeTriggerEnabled = 106,
	AudioVisualization = 107,
	AudioVisualizationIconFootstep = 108,
	AudioVisualizationLOS = 109,
	AudioVisualizationMaterialFootstep = 110,
	MultichannelAudioVisualization = 111,
	RevertMobileFiringError = 112,
	BurstFire = 113,
	BuffDamageRefactor = 114,
	SkyeSeekerRefactor = 115,
	SageWallFindFloorUsingCapsuleSweep = 116,
	PODetection = 117,
	MobileAllySendRateLimiting = 118,
	PremiumContentToggle0 = 119,
	PremiumContentToggle1 = 120,
	PremiumContentToggle2 = 121,
	PremiumContentToggle3 = 122,
	PremiumContentToggle4 = 123,
	PremiumContentToggle5 = 124,
	PremiumContentToggle6 = 125,
	PremiumContentToggle7 = 126,
	PremiumContentToggle8 = 127,
	PremiumContentToggle9 = 128,
	GradualMovementCorrections = 129,
	DebugMenuEnabledDefault = 130,
	UseMeshMaterialManager = 131,
	OmenCustomEQS = 132,
	OmenWallToggle = 133,
	VisionConeIntersectionFix = 134,
	CorpsesBlockWorldDynamic = 135,
	RateLimitClientInputs = 136,
	ErrorPowerByStabilityType = 137,
	AccoladesEnabled = 138,
	PremierGameEvents = 139,
	EquippableCacheRecycling = 140,
	ViperPitIgnoreCrawlspaceToggle = 141,
	EsportsGameEvents = 142,
	ScaledHeadshotFX = 143,
	ExplicitCharacterLoading = 144,
	MinimapFloors = 145,
	ShortTermNPEUpdates = 146,
	PatchHeightJumpCrouchExploitFix = 147,
	PatchHeightJumpCrouchExploitFixGekko = 148,
	FootstepDecayWhileWalking = 149,
	SystemicAbilityUpdates = 150,
	ConcussLowTickRate = 151,
	BombDestroysAllDestructibles = 152,
	OnlyDropCurrentEquippable = 153,
	ObserverMinimapComponentLocation = 154,
	EnableIncreasedNetDriverRateLimiting = 155,
	CellularPatchMultipleNodeOverlapCheck = 156,
	UseExtendedCombatReport = 157,
	AllowSkipRestrictionsForCurrentEquippable = 158,
	DisableFogOfWar = 159,
	RemoveClientPredictionDataForAI = 160,
	EsportsHub = 161,
	EnsureReplicationPauseSend = 162,
	PureTracers = 163,
	RebaseOnEnterFoW = 164,
	AbilityRechargeCooldownMulticastAll = 165,
	UsePlayerloadoutsInWeaponSpawners = 166,
	HideEnemyTracersOutsideGameplay = 167,
	KnifeOnlyFastFOV = 168,
	SkipEnemyMoveSendOutsideGameplay = 169,
	AllowPatchRunAlongGround = 170,
	SetOrbTickRateLow = 171,
	ReplayTimeScrubbing = 172,
	StopPreparedEffects = 173,
	EnableTapHoldActionBindings = 174,
	BotMovementDowntickingEnabled = 175,
	BotInterleaveMovementDowntickingEnabled = 176,
	AxialTracesCanUseComplexCollisionForEndpoints = 177,
	LimitedTrustedTargetingOnAbilities = 178,
	WraithSmokeInputPrototype = 179,
	CharacterLocationBunchData = 180,
	DoorsSnapToDefaultStateOnPostInitComponents = 181,
	CanCauseDamageWithNullDamageEventComponent = 182,
	LargeActorOverlapFixForWallMeshOverlap = 183,
	EnableDeadlockNeonTimedDoorEvacFix = 184,
	RemoveDeletedFXCsFromPool = 185,
	DisassociateAFKPlayers = 186,
	ReplayDataGameServerCompression = 187,
	OffsetHiddenMontages = 188,
	GamepadAimAccelResetEnabled = 189,
	GamepadAimAccelDelayResetEnabled = 190,
	LimitIncomingConnections = 191,
	VisionConeEarlyRelativeAngleCulling = 192,
	HapticDPTPrototyping = 193,
	ShootingRangeBotPoolingRefactor = 194,
	GamepadMegamapCommInput = 195,
	AccoladesTelemetryEnabled = 196,
	DDoSDetection = 197,
	AIToggleA = 198,
	AIToggleB = 199,
	TimeShiftByMoveBundles = 200,
	LockedMapControlType = 201,
	SwapViewTargetModeToWatchSpawnedOnDeath = 202,
	DisableCharacterTickOnRangeBots = 203,
	UseCachedBaseTeamComponentOnAresPlayerState = 204,
	ContextAwareModuleEnabled = 205,
	DisarmedComponentProgressesToEquipState = 206,
	PreventWeaponSwapSpamWhileDisarmed = 207,
	UnifyBaseAndRegionalDamageCalculation = 208,
	AllShotTelemetryEnabled = 209,
	AllyMapEdgePortraits = 210,
	PrecalcProjectileCollisionUsesTriggers = 211,
	UseAIJobCoordinationBehavior = 212,
	VTSPluginEnabled = 213,
	VTSPluginObserverEnabled = 214,
	ContextAwareModuleVisualsEnabled = 215,
	AIUseDistanceRoomPathfindingCosting = 216,
	EnableDoubleSniperOnAltModes = 217,
	ClientAuthBlinds = 218,
	SeparateCRInterpForRemoteClients = 219,
	EquippableReplicationImprovements = 220,
	SupportsNewPreRoundShop = 221,
	AlwaysTick3PAnimsForLocalPlayer = 222,
	PrimitiveComponentUpdateOverlapsChildren = 223,
	ValidPurchasableForItemClassCheck = 224,
	AnimationOptimizationBTM = 225,
	AnimationOptimizationBTMAllies = 226,
	FocusModeEnabled = 227,
	ArmorHUDFlooring = 228,
	UseNewInformationScreen = 229,
	AimToolingCloseRangeTuningEnabled = 230,
	DisableNonGamepadKeyBinds = 231,
	EnableGamepadVotingUI = 232,
	WallCollisionV2 = 233,
	Count = 234,
	Invalid = 254,
...
enum class EGameRuleBoolName : uint8 {
	...
	AllowDropOut = 5,
	SkipPregame = 6,
	AssignRandomAgents = 7,
	AllowGameModifiers = 8,
	TournamentMode = 9,
	MajorityVoteAgents = 10,
	PlayOutAllRounds = 11,
	SkipMatchHistory = 12,
	FillWithBots = 13,
	AllowDropIn = 14,
	UseMobileServerTickRate = 15,
	...
	AimToolingModule = 21,
	AimToolingBending = 22,
	AimToolingPullToCenter = 23,
	AimToolingAimAccelerationDelay = 24,
	AimToolingDeceleration = 25,
	AimToolingFrameOfReference = 26,
	AimToolingStrafeAssist = 27,
	AimToolingTargetFriction = 28,
	MovementToolingModule = 29,
	MovementToolingShotRooting = 30,
	MovementToolingFastStrafing = 31,
	MovementToolingFastRelease = 32,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	SilentFramesBeforeBurstLoss = 22,
	GamepadMaxFramerateAlways = 23,
	EndToEndLatencyJitter = 24,
	ABFootstepTestControlPercent = 25,
	RelativeTriggerThreshold = 26,
	RelativeTriggerDeltaSensitivity = 27,
	GameDataWorldSnapshotIntervalSec = 28,
	GameDataWorldConfigurationIntervalSec = 29,
	GameDataTimeseriesIntervalSec = 30,
	ShortTermNPEUpdatesChance = 31,
	MaxSnapshotCountForShortGames = 32,
	GamepadAimAccelResetAngle = 33,
	DesignerFloatA = 34,
	DesignerFloatB = 35,
	DesignerFloatC = 36,
	DesignerFloatD = 37,
	DesignerFloatE = 38,
	AwakeReplicationFrequency = 39,
	Count = 40,
	Invalid = 254,
...
enum class ETournamentPlacement : uint8 {
	FIRST = 99,
	SECOND = 98,
	THIRD = 97,
	FOURTH = 96,
...
enum class ECreateRosterInviteErrorType : uint8 {
	...
	InviteeChangesRosterDivisionTier = 2,
	InviteeNotEligibleAVS = 3,
	InviteeNotEligibleRanked = 4,
	InviteeNotEligibleRestrictionIneligible = 5,
	InviteeNotEligibleRestrictionDisqualified = 6,
	Default = 7,
	Count = 8,
	Invalid = 9,
	ECreateRosterInviteErrorType_MAX = 10
};
...
enum class EAresWidgetDependentState : uint8 {
	...
	Collapsed = 3,
	None = 4,
	EAresWidgetDependentState_MAX = 5
};
...
enum class EUIConfirmationModalType : uint8 {
	...
	Confirm = 1,
	ConfirmCancel = 2,
	EUIConfirmationModalType_MAX = 3
};
...
// Enum ShooterGame.ECrosshairsGridScreen
enum class ECrosshairsGridScreen : uint8 {
	NewCrosshairStyle = 0,
	SwitchCrosshairStyle = 1,
	None = 2,
	ECrosshairsGridScreen_MAX = 3
};
...
// Enum ShooterGame.EGamepadAimStickSquaringMode
enum class EGamepadAimStickSquaringMode : uint8 {
	Off = 0,
	Partial = 1,
	Full = 2,
	Count = 3,
	EGamepadAimStickSquaringMode_MAX = 4
};
...
enum class EAresSocialStatusTemplate : uint8 {
	...
	Generic = 9,
	Blocked = 10,
	EAresSocialStatusTemplate_MAX = 11
};
...
// Enum ShooterGame.EBTEStatus
enum class EBTEStatus : uint8 {
	BTENotSet = 0,
	BTENotComplete = 1,
	BTEComplete = 2,
	Invalid = 3,
...
enum class EEquippableSkinLevelItem : uint8 {
	...
	Transformation = 17,
	EEquippableSkinLevelItem_MAX = 18
};
...
enum class EAresMainMenuTopNavigationState : uint8 {
	...
	BTE = 20,
	None = 21,
	EAresMainMenuTopNavigationState_MAX = 22
};
...
enum class EPlatformInitErrorReason : uint8 {
	...
	Count = 93,
	EPlatformInitErrorReason_MAX = 94
};
...
struct FTeamDTO {
	...
	struct FString ImageLowResURL; // 0x40(0x10)
	struct FString ImageHighResURL; // 0x50(0x10)
	struct FString AlternativeImageURL; // 0x60(0x10)
	struct FString BackgroundImageURL; // 0x70(0x10)
	struct FString PrimaryColor; // 0x80(0x10)
	struct FString SecondaryColor; // 0x90(0x10)
	struct FMatchOutcomeDTO MatchOutcome; // 0xa0(0x38)
	struct FOriginDTO Origin; // 0xd8(0x28)
	struct TArray<struct FPlayerDTO> Players; // 0x100(0x10)
	struct FTeamRecordDTO Record; // 0x110(0x0c)
	char pad_11C[0x4]; // 0x11c(0x04)
	struct FHomeLeagueDTO HomeLeague; // 0x120(0x40)
	struct FString BundleID; // 0x160(0x10)
};
...
struct FEsportsPlayerStatsListDTO {
	struct TArray<struct FEsportsPlayerStatsDTO> Data; // 0x00(0x10)
};
...
struct FMatchDetailsDTO {
	...
	struct TArray<struct FTeamDetailsDTO> Teams; // 0x108(0x10)
	struct TArray<struct FRoundResultDTO> RoundResults; // 0x118(0x10)
};
...
struct FPlayerDetailsDTO {
	...
	bool IsObserver; // 0x9c(0x01)
	char pad_9D[0x3]; // 0x9d(0x03)
	struct FGuid PlayerCard; // 0xa0(0x10)
	struct FGuid PlayerTitle; // 0xb0(0x10)
	struct FGuid PreferredLevelBorder; // 0xc0(0x10)
	int32_t AccountLevel; // 0xd0(0x04)
...
struct FPremierLeaderboardEntry {
	...
	enum class ETournamentPlacement PlayoffResult; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
...
struct FPremierPlayerCrests {
	struct FString Puuid; // 0x00(0x10)
	struct TMap<struct FGuid, struct FPremierPlayerSeason> Seasons; // 0x10(0x50)
};
...
struct FPremierPlayerSeason {
	...
	bool IsProvisionalDivision; // 0x44(0x01)
	char pad_45[0x3]; // 0x45(0x03)
	int64_t Points; // 0x48(0x08)
	struct TMap<enum class EPremierEventType, int64_t> GamesPlayedByEventType; // 0x50(0x50)
	enum class EPremierCrestType Crest; // 0xa0(0x01)
	char pad_A1[0x7]; // 0xa1(0x07)
	int64_t ChampionshipPointRequirement; // 0xa8(0x08)
};
...
struct FMatchupGame {
	...
	struct TArray<struct FMatchupGameScore> Scores; // 0x28(0x10)
	struct TArray<struct FMatchupGamePlacement> Placements; // 0x38(0x10)
...
struct FRGICommonNavBarDetails {
	...
	struct FWildcard Data; // 0x28(0x40)
};
...
struct FAbilityInstigatedEffectContext : FGameplayEffectContext {
	int32_t CastID; // 0x70(0x04)
	struct TWeakObjectPtr<struct AAresEquippable> InstigatingEquippable; // 0x74(0x08)
	char pad_7C[0x4]; // 0x7c(0x04)
};
...
struct FAIAimTargetInfo {
	...
	struct FVector LocationTarget; // 0x08(0x0c)
	char pad_14[0x4]; // 0x14(0x04)
};
...
struct FCachableAnimationData {
	...
	struct TMap<struct UAnimInstance*, enum class EAnimArrayDirtyFlags> AnimArrayDirtyFlags; // 0x110(0x50)
};
...
struct FAnimationStateParams {
	...
	struct FVector FocusedWeaponOffset; // 0x7c(0x0c)
	struct FRotator FocusedWeaponRotation; // 0x88(0x0c)
	float FocusedWeaponAlpha; // 0x94(0x04)
	float InaccuracyMultiplier; // 0x98(0x04)
	float AnimPunch; // 0x9c(0x04)
	float AnimPunchHeight; // 0xa0(0x04)
	float AnimPunchRot; // 0xa4(0x04)
	float AnimPunchInterpolant; // 0xa8(0x04)
	float AnimLeanPitchAndRollStrength; // 0xac(0x04)
	float AnimLeanYawStrength; // 0xb0(0x04)
	float AnimLeanTranslationStrength; // 0xb4(0x04)
	float YawMomentumRotation; // 0xb8(0x04)
	float PitchMomentumRotation; // 0xbc(0x04)
	float DeltaTime; // 0xc0(0x04)
	enum class EAresShooterAnimMovementState MovementState; // 0xc4(0x01)
	char pad_C5[0x3]; // 0xc5(0x03)
	struct FMovementStateMachineAnimations MovementStateMachineAnimations1P; // 0xc8(0x18)
	struct FMovementStateMachineAnimations MovementStateMachineAnimationsGun1P; // 0xe0(0x18)
	struct FMovementStateMachineAnimations MovementStateMachineAnimationsCosmeticGun1P; // 0xf8(0x18)
	bool bHasUpperBodyFall3P; // 0x110(0x01)
	bool bHasCrouchUpperBodyFall3P; // 0x111(0x01)
	bool bIsJumping; // 0x112(0x01)
	bool bIsZoomed; // 0x113(0x01)
	bool bIsStopping2D; // 0x114(0x01)
	bool bIsCounterStrafing; // 0x115(0x01)
	bool bLanded; // 0x116(0x01)
	bool bJumped; // 0x117(0x01)
	bool bGlide; // 0x118(0x01)
	bool bIsCrouched; // 0x119(0x01)
	char pad_11A[0x2]; // 0x11a(0x02)
	float TimeSinceJumpStart; // 0x11c(0x04)
	bool bJumpLandCanTransition; // 0x120(0x01)
	bool bCrouchCanTransition; // 0x121(0x01)
	bool bUnCrouchCanTransition; // 0x122(0x01)
	bool bIsUsingAltAnims; // 0x123(0x01)
	bool bIsInIdleState; // 0x124(0x01)
	bool bIsOnRope; // 0x125(0x01)
	bool bIsTurningLeft; // 0x126(0x01)
	bool bIsTurningRight; // 0x127(0x01)
	bool bStandingStill; // 0x128(0x01)
	bool bStill; // 0x129(0x01)
	bool bPlayingDeathReaction; // 0x12a(0x01)
	bool bIsDeathReactionFaceUp; // 0x12b(0x01)
	bool bCanInterruptDeathReaction; // 0x12c(0x01)
	bool bIsAlive; // 0x12d(0x01)
	bool bHasEquippable; // 0x12e(0x01)
	bool bIsFiring; // 0x12f(0x01)
	bool bJustFired; // 0x130(0x01)
	bool bIsMeleeAttacking; // 0x131(0x01)
	char pad_132[0x2]; // 0x132(0x02)
	float BlindAmount; // 0x134(0x04)
	bool bCanFidget; // 0x138(0x01)
	char pad_139[0x3]; // 0x139(0x03)
	float MovementAdditiveAlpha; // 0x13c(0x04)
	float AnimDynamicsAlpha; // 0x140(0x04)
	float AimOffsetAlpha; // 0x144(0x04)
	float LowerBodyAimOffsetAlpha; // 0x148(0x04)
	float BoneTransformAimAlpha; // 0x14c(0x04)
	float BoneTransformAimConstraintAlpha; // 0x150(0x04)
	float FaceLayerAlpha; // 0x154(0x04)
	bool bTriggerFaceFidget; // 0x158(0x01)
	char pad_159[0x3]; // 0x159(0x03)
	float RigidBodyAlpha; // 0x15c(0x04)
	float ClothAlpha; // 0x160(0x04)
	float LeftHandIKAlpha; // 0x164(0x04)
	float RightHandIKAlpha; // 0x168(0x04)
	struct FVector LeftHandIKLocation; // 0x16c(0x0c)
	bool bUseLeftHandIKLocation; // 0x178(0x01)
	bool FootIKEnabled; // 0x179(0x01)
	char pad_17A[0x2]; // 0x17a(0x02)
	struct FRotator FootIKBoneRot; // 0x17c(0x0c)
	struct FVector FootIKBoneScale; // 0x188(0x0c)
	struct FVector FootIKActorDownTranslation; // 0x194(0x0c)
	float FootIKAlpha; // 0x1a0(0x04)
	float UpperBody3PAnimSlotBlendTime; // 0x1a4(0x04)
	float LowerBody3PAnimSlotBlendTime; // 0x1a8(0x04)
	float AnimSlotBlendTime1P; // 0x1ac(0x04)
	float AimOffsetBlendTime3P; // 0x1b0(0x04)
	float LowerBodyMontageWeight; // 0x1b4(0x04)
	float CrouchLowerBodyMontageAlpha; // 0x1b8(0x04)
	struct FVector CrouchSplitterTranslation; // 0x1bc(0x0c)
	float SpineBlendWeight; // 0x1c8(0x04)
	float ReapplyHandPoseBlendWeight; // 0x1cc(0x04)
	float HitReactionDamageNorthSouthBlendSpaceAlpha; // 0x1d0(0x04)
	float HitReactionDamageEastWestBlendSpaceAlpha; // 0x1d4(0x04)
	bool bHitReactionTriggered; // 0x1d8(0x01)
	bool bHitReactionTriggeredThisFrame; // 0x1d9(0x01)
	char pad_1DA[0x2]; // 0x1da(0x02)
	float CrouchUnits; // 0x1dc(0x04)
	float CrouchAmount; // 0x1e0(0x04)
	bool bIsLeftHanded; // 0x1e4(0x01)
...
struct FAimToolingTelemetryEvent {
	...
	struct FAimToolingTelemetryData AimToolingData; // 0x28(0x68)
};

// ScriptStruct ShooterGame.AimAccelerationSensitivityModifiers
// Size: 0x10 (Inherited: 0x00)
struct FAimAccelerationSensitivityModifiers {
	float AimAccelerationXScale; // 0x00(0x04)
	float AimAccelerationYScale; // 0x04(0x04)
	float AimAccelerationModifierRampUpTimeScale; // 0x08(0x04)
	float AimAccelerationModifierRampUpDelayScale; // 0x0c(0x04)
};
...
struct FAresDebugSpherePersistent {
	...
	float TimeLastUpdated; // 0x04(0x04)
	float LifeTime; // 0x08(0x04)
	struct FVector Center; // 0x0c(0x0c)
...
struct FAllInitSystems {
	...
	struct UPatchNotesManager* PatchNotesManager; // 0x150(0x08)
	struct UAresWatermarkManager* WatermarkManager; // 0x158(0x08)
	struct UInventoryManager* InventoryManager; // 0x160(0x08)
	struct UPlayerListingManager* PlayerListingManager; // 0x168(0x08)
	struct UPartyListingManager* PartyListingManager; // 0x170(0x08)
	struct UWhisperChatManager* WhisperChatManager; // 0x178(0x08)
	struct UNotificationManager* NotificationManager; // 0x180(0x08)
	struct UDebugNotificationEmitter* DebugNotificationEmitter; // 0x188(0x08)
	struct UPartyNotificationManager* PartyNotificationManager; // 0x190(0x08)
	struct UFriendNotificationManager* FriendNotificationManager; // 0x198(0x08)
	struct UPlayerReportNotificationManager* PlayerReportNotificationManager; // 0x1a0(0x08)
	struct UVoiceModel* VoiceModel; // 0x1a8(0x08)
	struct UVoicePreferencesManager* VoicePreferencesManager; // 0x1b0(0x08)
	struct UVoiceViewController* VoiceViewController; // 0x1b8(0x08)
	struct UMatchmakingManager* MatchmakingManager; // 0x1c0(0x08)
	struct UPregameManager* PregameManager; // 0x1c8(0x08)
	struct UContractsManager* ContractsManager; // 0x1d0(0x08)
	struct UBTEManager* BTEManager; // 0x1d8(0x08)
	struct UContractDefinitionsManager* ContractDefinitionsManager; // 0x1e0(0x08)
	struct UContractsViewController* ContractsViewController; // 0x1e8(0x08)
	struct UCrosshairManager* CrosshairManager; // 0x1f0(0x08)
	struct URewardGrantModelFactory* RewardGrantModelFactory; // 0x1f8(0x08)
	struct UVanguardManager* VanguardManager; // 0x200(0x08)
	struct UDropInLoadingManager* DropInLoadingManager; // 0x208(0x08)
	struct UChatSessionManager* ChatSessionManager; // 0x210(0x08)
	struct UPurchaseManager* PurchaseManager; // 0x218(0x08)
	struct UPlatformOffersManager* PlatformOffersManager; // 0x220(0x08)
	struct UStoreManager* StoreManager; // 0x228(0x08)
	struct UStoreUITelemetryManager* StoreUITelemetryManager; // 0x230(0x08)
	struct UStoreViewControllerV2* StoreViewController; // 0x238(0x08)
	struct UPlayerFeedbackToolViewController* PlayerFeedbackToolViewController; // 0x240(0x08)
	struct UAresClientEvents* AresClientEvents; // 0x248(0x08)
	struct UCompetitiveTierUpdater* CompetitiveTierUpdater; // 0x250(0x08)
	struct UPlayerIdentityUpdater* PlayerIdentityUpdater; // 0x258(0x08)
	struct UProvisioningErrorNotificationManager* ProvisioningErrorNotificationManager; // 0x260(0x08)
	struct ULegalInfoManager* LegalInfoManager; // 0x268(0x08)
	struct UMapLoadModel* MapLoadModel; // 0x270(0x08)
	struct UMenuStackManager* MenuStackManager; // 0x278(0x08)
	struct UUINavigationManager* UINavigationManager; // 0x280(0x08)
	struct UModalManager* ModalManager; // 0x288(0x08)
	struct UFlyoutManager* FlyoutManager; // 0x290(0x08)
	struct UPlayerAliasManager* PlayerAliasManager; // 0x298(0x08)
	struct UPaymentsManager* PaymentsManager; // 0x2a0(0x08)
	struct UPingManager* PingManager; // 0x2a8(0x08)
	struct UOnlineIdentityManager* OnlineIdentityManager; // 0x2b0(0x08)
	struct UPlayerSettingsTelemetry* PlayerSettingsTelemetry; // 0x2b8(0x08)
	struct UUITelemetryManager* UITelemetryManager; // 0x2c0(0x08)
	struct UActionTraitsManager* ActionTraitsManager; // 0x2c8(0x08)
	struct UActionBindingsManager* ActionBindingsManager; // 0x2d0(0x08)
	struct UPlayerFacingPerfManager* PlayerFacingPerfManager; // 0x2d8(0x08)
	struct UApplicationRepairManager* ApplicationRepairManager; // 0x2e0(0x08)
	struct UArsenalViewController* ArsenalViewController; // 0x2e8(0x08)
	struct UPlayerAffinityManager* PlayerAffinityManager; // 0x2f0(0x08)
	struct UPatchAvailabilityManager* PatchAvailabilityManager; // 0x2f8(0x08)
	struct UPatchManager* PatchManager; // 0x300(0x08)
	struct URiotClientConfigManager* RiotClientConfigManager; // 0x308(0x08)
	struct UNPELoader* NPELoader; // 0x310(0x08)
	struct UTransitionModelManager* TransitionModelManager; // 0x318(0x08)
	struct UTutorialManager* TutorialManager; // 0x320(0x08)
	struct ULoginQueueManager* LoginQueueManager; // 0x328(0x08)
	struct URiotClientHeartbeatManager* RiotClientHeartbeatManager; // 0x330(0x08)
	struct ULocalePreferenceManager* LocalePreferenceManager; // 0x338(0x08)
	struct UVNGManager* VNGManager; // 0x340(0x08)
	struct UMassRewardsManager* MassRewardsManager; // 0x348(0x08)
	struct UPlayerLoginLocationHistoryManager* PlayerLoginLocationHistoryManager; // 0x350(0x08)
	struct URestrictionsManager* RestrictionsManager; // 0x358(0x08)
	struct UAccountXPManager* AccountXPManager; // 0x360(0x08)
	struct UReporterFeedbackManager* ReporterFeedbackManager; // 0x368(0x08)
	struct URiotWarningManager* RiotWarningManager; // 0x370(0x08)
	struct URosterManager* RosterManager; // 0x378(0x08)
	struct UTournamentsManager* TournamentsManager; // 0x380(0x08)
	struct UPremierManager* PremierManager; // 0x388(0x08)
	struct UPremierRosterManager* PremierRosterManager; // 0x390(0x08)
	struct UPremierRosterViewController* PremierRosterViewController; // 0x398(0x08)
	struct ULeaderboardManager* LeaderboardManager; // 0x3a0(0x08)
	struct ULeaderboardViewController* LeaderboardViewController; // 0x3a8(0x08)
	struct UMainMenuTelemetryManager* MainMenuTelemetryManager; // 0x3b0(0x08)
	struct UHovercardCacheManager* HovercardCacheManager; // 0x3b8(0x08)
	struct UEULAManager* EULAManager; // 0x3c0(0x08)
	struct UAVSManager* AVSManager; // 0x3c8(0x08)
	struct UDailyRewardsManager* DailyRewardsManager; // 0x3d0(0x08)
	struct UJuiceScreenViewController* JuiceScreenViewController; // 0x3d8(0x08)
	struct UFavoritesManager* FavoritesManager; // 0x3e0(0x08)
	struct UContentFilterViewController* ContentFilterViewController; // 0x3e8(0x08)
	struct UContentFilterUITelemetryManager* ContentFilterUITelemetryManager; // 0x3f0(0x08)
	struct UUserInfoNotificationManager* UserInfoNotificationManager; // 0x3f8(0x08)
	struct UClientTelemetryPersistence* TelemetryPersistence; // 0x400(0x08)
	struct ULatencyService* LatencyService; // 0x408(0x08)
	struct UPlatformEnvironmentManager* PlatformEnvironmentManager; // 0x410(0x08)
	struct UConfigManager* ConfigManager; // 0x418(0x08)
	struct URSOManager* RSOManager; // 0x420(0x08)
	struct UPlatformSessionManager* SessionManager; // 0x428(0x08)
	struct URMSManager* RMSManager; // 0x430(0x08)
	struct UPersonalizationManagerV2* PersonalizationManagerV2; // 0x438(0x08)
	struct UPartyManager* PartyManager; // 0x440(0x08)
	struct UPlayerReportManager* PlayerReportManager; // 0x448(0x08)
	struct UGlobalAudioManager* GlobalAudioManager; // 0x450(0x08)
	struct UEsportsManager* EsportsManager; // 0x458(0x08)
	struct UEsportsTelemetryManager* EsportsTelemetryManager; // 0x460(0x08)
	struct UReplayCatalogManager* ReplayManager; // 0x468(0x08)
	struct UAresRGIFriendsClient* RGIFriendsClient; // 0x470(0x08)
	struct UMainMenuParentWidget* MainMenuParent; // 0x478(0x08)
	struct UNativePlatformAuthManager* NativePlatformAuthManager; // 0x480(0x08)
};
...
struct FAresCommonConditionalInputAction {
	struct FText OverrideConditionalActionDisplayName; // 0x00(0x18)
	struct FDataTableRowHandle InputAction; // 0x18(0x18)
	enum class EAresCommonInputCondition InputCondition; // 0x30(0x01)
	bool bShouldOverrideInputActionIcon; // 0x31(0x01)
	bool bConditionActive; // 0x32(0x01)
...
struct FCrosshairPresetEntry {
	...
	struct FString PresetName; // 0x10(0x10)
	struct FGameplayTagContainer CrosshairFilters; // 0x20(0x20)
};

// ScriptStruct ShooterGame.AresPointDamageEvent
// Size: 0xc0 (Inherited: 0xb0)
struct FAresPointDamageEvent : FPointDamageEvent {
	enum class EAresRegionalDamage RegionalDamage; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	float DamageFalloff; // 0xb4(0x04)
	bool bDamageThroughWall; // 0xb8(0x01)
...
struct FEquippableAimToolingModifiers {
	...
	struct FString TuningTagHipfireCloseRange; // 0x18(0x10)
	struct FString TuningTagFocus; // 0x28(0x10)
	struct FString TuningTagADS; // 0x38(0x10)
};
...
struct FAresSystemTelemetryMetrics {
	struct FMetric AI; // 0x00(0x14)
	struct FMetric AI_Behavior; // 0x14(0x14)
	struct FMetric AI_Controller; // 0x28(0x14)
	struct FMetric AI_Movement; // 0x3c(0x14)
	struct FMetric AI_Perception; // 0x50(0x14)
	struct FMetric AI_SpatialAwareness; // 0x64(0x14)
	struct FMetric AI_Other; // 0x78(0x14)
	struct FMetric Animation; // 0x8c(0x14)
	struct FMetric Animation_TickPose; // 0xa0(0x14)
	struct FMetric Animation_ProxyUpdateAnimation; // 0xb4(0x14)
	struct FMetric Animation_RefreshBoneTransforms; // 0xc8(0x14)
	struct FMetric Animation_AnimationStateComponentTick; // 0xdc(0x14)
	struct FMetric Animation_Other; // 0xf0(0x14)
	struct FMetric Character; // 0x104(0x14)
	struct FMetric Character_Input; // 0x118(0x14)
	struct FMetric Character_Tick; // 0x12c(0x14)
	struct FMetric Character_Abilities; // 0x140(0x14)
	struct FMetric Character_Other; // 0x154(0x14)
	struct FMetric Equippable; // 0x168(0x14)
	struct FMetric Equippable_Other; // 0x17c(0x14)
	struct FMetric Esports; // 0x190(0x14)
	struct FMetric Esports_Other; // 0x1a4(0x14)
	struct FMetric FogOfWar; // 0x1b8(0x14)
	struct FMetric FogOfWar_Visibility; // 0x1cc(0x14)
	struct FMetric FogOfWar_Manager; // 0x1e0(0x14)
	struct FMetric FogOfWar_Component; // 0x1f4(0x14)
	struct FMetric FogOfWar_Other; // 0x208(0x14)
	struct FMetric Gameplay; // 0x21c(0x14)
	struct FMetric Gameplay_GameMode; // 0x230(0x14)
	struct FMetric Gameplay_GameState; // 0x244(0x14)
	struct FMetric Gameplay_PlayerState; // 0x258(0x14)
	struct FMetric Gameplay_Controller; // 0x26c(0x14)
	struct FMetric Gameplay_Audio; // 0x280(0x14)
	struct FMetric Gameplay_Minimap; // 0x294(0x14)
	struct FMetric Gameplay_Other; // 0x2a8(0x14)
	struct FMetric Movement; // 0x2bc(0x14)
	struct FMetric Movement_Other; // 0x2d0(0x14)
	struct FMetric Network; // 0x2e4(0x14)
	struct FMetric Network_StreamComponent; // 0x2f8(0x14)
	struct FMetric Network_OodleNetwork; // 0x30c(0x14)
	struct FMetric Network_Other; // 0x320(0x14)
	struct FMetric Particles; // 0x334(0x14)
	struct FMetric Particles_Other; // 0x348(0x14)
	struct FMetric Physics; // 0x35c(0x14)
	struct FMetric Physics_Other; // 0x370(0x14)
	struct FMetric Render; // 0x384(0x14)
	struct FMetric Render_Sync; // 0x398(0x14)
	struct FMetric Render_TextureStreaming; // 0x3ac(0x14)
	struct FMetric Render_UI; // 0x3c0(0x14)
	struct FMetric Render_Other; // 0x3d4(0x14)
	struct FMetric Replay; // 0x3e8(0x14)
	struct FMetric Replay_HttpStreamer; // 0x3fc(0x14)
	struct FMetric Replay_LocalFileStreamer; // 0x410(0x14)
	struct FMetric Replay_Other; // 0x424(0x14)
	struct FMetric Replication; // 0x438(0x14)
	struct FMetric Replication_Other; // 0x44c(0x14)
	struct FMetric Idle; // 0x460(0x14)
	struct FMetric Other; // 0x474(0x14)
	struct FMetric Other_ActorTick; // 0x488(0x14)
	struct FMetric Other_ComponentTick; // 0x49c(0x14)
	struct FMetric Other_GameObjectTick; // 0x4b0(0x14)
	struct FMetric Other_GarbageCollection; // 0x4c4(0x14)
	struct FMetric Other_WorldTick; // 0x4d8(0x14)
	struct FMetric Other_TickPreRTG; // 0x4ec(0x14)
	struct FMetric Other_TickPostRTG; // 0x500(0x14)
	struct FMetric Other_RunTickGroup; // 0x514(0x14)
	struct FMetric TempDebug; // 0x528(0x14)
	struct FMetric TempDebug_SubOne; // 0x53c(0x14)
	struct FMetric TempDebug_SubTwo; // 0x550(0x14)
	struct FMetric TempDebug_SubThree; // 0x564(0x14)
	struct FMetric TempDebug_Other; // 0x578(0x14)
};
...
struct FWeaponOrbRewardDroppedEvent {
	...
	struct FVector PickupLocation; // 0xc4(0x0c)
	struct FVector DropLocation; // 0xd0(0x0c)
	int32_t BulletsLeft; // 0xdc(0x04)
	bool bIsPlayerAlive; // 0xe0(0x01)
...
struct FOrbInteractionEvent {
	...
	struct FVector OrbLocation; // 0xc0(0x0c)
	float TimeSinceSpawned; // 0xcc(0x04)
	int32_t NumCharacterCollectors; // 0xd0(0x04)
	char pad_D4[0x4]; // 0xd4(0x04)
};
...
struct FShotProjectileInfo {
	...
	struct FGameEventCharacterState DealerCharacterState; // 0x88(0x1a8)
	int32_t NumberProjectiles; // 0x230(0x04)
	int32_t ZoomLevel; // 0x234(0x04)
	struct FStabilityValues StabilityValues; // 0x238(0x18)
	struct FString DamageEquippableInventoryTransactionType; // 0x250(0x10)
};
...
struct FGameEventCharacterState {
	...
	struct FVector ViewVector; // 0x20(0x0c)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct FString MovementType; // 0x30(0x10)
	float Speed; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
	struct FGameEventInventory Inventory; // 0x48(0x148)
	struct FString StabilityType; // 0x190(0x10)
	float StabilityFiringError; // 0x1a0(0x04)
	float StabilityMovementError; // 0x1a4(0x04)
};
...
struct FShotProjectileOnHitInfo : FShotProjectileInfo {
	struct FString DamageSource; // 0x260(0x10)
	struct FString DamageSourceId; // 0x270(0x10)
	struct TArray<struct FShotProjectileDamageInfo> DamageEvents; // 0x280(0x10)
};
...
struct FDamageLogEvent {
	...
	struct FGameEventCharacterState DealerCharacterState; // 0x150(0x1a8)
	struct FGameEventCharacterState ReceiverCharacterState; // 0x2f8(0x1a8)
	struct FString DamageSource; // 0x4a0(0x10)
	struct FString DamageSourceId; // 0x4b0(0x10)
	float DamageAmount; // 0x4c0(0x04)
	float DamageTaken; // 0x4c4(0x04)
	struct FString DamageRegion; // 0x4c8(0x10)
	bool IsPenetration; // 0x4d8(0x01)
	bool IsKill; // 0x4d9(0x01)
	char pad_4DA[0x6]; // 0x4da(0x06)
	struct FAimReport AimReport; // 0x4e0(0x68)
	bool IsZoomed; // 0x548(0x01)
	bool DamageReceiverIsPlayer; // 0x549(0x01)
	char pad_54A[0x6]; // 0x54a(0x06)
	struct FString DamageEquippableInventoryTransactionType; // 0x550(0x10)
};
...
// ScriptStruct ShooterGame.MatchDetailsAccuracyEvent
// Size: 0x70 (Inherited: 0x00)
struct FMatchDetailsAccuracyEvent {
	struct FGameEventMatchInfo MatchInfo; // 0x00(0x68)
	int32_t NumShots; // 0x68(0x04)
...
struct FVisibilityContext {
	char pad_0[0x30]; // 0x00(0x30)
	struct UBaseTeamComponent* TeamComponent; // 0x30(0x08)
};
...
struct FGPUStats {
	struct FMetric GPUTimeMs; // 0x00(0x14)
	struct FGPUFpsBuckets GPUFpsBuckets; // 0x14(0x34)
	struct FGPUFlipBuckets GPUFlipBuckets; // 0x48(0x14)
};
...
struct FInputLatencyStats {
	struct FMetric TotalEngineLatencyMs; // 0x00(0x14)
	struct FMetric TotalWorkMs; // 0x14(0x14)
	struct FMetric TotalSlopMs; // 0x28(0x14)
	struct FMetric TotalSlackMs; // 0x3c(0x14)
	struct FMetric PresentEndIntervalMs; // 0x50(0x14)
	struct FInputLatencyFpsBuckets TotalEngineLatencyFpsBuckets; // 0x64(0x34)
	struct FInputLatencyFpsBuckets TotalWorkFpsBuckets; // 0x98(0x34)
	struct FInputLatencyFpsBuckets TotalWorkAndSlackFpsBuckets; // 0xcc(0x34)
	struct FInputLatencyFpsBuckets PresentEndIntervalFpsBuckets; // 0x100(0x34)
};
...
struct FGameClientInstanceInfo : FGameBaseInstanceInfo {
	...
	bool IsRunningOnSSD; // 0x148(0x01)
	char pad_149[0x3]; // 0x149(0x03)
	int32_t SIMDSupport; // 0x14c(0x04)
};
...
struct FAresFloatSetting : FBaseFloatSetting {
	...
	bool bShouldUseRealSettingSliderMinMax; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	float RealSettingSliderStep; // 0x30(0x04)
};
...
struct FContentListing {
	...
	struct FJuiceSpendRules JuiceSpendRules; // 0x130(0x110)
	struct TArray<struct FMissionCatalogData> Missions; // 0x240(0x10)
	struct TArray<struct FEventCatalogData> Events; // 0x250(0x10)
	struct TArray<struct FSeasonCatalogData> Seasons; // 0x260(0x10)
	struct TArray<struct FCompetitiveSeasonCatalogData> CompetitiveSeasons; // 0x270(0x10)
	struct TArray<struct FPremierSeasonCatalogData> PremierSeasons; // 0x280(0x10)
	struct TArray<struct FPremierConferenceCatalogData> PremierConferences; // 0x290(0x10)
	struct FPremierCustomizationCatalogData PremierCustomizationData; // 0x2a0(0x20)
	struct TArray<struct FStreamedVideoFileCatalogData> StreamedVideoFiles; // 0x2c0(0x10)
	struct FContractListing ContractListing; // 0x2d0(0x20)
...
struct FPremierSeasonCatalogData {
	...
	struct FDateTime StartTime; // 0x20(0x08)
	struct FDateTime EndTime; // 0x28(0x08)
	struct TArray<struct FPremierEventCatalogData> Events; // 0x30(0x10)
	struct TArray<struct FPremierDivisionCatalogData> Divisions; // 0x40(0x10)
	struct TArray<struct FGuid> ParticipationRewardsActIDs; // 0x50(0x10)
	struct FRewardGrant ParticipationRewards; // 0x60(0x20)
	struct FRewardGrant TournamentWinnerRewards; // 0x80(0x20)
	struct TMap<struct FString, struct FRewardGrant> DivisionWinnerRewards; // 0xa0(0x50)
	bool DevelopmentOnly; // 0xf0(0x01)
	char pad_F1[0x7]; // 0xf1(0x07)
	struct TArray<struct FString> ExcludedPlatforms; // 0xf8(0x10)
	struct TMap<struct FString, struct FPlatformInclusionFlags> IncludedPlatforms; // 0x108(0x50)
	struct UObject* PrimaryAsset; // 0x158(0x08)
};
...
struct FAresSocialPageDefinition {
	struct FString ID; // 0x00(0x10)
	struct UCommonActivatableWidget* PageClass; // 0x10(0x08)
	struct UAresCommonButton* TabButtonClass; // 0x18(0x08)
	struct UAresButtonImageBrushContainer* IconBrushClass; // 0x20(0x08)
...
struct FAresSocialPresenceState {
	...
	enum class EAresSocialPartyCompatibility PartyCompatibility; // 0x02(0x01)
	enum class EAresSocialPartyCompatibility PlayerCompatibilityWithLocalParty; // 0x03(0x01)
...
struct FUINavigationGlobalsEntry {
	...
	struct TSoftObjectPtr<UTexture2D> ScreenIcon; // 0x60(0x30)
	struct TSoftObjectPtr<UTexture2D> BackgroundArtOverride; // 0x90(0x30)
	struct FMenuStackMediaSourceParams BackgroundVideoOverride; // 0xc0(0x30)
	struct FShellWidgetVisibilityOptions ShellWidgetVisibilityOptions; // 0xf0(0x09)
	bool bIsLandingScreen; // 0xf9(0x01)
	char pad_FA[0x6]; // 0xfa(0x06)
	struct TSoftClassPtr<UObject> NavigationButtonClass; // 0x100(0x30)
	struct TArray<struct FName> ValidChildScreens; // 0x130(0x10)
	int32_t NavigationBarIndex; // 0x140(0x04)
	char pad_144[0x4]; // 0x144(0x04)
	struct TArray<struct FModalContextInfo> ModalContext; // 0x148(0x10)
};
...
struct FBlindSpawnParams {
	...
	struct FVector BlindExplosionLocation; // 0x10(0x0c)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct AActor* CausingActor; // 0x20(0x08)
	float NetBlindTimestamp; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
};
...
struct FBracketLineConfig {
	...
	struct FLinearColor SwissLineColor; // 0x1c(0x10)
	float SwissLineThickness; // 0x2c(0x04)
	float SwissInitialLeadOff; // 0x30(0x04)
	float SwissLineOverlapPadding; // 0x34(0x04)
};
...
struct FBTEMilestone {
	...
	struct TSoftClassPtr<UObject> ConsoleQueueAsset; // 0x40(0x30)
	struct TSoftClassPtr<UObject> PCQueueAsset; // 0x70(0x30)
	struct TSoftClassPtr<UObject> UIData; // 0xa0(0x30)
};
...
struct FCAPProgressionConfigMilestone {
	struct FGuid ID; // 0x00(0x10)
	struct FString Name; // 0x10(0x10)
	struct TArray<struct FCAPProgressionConfigTriggerCounter> CounterTriggers; // 0x20(0x10)
	struct FCAPProgressionConfigRewards Rewards; // 0x30(0x30)
};
...
struct FPatchNode {
	...
	char pad_1C[0x4]; // 0x1c(0x04)
	struct TMap<struct FIntPoint, struct FVector> BlockedLocations; // 0x20(0x50)
};
...
struct FCinematicCameraDebugData {
	struct FCinematicCameraData CameraData; // 0x00(0x60)
	struct FCinematicCameraScoreData ScoreData; // 0x60(0x70)
	struct FString CameraActorName; // 0xd0(0x10)
	struct AActor* CameraActor; // 0xe0(0x08)
	bool bIsDestroyed; // 0xe8(0x01)
...
struct FCinematicCameraScoreData {
	struct FCinematicCameraData CameraData; // 0x00(0x60)
	float Score; // 0x60(0x04)
	float CameraToTargetDotProduct; // 0x64(0x04)
	float DistanceFromCamera; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
};
...
struct FClientPerRoundPerformanceData {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x34(0x58c)
	struct FClientFrameBuckets FrameBuckets; // 0x5c0(0x24)
	struct FMachinePerfStats MachinePerfStats; // 0x5e4(0x64)
	struct FAresObjectMetrics ObjectMetrics; // 0x648(0x64)
	char MoveTimestepsPerSecond; // 0x6ac(0x01)
	char pad_6AD[0x3]; // 0x6ad(0x03)
};

// ScriptStruct ShooterGame.ClientEndOfRoundPerformanceProfile
// Size: 0x9d0 (Inherited: 0x00)
struct FClientEndOfRoundPerformanceProfile {
	struct FMetric TotalFrameTime; // 0x00(0x14)
	struct FMetric ProcessingTime; // 0x14(0x14)
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x28(0x58c)
	struct FAresObjectMetrics ObjectMetrics; // 0x5b4(0x64)
	struct FMetric GPUTime; // 0x618(0x14)
	struct FGPUStats GPUStats; // 0x62c(0x5c)
	struct FClientFrameBuckets FrameBuckets; // 0x688(0x24)
	char pad_6AC[0x4]; // 0x6ac(0x04)
	struct FString matchID; // 0x6b0(0x10)
	int32_t RoundNumber; // 0x6c0(0x04)
	char pad_6C4[0x4]; // 0x6c4(0x04)
	int64_t RoundDuration; // 0x6c8(0x08)
	struct FString InstanceId; // 0x6d0(0x10)
	struct FPerfSettings Settings; // 0x6e0(0x58)
	struct FMachinePerfStats MachinePerfStats; // 0x738(0x64)
	char MoveTimestepsPerSecond; // 0x79c(0x01)
	char pad_79D[0x3]; // 0x79d(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x7a0(0x54)
	char pad_7F4[0x4]; // 0x7f4(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x7f8(0x70)
	struct FInputLatencyStats InputLatencyStats; // 0x868(0x134)
	char pad_99C[0x4]; // 0x99c(0x04)
	struct FString Puuid; // 0x9a0(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x9b0(0x20)
};
...
struct FRoundReports {
	...
	struct TArray<struct UExtendedCharacterCombatReport*> ExtendedCombatReports; // 0x18(0x10)
};
...
struct FContracts {
	...
	struct FString BTEStatus; // 0x70(0x10)
};
...
struct FBTEProgressUpdate {
	int32_t ActiveMilestoneIndexBefore; // 0x00(0x04)
	int32_t ActiveMilestoneIndexAfter; // 0x04(0x04)
};
...
struct FRecruitmentProgress {
	...
	struct FGuid AgentID; // 0x10(0x10)
	struct TArray<struct FProgressionCounter> Counters; // 0x20(0x10)
};
...
struct FCoreGamePlayerLoadoutDTO {
	struct FString Subject; // 0x00(0x10)
	struct FMegapacketLoadout Loadout; // 0x10(0x60)
	struct FString CharacterID; // 0x70(0x10)
};
...
struct FGraphStyleParams {
	...
	struct FVector2D CurveCircleDrawOffset; // 0x30(0x08)
	struct FAresHudFontParams GraphTitleFontParams; // 0x38(0x70)
	struct FVector2D GraphTitleDrawOffset; // 0xa8(0x08)
	struct FAresHudFontParams ValueLabelFontParams; // 0xb0(0x70)
	float ValueLabelSeparation; // 0x120(0x04)
	bool bShowGraphCurrentValue; // 0x124(0x01)
	bool bShowGraphMinMaxValues; // 0x125(0x01)
	char pad_126[0x2]; // 0x126(0x02)
	struct FAresHudFontParams GraphCurrentValueFontParams; // 0x128(0x70)
	struct FVector2D GraphCurrentValueDrawOffset; // 0x198(0x08)
	struct FVector2D GraphCurrentValueSeparationOffset; // 0x1a0(0x08)
};
...
struct FDebugShooterCharacterAnimInstanceGraph {
	struct FGraphStyleParams GraphStyle; // 0x00(0x1a8)
	struct FText Title; // 0x1a8(0x18)
	struct TArray<struct FName> VariableNames; // 0x1c0(0x10)
	struct TArray<struct FDebugShooterCharacterAnimInstanceGraphPlot> Plots; // 0x1d0(0x10)
	struct FVector2D GraphDrawOffset; // 0x1e0(0x08)
	float GraphScale; // 0x1e8(0x04)
	char pad_1EC[0x4]; // 0x1ec(0x04)
	struct UShooterCharacterAnimInstance* AnimInstance; // 0x1f0(0x08)
};
...
struct FBindingDependencyData {
	struct TArray<struct UActionBindSet*> ChildrenBindSets; // 0x00(0x10)
	struct UActionBindSet* ParentBindSet; // 0x10(0x08)
};
...
struct FMegapacketPlayer {
	...
	struct FMegapacketPlayerIdentity PlayerIdentity; // 0xe0(0x04)
	char pad_E4[0x4]; // 0xe4(0x04)
	struct TArray<struct FString> AccessibleCharacters; // 0xe8(0x10)
	int32_t CompetitiveTier; // 0xf8(0x04)
	bool IsModerator; // 0xfc(0x01)
	bool UseBroadcastHUD; // 0xfd(0x01)
	bool IsCoach; // 0xfe(0x01)
...
struct FWeaponEjectable {
	...
	struct FEjectableVelocitySample VelocitySamplePrev; // 0x80(0x20)
	struct FEjectableVelocitySample VelocitySampleCurr; // 0xa0(0x20)
};
...
struct FNetworkedForceModuleInfo {
	...
	char pad_1C[0x4]; // 0x1c(0x04)
	struct UForceModule* ModuleClass; // 0x20(0x08)
	float Duration; // 0x28(0x04)
	struct FNetworkedMovementTimestamp Timestamp; // 0x2c(0x10)
	char pad_3C[0x4]; // 0x3c(0x04)
	struct AActor* ContextActor; // 0x40(0x08)
};
...
struct FAresListConfiguration {
	...
	struct FAresListConstructArgs ListConstructArgs; // 0x0c(0x18)
	char pad_24[0x4]; // 0x24(0x04)
};
...
struct FAresListConstructArgs {
	...
	bool bAllowFocus; // 0x01(0x01)
	enum class ESelectionMode SelectionMode; // 0x02(0x01)
	bool bNavigationIsSelection; // 0x03(0x01)
	bool bClearSelectionOnClick; // 0x04(0x01)
	enum class EConsumeMouseWheel ConsumeMouseWheel; // 0x05(0x01)
	bool bReturnFocusToSelection; // 0x06(0x01)
	enum class EOrientation Orientation; // 0x07(0x01)
	enum class EListItemAlignment TileAlignment; // 0x08(0x01)
	char pad_9[0x3]; // 0x09(0x03)
	float EntryHeight; // 0x0c(0x04)
	float EntryWidth; // 0x10(0x04)
	bool bWrapDirectionalNavigation; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
};
...
struct FAresPaginatedListConfiguration {
	...
	int32_t ItemsPerPageOverride; // 0x04(0x04)
};
...
struct FConsoleClientLaunchTimes {
	...
	double HotfixTimeSecs; // 0x28(0x08)
	bool DidApplyHotfix; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
...
struct FProcessedPlayerDetails {
	struct FPlayerDetailsDTO PlayerDetailsRaw; // 0x00(0xd8)
	int32_t BestRound; // 0xd8(0x04)
	int32_t BestRoundBeforeOT; // 0xdc(0x04)
	int32_t TotalDamageDealt; // 0xe0(0x04)
	int32_t TotalLoadoutValue; // 0xe4(0x04)
	int32_t TotalMoneySpent; // 0xe8(0x04)
	int32_t BombPlants; // 0xec(0x04)
	int32_t BombDefuses; // 0xf0(0x04)
	char pad_F4[0x4]; // 0xf4(0x04)
	struct UCharacterUIData* CharacterUIData; // 0xf8(0x08)
	struct UTexture2D* FullPortrait; // 0x100(0x08)
	struct FAbilityEffectDTO AbilityEffects; // 0x108(0x140)
	struct UCharacterDataAsset* CharacterDataAsset; // 0x248(0x08)
	struct UPlayerCardDataAsset* PlayerCardAsset; // 0x250(0x08)
	struct UPlayerTitleDataAsset* PlayerTitleDataAsset; // 0x258(0x08)
	struct ULevelBorderDataAsset* LevelBorderDataAsset; // 0x260(0x08)
};
...
struct FParticipantMatchResults {
	...
	struct FNewPlayerExperienceDetails NewPlayerExperienceDetails; // 0x50(0xb8)
	struct FNewPlayerExperienceV2Details NewPlayerExperienceV2Details; // 0x108(0x20)
	struct TMap<struct FString, float> BehaviorFactors; // 0x128(0x50)
};
...
struct FMegapacket {
	...
	struct FMegapacketMetadata MetaData; // 0x90(0x278)
};
...
struct FMegapacketMetadata {
	...
	struct FTournamentRosterMetadata RosterMetadata; // 0x208(0x70)
};
...
// Size: 0x48 (Inherited: 0x08)
struct FPlayerJoinCompleteGameDataEvent : FGameDataEventBase {
	char pad_8[0x40]; // 0x08(0x40)
};

// ScriptStruct ShooterGame.PlayerDisassociatedGameDataEvent
// Size: 0x38 (Inherited: 0x08)
struct FPlayerDisassociatedGameDataEvent : FGameDataEventBase {
...
struct FScriptStateEffectInfo {
	...
	bool bStopEffectOnUnequip; // 0x32(0x01)
	bool bOwnerEffectOnly; // 0x33(0x01)
	enum class EStateContext Context; // 0x34(0x01)
	enum class EMovementSync MovementSync; // 0x35(0x01)
	char pad_36[0x2]; // 0x36(0x02)
};
...
struct FAntiDDoSPacketStats {
	struct FMetric ReceivedConnectionPackets; // 0x00(0x14)
	struct FMetric ReceivedNonConnectionPackets; // 0x14(0x14)
	struct FMetric ReceivedBadPackets; // 0x28(0x14)
	struct FMetric ReceivedErrorPackets; // 0x3c(0x14)
};
...
struct FObserverPawnMove {
	...
	struct FVector_NetQuantize100 Velocity; // 0x14(0x0c)
...
struct FRoomInfo {
	char pad_0[0x20]; // 0x00(0x20)
	struct UAkRoomComponent* RoomComponent; // 0x20(0x08)
	struct TArray<int32_t> ExitPortalIndex; // 0x28(0x10)
...
struct FPartyData {
	...
	enum class EAresPartyAccessibility PartyAccessibility; // 0x38(0x01)
	char pad_39[0x7]; // 0x39(0x07)
	struct FString ClientVersion; // 0x40(0x10)
	enum class EAresTempType PrecisePlatformType; // 0x50(0x01)
	bool IsCrossPlayEnabled; // 0x51(0x01)
	char pad_52[0x6]; // 0x52(0x06)
};
...
struct FAresParty {
	...
	struct FTournamentData TournamentData; // 0x180(0x70)
	struct FString ClientVersion; // 0x1f0(0x10)
	int64_t Version; // 0x200(0x08)
	bool LookingForMore; // 0x208(0x01)
	char pad_209[0x7]; // 0x209(0x07)
	struct FCheatData CheatData; // 0x210(0x18)
	struct TArray<struct FString> EligibleQueues; // 0x228(0x10)
	struct TArray<struct FPartyXPBonus> XPBonuses; // 0x238(0x10)
	struct FString State; // 0x248(0x10)
	struct FString PreviousState; // 0x258(0x10)
	enum class EAresPartyAccessibility Accessibility; // 0x268(0x01)
	char pad_269[0x7]; // 0x269(0x07)
	struct FString StateTransitionReason; // 0x270(0x10)
	struct TArray<struct FPartyInvite> Invites; // 0x280(0x10)
	struct TArray<struct FPartyRequest> Requests; // 0x290(0x10)
	struct FDateTime QueueEntryTime; // 0x2a0(0x08)
	struct FAresPartyErrorNotification ErrorNotification; // 0x2a8(0x20)
	int64_t RestrictedSeconds; // 0x2c8(0x08)
	struct TArray<struct FQueueIneligibility> QueueIneligibilities; // 0x2d0(0x10)
	struct FString InviteCode; // 0x2e0(0x10)
	bool IsCrossPlayEnabled; // 0x2f0(0x01)
...
struct FQueueConfig {
	...
	char pad_69[0x7]; // 0x69(0x07)
	struct TArray<struct FGuid> DisabledContent; // 0x70(0x10)
};
...
struct FWallSpanList {
	...
	char pad_11[0x3]; // 0x11(0x03)
	struct FHitResult EntranceToLastPoint; // 0x14(0x90)
...
struct FWallSpanInfo {
	struct FHitResult Entrance; // 0x00(0x90)
	struct FHitResult Exit; // 0x90(0x90)
};
...
struct FPregameMatch {
	...
	struct FTournamentMetadata TournamentMetadata; // 0x1a0(0x80)
	struct FTournamentRosterMetadata RosterMetadata; // 0x220(0x70)
};
...
struct FPremierEvent {
	...
	char pad_15[0x3]; // 0x15(0x03)
	struct FTimecode StartTime; // 0x18(0x14)
	struct FTimecode Duration; // 0x2c(0x14)
	enum class EPremierEventType Type; // 0x40(0x01)
	char pad_41[0x7]; // 0x41(0x07)
	struct FText Name; // 0x48(0x18)
	struct FText Description; // 0x60(0x18)
	struct TSoftClassPtr<UObject> Icon; // 0x78(0x30)
	struct TSoftClassPtr<UObject> Schedule; // 0xa8(0x30)
	enum class EPremierEventMapSelectionStrategy MapSelectionStrategy; // 0xd8(0x01)
	char pad_D9[0x7]; // 0xd9(0x07)
	struct TSoftClassPtr<UObject> MapPool; // 0xe0(0x30)
};
...
struct FPremierConference {
	struct FGuid ID; // 0x00(0x10)
	struct FString Key; // 0x10(0x10)
	struct TArray<struct FString> gamePods; // 0x20(0x10)
...
struct FPremierRosterV2 {
	...
	struct FPremierRosterV2SeasonData season; // 0xb0(0xa0)
	int32_t MinimumRequiredMembersForEnrollment; // 0x150(0x04)
	int32_t MatchesSinceReset; // 0x154(0x04)
	int32_t TournamentsSinceReset; // 0x158(0x04)
	char pad_15C[0x4]; // 0x15c(0x04)
	struct FPremierRosterV2Version Version; // 0x160(0x10)
	int64_t UpdatedAt; // 0x170(0x08)
	int64_t CreatedAt; // 0x178(0x08)
};
...
struct FPremierRosterV2SeasonData {
	...
	bool IsProvisionalDivision; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	...
	bool HasEarnedPromotionForNextSeason; // 0x98(0x01)
	char pad_99[0x7]; // 0x99(0x07)
};
...
struct FPremierRoster {
	...
	int32_t LeaguePoints; // 0x30(0x04)
	int32_t MaxLeaguePoints; // 0x34(0x04)
	...
	struct FPremierRosterV2SeasonData season; // 0xb8(0xa0)
};
...
struct FPremierSeasonDTO {
	...
	char pad_21[0x7]; // 0x21(0x07)
	struct TArray<struct FPremierEventDTO> Events; // 0x28(0x10)
	struct TArray<struct FPremierScheduledEventDTO> ScheduledEvents; // 0x38(0x10)
	struct FDateTime StartTime; // 0x48(0x08)
	struct FDateTime EndTime; // 0x50(0x08)
	struct FDateTime EnrollmentPhaseStartDateTime; // 0x58(0x08)
	struct FDateTime EnrollmentPhaseEndDateTime; // 0x60(0x08)
	struct TArray<struct FPremierDivisionThresholdDTO> DivisionThresholds; // 0x68(0x10)
	int32_t ChampionshipPointRequirement; // 0x78(0x04)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FString ChampionshipEventID; // 0x80(0x10)
	struct FDateTime LeaderboardFinalizationDateTime; // 0x90(0x08)
};
...
struct FPremierScheduledEventDTO {
	...
	struct FString Conference; // 0x10(0x10)
	struct FDateTime StartDateTime; // 0x20(0x08)
	struct FDateTime EndDateTime; // 0x28(0x08)
};
...
struct FAresPresenceInfo {
	...
	struct FAresPresenceData Data; // 0xe8(0x198)
};
...
struct FAresPresenceData {
	...
	struct FString TempValueX; // 0x170(0x10)
	struct FString TempValueY; // 0x180(0x10)
	bool TempValueZ; // 0x190(0x01)
	bool TempValueW; // 0x191(0x01)
...
struct FChatPresenceUpdateRequest {
	...
	struct FAresPresenceDataWrapper Private; // 0x20(0x198)
	struct FChatPresenceSharedData Shared; // 0x1b8(0x48)
};
...
struct FAresPresenceDataWrapper {
	struct FAresPresenceData AresData; // 0x00(0x198)
};
...
struct FPresenceData {
	...
	char pad_4[0x4]; // 0x04(0x04)
	struct FAresPresenceDataWrapper AresDataWrapper; // 0x08(0x198)
};
...
struct FProjectileThrowTuning {
	...
	bool bJumpThrowNormalization_LaunchPoint; // 0x3c(0x01)
	bool bJumpThrowNormalization_ImpartedVelocity; // 0x3d(0x01)
...
struct FServerRoundMetrics {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x98(0x58c)
	struct FServerFrameBuckets FrameBuckets; // 0x624(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x640(0x64)
};
...
struct FServerPerRoundPerformanceData {
	...
	struct FMetric ProcessingTime; // 0x20(0x14)
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x34(0x58c)
	struct FServerFrameBuckets FrameBuckets; // 0x5c0(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x5dc(0x64)
	struct FAresObjectMetrics ObjectMetrics; // 0x640(0x64)
	int32_t ConcurrentServers; // 0x6a4(0x04)
	float MaxTickRate; // 0x6a8(0x04)
	char MoveTimestepsPerSecond; // 0x6ac(0x01)
	char pad_6AD[0x3]; // 0x6ad(0x03)
};
...
struct FServerEndOfRoundPerformanceProfile {
	...
	struct FString matchID; // 0x5b8(0x10)
	int32_t RoundNumber; // 0x5c8(0x04)
	char pad_5CC[0x4]; // 0x5cc(0x04)
	int64_t RoundDuration; // 0x5d0(0x08)
	int32_t ConcurrentServers; // 0x5d8(0x04)
	struct FAresObjectMetrics ObjectMetrics; // 0x5dc(0x64)
	struct FServerFrameBuckets FrameBuckets; // 0x640(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x65c(0x64)
	char MoveTimestepsPerSecond; // 0x6c0(0x01)
	char pad_6C1[0x3]; // 0x6c1(0x03)
	float MaxTickRate; // 0x6c4(0x04)
	struct FNetworkPacketStats NetworkPacketStats; // 0x6c8(0x54)
	struct FAntiDDoSPacketStats AntiDDoSPacketStats; // 0x71c(0x50)
	char pad_76C[0x4]; // 0x76c(0x04)
};

// ScriptStruct ShooterGame.ServerEndOfRoundPerformanceProfileNR
// Size: 0x38 (Inherited: 0x00)
struct FServerEndOfRoundPerformanceProfileNR {
	int32_t RoundNumber; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
...
struct FInWorldReclamationTelemetryEvent {
	...
	struct FGameEventRoundInfo RoundInfo; // 0x68(0x28)
	struct FGameEventPlayerInfo PlayerInfo; // 0x90(0x60)
	struct FReclaimOrbTelemetryInfo OrbInfo; // 0xf0(0x38)
};
...
struct FReclaimOrbTelemetryInfo {
	...
	struct FVector OrbLocation; // 0x20(0x0c)
	int32_t OrbCreationRoundTime; // 0x2c(0x04)
	int32_t OrbReclaimRoundTime; // 0x30(0x04)
	int32_t OrbReclaimAttempts; // 0x34(0x04)
};
...
struct FPlayerSpawnedEvent {
	...
	struct FGameEventRoundInfo RoundInfo; // 0xb0(0x28)
	uint32_t NumVisibleEnemyCharacters; // 0xd8(0x04)
	uint32_t NumAliveCharacters; // 0xdc(0x04)
	float LookAheadMultiplier; // 0xe0(0x04)
	char pad_E4[0x4]; // 0xe4(0x04)
	struct TArray<struct FNumSpawnsPerVisibilityScore> NumSpawnsPerVisibilityScore; // 0xe8(0x10)
	uint32_t NumStaleSpawnPoints; // 0xf8(0x04)
	char pad_FC[0x4]; // 0xfc(0x04)
	struct TArray<float> ConsideredSpawnPointScores; // 0x100(0x10)
};
...
struct FPlayerRoundSnapshotEvent {
	...
	struct FGameEventRoundInfo RoundInfo; // 0x68(0x28)
	struct FGameEventPlayerInfo PlayerInfo; // 0x90(0x60)
	struct FGameEventCharacterState PlayerState; // 0xf0(0x1a8)
};
...
struct FAbilityUsageEvent {
	...
	struct FGameEventPlayerInfo PlayerInfo; // 0x90(0x60)
	struct FGameEventCharacterState PlayerState; // 0xf0(0x1a8)
	struct FAbilityUsageInfo AbilityInfo; // 0x298(0x68)
};
...
// Size: 0xe8 (Inherited: 0x00)
struct FShotResult {
	struct FShotResultMetadata ClientShotMetadata; // 0x00(0x70)
	struct FShotResultMetadata ServerShotMetadata; // 0x70(0x70)
	bool bReceivedServerResults; // 0xe0(0x01)
	bool bReceivedClientResults; // 0xe1(0x01)
...
struct FShotResultMetadata {
	...
	struct FStabilityValues StabilityValues; // 0x44(0x18)
	struct FVector MovementVelocity; // 0x5c(0x0c)
	bool bUsedPredictedLocation; // 0x68(0x01)
	char pad_69[0x7]; // 0x69(0x07)
};
...
struct FNetworkedClientShotResult {
	...
	struct FShotResultMetadata ShotMetadata; // 0x08(0x70)
};
...
struct FServerMoveDebugData {
	struct FVector ServerPosition; // 0x00(0x0c)
	struct FVector ServerVelocity; // 0x0c(0x0c)
	struct FVector ServerAcceleration; // 0x18(0x0c)
	struct FTimeStampIndex TimeStampIndex; // 0x24(0x04)
};

// ScriptStruct ShooterGame.GradualCorrectionData
// Size: 0x28 (Inherited: 0x00)
struct FGradualCorrectionData {
	struct FVector ClientToServerPositionDiff; // 0x00(0x0c)
	struct FVector ServerVelocity; // 0x0c(0x0c)
	char pad_18[0x10]; // 0x18(0x10)
};
...
struct FAresGameInfo {
	...
	bool bIsDropInEnabled; // 0x29(0x01)
	char pad_2A[0x6]; // 0x2a(0x06)
...
struct FMultiStateEffectDefinition {
	struct FScriptStateEffectInfo EffectInfo; // 0x00(0x38)
};
...
struct FStealthTrackedEnemies {
	struct TMap<struct AShooterCharacter*, struct FStealthRangeData> TrackedEnemies; // 0x00(0x50)
	struct TMap<struct AShooterCharacter*, float> TrackedEnemyExitTimes; // 0x50(0x50)
};

// ScriptStruct ShooterGame.StealthRangeData
// Size: 0x58 (Inherited: 0x00)
struct FStealthRangeData {
	float TimeInRange; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
	struct TSet<struct UPrimitiveComponent*> OverlappedRangeColliders; // 0x08(0x50)
};
...
struct FGetStorefrontResponseV3 {
	...
	struct FSkinsPanelLayout SkinsPanelLayout; // 0x118(0x28)
...
struct FPluginStoreOffer {
	struct FPluginStorePurchaseInformation PurchaseInformation; // 0x00(0x100)
	struct TArray<struct FPluginStoreSubOffer> SubOffers; // 0x100(0x10)
};
...
struct FPluginStorePurchaseInformation {
	...
	struct TArray<struct FPluginStoreReward> Rewards; // 0xe8(0x10)
...
struct FSkinsPanelLayout {
	...
	struct TArray<struct UStoreOffer*> SingleItemStoreOffers; // 0x10(0x10)
	int32_t SingleItemOffersRemainingDurationInSeconds; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
};
...
struct FAgentStorefront {
	struct FAgentStore AgentStore; // 0x00(0x20)
};
...
struct FAgentStore {
	...
	struct FGuid FeaturedAgent; // 0x10(0x10)
};
...
struct FNavigationBarData {
	struct TArray<struct FString> Urls; // 0x00(0x10)
	struct TArray<struct FRGICommonNavBarDetails> ButtonDetails; // 0x10(0x10)
	bool bIsEnabled; // 0x20(0x01)
	char pad_21[0x7]; // 0x21(0x07)
};
...
struct FWeaponModifiersDataTableRow : FTableRowBase {
	struct FSoftClassPath WeaponClass; // 0x08(0x20)
	struct FEquippableInfo Modifiers; // 0x28(0x0c)
	char pad_34[0x4]; // 0x34(0x04)
};
