...
struct ULoadingThrobberSmall_C : UDesignableUserWidget {
	...
	void OnHovered__DelegateSignature(struct USharedButtonText1_C* TextButton); // Function LoadingThrobberSmall.LoadingThrobberSmall_C.OnHovered__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x4282c30
	void OnClicked__DelegateSignature(struct USharedButtonText1_C* TextButton); // Function LoadingThrobberSmall.LoadingThrobberSmall_C.OnClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x4282c30
};
