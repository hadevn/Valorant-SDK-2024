...
struct UShooterCharacterAudioAttenuationMinimapWidget_C : UAresMinimapWidget_C {
	...
	void NewFunction_1(); // Function ShooterCharacterAudioAttenuationMinimapWidget.ShooterCharacterAudioAttenuationMinimapWidget_C.NewFunction_1 // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x4282c30
	void GetDesiredAttenuationSize(float& DesiredRadius); // Function ShooterCharacterAudioAttenuationMinimapWidget.ShooterCharacterAudioAttenuationMinimapWidget_C.GetDesiredAttenuationSize // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x4282c30
	void UpdateVisualization(struct TArray<struct FStruct_AttenuationInformation>& Attenuations); // Function ShooterCharacterAudioAttenuationMinimapWidget.ShooterCharacterAudioAttenuationMinimapWidget_C.UpdateVisualization // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x4282c30
	void ExecuteUbergraph_ShooterCharacterAudioAttenuationMinimapWidget(int32_t EntryPoint); // Function ShooterCharacterAudioAttenuationMinimapWidget.ShooterCharacterAudioAttenuationMinimapWidget_C.ExecuteUbergraph_ShooterCharacterAudioAttenuationMinimapWidget // (Final|UbergraphFunction|HasDefaults) // @ game+0x4282c30
};
