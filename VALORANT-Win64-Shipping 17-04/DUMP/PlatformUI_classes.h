...
struct UPlatformUIFRE : UPlatformUI {
	...
	bool SetHotfixAvailability(enum class EPlatformUIHotFixAvailability HotfixAvailability); // Function PlatformUI.PlatformUIFRE.SetHotfixAvailability // (Final|Native|Public|BlueprintCallable) // @ game+0x2469ae0
};
