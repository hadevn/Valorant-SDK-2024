...
struct FGameplayAbilitySpecDef {
	...
	struct UObject* SourceObject; // 0x48(0x08)
...
struct FGameplayCueParameters {
	...
	bool bReplicateLocationWhenUsingMinimalRepProxy; // 0xc0(0x01)
...
struct FActiveGameplayCue : FFastArraySerializerItem {
	...
	struct FGameplayCueParameters Parameters; // 0x28(0xc8)
	bool bPredictivelyRemoved; // 0xf0(0x01)
...
struct FGameplayCuePendingExecute {
	...
	struct FGameplayCueParameters CueParameters; // 0xb8(0xc8)
};
...
struct FMinimalGameplayCueReplicationProxy {
	...
	struct UAbilitySystemComponent* Owner; // 0x300(0x08)
...
struct FGameplayModifierInfo {
	...
	struct FScalableFloat Magnitude; // 0x40(0x38)
	struct FGameplayEffectModifierMagnitude ModifierMagnitude; // 0x78(0x2f0)
	struct FGameplayModEvaluationChannelSettings EvaluationChannelSettings; // 0x368(0x01)
	char pad_369[0x7]; // 0x369(0x07)
	struct FGameplayTagRequirements SourceTags; // 0x370(0x40)
	struct FGameplayTagRequirements TargetTags; // 0x3b0(0x40)
};
...
struct FGameplayEffectExecutionScopedModifierInfo {
	...
	struct FGameplayTagRequirements SourceTags; // 0x348(0x40)
	struct FGameplayTagRequirements TargetTags; // 0x388(0x40)
};
...
struct FMovieSceneGameplayCueChannel : FMovieSceneChannel {
	...
	struct TArray<struct FMovieSceneGameplayCueKey> KeyValues; // 0x18(0x10)
...
struct FMovieSceneGameplayCueKey {
	...
	struct FName AttachSocketName; // 0x24(0x0c)
	float NormalizedMagnitude; // 0x30(0x04)
	struct FMovieSceneObjectBindingID Instigator; // 0x34(0x18)
	struct FMovieSceneObjectBindingID EffectCauser; // 0x4c(0x18)
	char pad_64[0x4]; // 0x64(0x04)
	struct UPhysicalMaterial* PhysicalMaterial; // 0x68(0x08)
	int32_t GameplayEffectLevel; // 0x70(0x04)
	int32_t AbilityLevel; // 0x74(0x04)
	bool bAttachToBinding; // 0x78(0x01)
