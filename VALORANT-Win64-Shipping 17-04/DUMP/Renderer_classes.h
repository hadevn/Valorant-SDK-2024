...
struct UAresOutlineRendering : UObject {
	...
	void SetOutlineColorsForRender(struct UObject* WorldContextObject, struct FLinearColor& AllyColor, struct FLinearColor& EnemyColor); // Function Renderer.AresOutlineRendering.SetOutlineColorsForRender // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x4ccb9b0
};
