...
struct UJumpingPathFollowingComponent : UPathFollowingComponent {
	...
	void OnPostProcessMove(struct UPathFollowingComponent* PathFollower, struct FVector& InOutVelocity); // Function AINavigation.JumpingPathFollowingComponent.OnPostProcessMove // (Final|Native|Protected|HasOutParms|HasDefaults) // @ game+0x2756360
};
...
struct ANavLinkDropOff : AActor {
	...
	float DropOffDistance; // 0x3c8(0x04)
	float MaxDropOff; // 0x3cc(0x04)
	float MaxJumpHeight; // 0x3d0(0x04)
	char pad_3D4[0x14]; // 0x3d4(0x14)
};
...
struct ANavLinkDropOffGenerator : AActor {
	char pad_3B8[0x10]; // 0x3b8(0x10)
	float DropOffSeparation; // 0x3c8(0x04)
	float DropOffDistance; // 0x3cc(0x04)
	float MaxStepUpHeight; // 0x3d0(0x04)
	float MinStepDownHeight; // 0x3d4(0x04)
	float MaxDropOff; // 0x3d8(0x04)
	float MaxJumpHeight; // 0x3dc(0x04)
	float FallDamageHeight; // 0x3e0(0x04)
	float BaseLift; // 0x3e4(0x04)
	float BaseBackOff; // 0x3e8(0x04)
	struct FName IgnoreObjectsWithTag; // 0x3ec(0x0c)
	struct TArray<struct FGeneratedNavigationLinkInfo> PointLinks; // 0x3f8(0x10)
	char pad_408[0x8]; // 0x408(0x08)

	void OnNavigationGenerated(struct ANavigationData* NavData); // Function AINavigation.NavLinkDropOffGenerator.OnNavigationGenerated // (Final|Native|Private) // @ game+0x27562d0
	bool HasValidData(); // Function AINavigation.NavLinkDropOffGenerator.HasValidData // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x27562a0
	bool DoesMapHaveHealthyJumpLinks(); // Function AINavigation.NavLinkDropOffGenerator.DoesMapHaveHealthyJumpLinks // (Final|Native|Public|BlueprintCallable) // @ game+0x2756270
};

// Class AINavigation.NavLinkDropOffIgnoreVolumeBase
// Size: 0x3c0 (Inherited: 0x3b8)
struct ANavLinkDropOffIgnoreVolumeBase : AActor {
	struct UBoxComponent* IgnoreVolume; // 0x3b8(0x08)
};
