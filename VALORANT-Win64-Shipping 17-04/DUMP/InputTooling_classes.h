...
struct UAimToolingComponent : UBaseInputToolingComponent {
	char pad_F0[0x548]; // 0xf0(0x548)
	struct TArray<bool> FeaturesEnabledValues; // 0x638(0x10)
	struct TArray<float> FeatureConfigValues; // 0x648(0x10)
	struct TArray<struct UCurveFloat*> FeatureConfigCurves; // 0x658(0x10)
	...
	bool IsFeatureEnabled(enum class EAimToolingFeature Feature, struct UAimToolingTargetComponentBase* TargetComponent); // Function InputTooling.AimToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6a28390
	bool IsAimToolingEnabled(); // Function InputTooling.AimToolingComponent.IsAimToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x3d7b060
};
...
struct UAimToolingTargetComponentBase : USceneComponent {
	...
	void EnableAimToolingFeature(enum class EAimToolingFeature AimToolingFeature); // Function InputTooling.AimToolingTargetComponentBase.EnableAimToolingFeature // (Final|Native|Public|BlueprintCallable) // @ game+0x6a29630
	void DisableAimToolingFeature(enum class EAimToolingFeature AimToolingFeature); // Function InputTooling.AimToolingTargetComponentBase.DisableAimToolingFeature // (Final|Native|Public|BlueprintCallable) // @ game+0x6a295b0
};
...
struct UMovementToolingComponent : UBaseInputToolingComponent {
	...
	bool IsMovementToolingEnabled(); // Function InputTooling.MovementToolingComponent.IsMovementToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x38d7740
	bool IsFeatureEnabled(enum class EMovementToolingFeature Feature); // Function InputTooling.MovementToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6a31cd0
};
